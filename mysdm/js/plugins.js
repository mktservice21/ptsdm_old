...
*/
    // SELECT2
        ...
        $("#e_tindak").select2();
        $("#e_polikel").select2();
        $("#e_petugaskes").select2();
        $("#e_stsrujukdari").select2();
        $("#e_inpartu").select2();
        $("#e_oxidan").select2();
        $("#e_kbps").select2();
        $("#e_kondisiibu").select2();
        $("#e_kondisibayi").select2();
        $("#e_kondisiibukp").select2();
        $("#e_kondisibayikp").select2();
        $("#e_nilaibayi").select2();
        $("#e_rawatbayi1").select2();
        $("#e_rawatbayi2").select2();
        $("#e_jekel").select2();
        $("#e_vtpbayi").select2();
        $("#e_pmkbayi").select2();
        $("#e_rujukibu").select2();
        ...
        $("#e_psm").select2();
        $("#e_pengasi").select2();
        $("#e_nyeritekan").select2();
        $("#e_kmata").select2();
        $("#e_klidah").select2();

        $("#e_easimetris").select2();
        $("#e_eakuku").select2();
        $("#e_ebsimetris").select2();
        $("#e_eboedema").select2();
        $("#e_ebrefleks").select2();
        $("#e_aghaemor").select2();

        $("#e_ruangan").select2();
        $("#e_ruanganigd").select2();
