...
if ($pilihdarims==true) {
    ...
    $query = "select * from sls.ytd where bulan='$bulan' and iddaerah='$cbgytd'";
    ...
    $query = "UPDATE $tmp00 SET mtd_qty_target=0, mtd_value_target=0, ytd_qty_target=0, "
            . " ytd_value_target=0, thn_qty_target=0, thn_value_target=0";
    $results1 = DB::query($query);
    
    $query = "UPDATE $tmp00 SET mtd_qty_target=mtd_qty_targetdm, mtd_value_target=mtd_value_targetdm, ytd_qty_target=ytd_qty_targetdm, "
            . " ytd_value_target=ytd_value_targetdm";
    $results1 = DB::query($query);
        ...
        <?php
            ...
            foreach ($results1 as $r1) {
              ...
              foreach ($result8 as $r8){
                  echo "<tr>";
                  echo "<td colspan='2'><b>Total $namacabangytd + OTHER<b></td><td class='divnone'></td>";
