...
if ($pilihdarims==true) {
    ...
    $link =$_GET["link"]."/report/ytd_daerah.aspx";
...
if (!empty($cbgytd)) {
    ...
    $ppilihanmakloya="";
    $resultsmkl = DB::query("SELECT DISTINCT iddaerah, iprodid, divprodid FROM sls.maklon_daerah WHERE iddaerah='$cbgytd'");
              ...
              */
			  //OTHER
                ...
                foreach ($result10 as $r10){
                  ...
                  echo "<tr>";
                  echo "<td colspan='2'><b>&nbsp;<b></td><td class='divnone'></td>";
              ...
              if (!empty($pprodukmaklo)) {
                    ...
                    foreach ($result42 as $r42){
                        echo "<tr>";
                        echo "<td colspan='2'><b>Total $namacabangytd + MAKLON<b></td><td class='divnone'></td>";
