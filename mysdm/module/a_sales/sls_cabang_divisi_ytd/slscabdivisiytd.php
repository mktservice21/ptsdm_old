    ...
    echo "<table width='90%' align='center' border='0' class='table table-striped table-bordered'>";
        echo "<tr>";
            echo "<td valign='top'>";
                ...
                echo "<tr><td><b>SALES YTD CABANG & DIVISI BY VALUE</b></td></tr>";
...
<table id="datatable1" class="display  table table-striped table-bordered" style="width:100%" border='0px'>
    <thead>
        ...
        <tr>-->
            ...
            foreach ($results1 as $r1) {
                $fdivisi=$r1['divprodid'];
                echo "<th valign='top'><u>$fdivisi</u>&nbsp;<br/>Sales YTD $thnbln</th>";
                echo "<th valign='top'><u>$fdivisi</u>&nbsp;<br/>Target YTD $thnbln</th>";
                echo "<th valign='top'><u>$fdivisi</u>&nbsp;<br/>Ach %</th>";
                echo "<th valign='top'><u>$fdivisi</u>&nbsp;<br/>Sales YTD $thnbln2</th>";
                echo "<th valign='top'><u>$fdivisi</u>&nbsp;<br/>Growth %</th>";
                
            }
            ?>
            <th valign='top'>Sales YTD <?PHP echo $thnbln; ?></th>
            <th valign='top'>Target YTD <?PHP echo $thnbln; ?></th>
            <th valign='top'>Ach %</th>
            <th valign='top'>Sales YTD <?PHP echo $thnbln2; ?></th>
