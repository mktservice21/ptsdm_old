                    ...
                    <div class='x_panel'>
                        ...
                        <form method='POST' action='' 
                            ...
                            if ($_SESSION['GROUP']==1) {
                                ?>
                                <br/><br/><br/><br/>
                                <input class='btn btn-success' type=button value='TEST NON 022 (5)' onclick="ProsesDataCallPros('tesdatamodule', '5')"><br/>
                                <input class='btn btn-success' type=button value='TEST NON 023 (6)' onclick="ProsesDataCallPros('tesdatamodule', '6')"><br/>
                                <input class='btn btn-dark' type=button value='TEST AKTIF 022 (7)' onclick="ProsesDataCallPros('tesdatamodule', '7')"><br/>
                                <input class='btn btn-dark' type=button value='TEST AKTIF 023 (8)' onclick="ProsesDataCallPros('tesdatamodule', '8')"><br/>
                                <?PHP
                            }
                            ?>
