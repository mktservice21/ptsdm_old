...
<div class="">
    ...
    <div class="row">
        ...
        $pcabid_pl=$_SESSION['DCCCABCAB'];
        $pareaid_pl=$_SESSION['DCCCABARE'];
        $pkryid_pl=$_SESSION['DCCCABKRY'];
        $pjbtid_pl=$_SESSION['DCCCABJBT'];
        $pkryid_pl=$_SESSION['DCCCABKRY'];
        $ptgl1_pl=$_SESSION['DCCCABTGL'];
