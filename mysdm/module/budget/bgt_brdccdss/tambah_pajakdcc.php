...
<?PHP
    ...
    $sql = "SELECT * FROM hrd.br0 WHERE brId='$pidbrno'";
                    ...
                    <div class='x_content'>
                        ...
                        <div id='xxpanel'>
                            <table id='dtableviewpajak' class='table table-striped table-bordered' width='100%'>
                                ...
                                <tbody>
                                    <?PHP
                                        $sql = "SELECT '0' as idinput, brId, tgl, noslip, jumlah, nama_pengusaha, noseri, tgl_fp, "
                                               . " jasa_rp, dpp, ppn, ppn_rp, pph_jns, pph, pph_rp, jenis_dpp, "
                                               . " pembulatan, noseri_pph, tgl_fp_pph, dpp_pph FROM hrd.br0 WHERE "
                                               . " brId='$pidbrno' AND pajak='Y' AND (IFNULL(nama_pengusaha,'')<>'' OR "
                                               . " IFNULL(noseri,'')<>'' OR IFNULL(jasa_rp,'')<>'' OR IFNULL(dpp,0)<>0 OR IFNULL(ppn,0)<>0)  "
                                               . " UNION ";
                                        $sql .= "SELECT a.idinput, a.brId, b.tgl, b.noslip, b.jumlah, a.nama_pengusaha, a.noseri, a.tgl_fp, "
                                               . " a.jasa_rp, a.dpp, a.ppn, a.ppn_rp, a.pph_jns, a.pph, a.pph_rp, a.jenis_dpp, "
                                               . " a.pembulatan, a.noseri_pph, a.tgl_fp_pph, a.dpp_pph "
                                               . " from dbmaster.t_br0_pajak a JOIN hrd.br0 b on a.brId=b.brId WHERE "
                                               . " a.brId='$pidbrno' ";
...
<script>
    ...
    function disp_confirm_pajak(pText_,nid)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                $.ajax({
                    type:"post",
                    url:"module/budget/bgt_brdccdss/simpan_pajakethdsdc.php?module="+module+"&act="+eact+"&idmenu="+idmenu,
    ...
    function disp_edit_data(pText_,nid)  {
        $.ajax({
            type:"post",
            url:"module/budget/bgt_brdccdss/viewpajakeditdsdc.php?module=caridatapajak",
            data:"uid="+nid,
            success:function(data){
    ...
    function disp_hapusdata_pajak(pText_,nid)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                $.ajax({
                    type:"post",
                    url:"module/budget/bgt_brdccdss/simpan_pajakethdsdc.php?module="+module+"&act=hapus&idmenu="+idmenu,
                    data:"uid="+nid,
                    success:function(data){
                        if (data.length > 2) {
                            alert(data);
...
<script>
    ...
    function HitungJumlahUsulan(){
        ...
        ntotalmintarp=parseFloat(njmltotminta)+parseFloat(e_totrpusulan)-parseFloat(njmlmintaedit);
