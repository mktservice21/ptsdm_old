...
if ($pmodule=='entrybrrutinadmcab')
{
    ...
    if ($pact=='hapus') {
        ...
        if (empty($pidcabang) OR empty($pareaid)) {
            
            $query = "select karyawanId as karyawanid, nama, iCabangId as icabangid, areaId as areaid "
        ...
        if (empty($pjbtid) OR empty($pidcabang) OR empty($pareaid)) {
