<?php
    ...
    $query = "select a.*, b.nama as nama_kry, c.nama as nama_cabang, d.nama as nama_area, "
            . " f.nama as nama_atasan1, g.nama as nama_atasan2, h.nama as nama_atasan3, e.nama as nama_atasan4 "
            ...
            . " LEFT JOIN hrd.karyawan as f on a.atasan1=f.karyawanid "
            . " LEFT JOIN hrd.karyawan as g on a.atasan2=g.karyawanid "
            . " LEFT JOIN hrd.karyawan as h on a.atasan3=h.karyawanid "
            . " WHERE a.kode='1' AND "
            . " a.idrutin='$pidrutin' ";
    ...
    if ($pbulanpengajuan<'202107') {
        $query_ttd = "SELECT idrutin, gambar, gbr_atasan1, gbr_atasan2, gbr_atasan3, gbr_atasan4 FROM "
    ...
    if (!empty($gbr1)) {
        ...
        list(, $data)      = explode(',', $data);
        $data = base64_decode($data);
        $namaspv="img_".$pidrutin."SPVA_.png";
...
<HTML>
<HEAD>
    <title>Data Biaya Rutin By Admin Cabang <?PHP echo $printdate." ".$jamnow; ?></title>
            ...
            <table class='tjudul' width='100%'>
                <?PHP
                    echo "<tr>";
                        ...
                        if (empty($pidatasan1) AND empty($pidatasan2) AND empty($pidatasan3)) {//atasan langsung GSM
                            echo "<td align='center'>";
                                echo "Diperiksa oleh :";
                                if (!empty($namagsm)) {
                            ...
                            echo "</td>";
                        }elseif (empty($pidatasan1) AND empty($pidatasan2) AND !empty($pidatasan3)) {//atasan langsung SM
                            ...
                            echo "</td>";
                        }elseif (empty($pidatasan1) AND !empty($pidatasan2)) {//atasan langsung DM
                            echo "<td align='center'>";
                        ...
                        }elseif (!empty($pidatasan1)) {//atasan langsung SPV AM
