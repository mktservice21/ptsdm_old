...
$pdivisi="HO";
    ...
    $query ="SELECT a.karyawanid, b.nama nama_karyawan, a.spv, c.nama nama_spv, 
        ...
        a.icabangid as icabangid, a.areaid as areaid, b.jabatanid as jabatanid,
        b.icabangid as icabangid_h, b.areaid as areaid_h, b.jabatanid as jabatanid_h  
        ...
        LEFT JOIN hrd.karyawan f on a.gsm=f.karyawanId WHERE a.karyawanid='$pkaryawanid'";
    ...
    $pidcabang=$nrs['icabangid'];
    $pidarea=$nrs['areaid'];
    
    if (empty($pidcabang)) {
        $pidcabang=$nrs['icabangid_h'];
        $pidarea=$nrs['areaid_h'];
    }
                            ...
                            echo "<div id='div_detail'>";
                                if ($pstsmobile=="Y") {
                                    ...
                                    echo "<div style='overflow-x:auto;'>";
                                        include "module/budget/bgt_brrutin_admcab/inputdetailmobileadmcb.php";
                                    echo "</div>";
                                }else{
                                    include "module/budget/bgt_brrutin_admcab/inputdetailbradmcb.php";
                                }
                            echo "</div>";
                        ...
                        <h2>
                            ...
                            if (empty($sudahapv)) {
                                ...
                                echo "<div class='col-sm-5'>";
                                    include "module/budget/bgt_brrutin_admcab/ttd_brrutinadmcb.php";
                                echo "</div>";
                                }
...
<script>
    ...
    function ShowDataKaryawan() {
        ...
        $.ajax({
            type:"post",
            url:"module/budget/bgt_brrutin_admcab/viewdatabradmcb.php?module=getdatakaryawan",
    ...
    function showKodePeriode() {
        ...
        $.ajax({
            type:"post",
            url:"module/budget/bgt_brrutin_admcab/viewdatabradmcb.php?module=getkodeperiode",
    ...
    function showPeriode() {
        ...
        $.ajax({
            type:"post",
            url:"module/budget/bgt_brrutin_admcab/viewdatabradmcb.php?module=getperiode",
    ...
    function showDataAbsensi() {
        ...
        $.ajax({
            type:"post",
            url:"module/budget/bgt_brrutin_admcab/viewdatabradmcb.php?module=caridataabsentotal",
    ...
    function ShowDetailInputan() {
        ...
        $.ajax({
            type:"post",
            url:"module/budget/bgt_brrutin_admcab/viewdatabradmcb.php?module=cariinputandetail",
    ...
    function disp_confirm(pText_, ket, data_img) {
        ...
        var iats1 =document.getElementById('e_kdspv').value;
        var iats2 =document.getElementById('e_kddm').value;
        var iats3 =document.getElementById('e_kdsm').value;
        var iats4 =document.getElementById('e_kdgsm').value;
        
        
        if (iats1=="" && iats2=="" && iats3=="" && iats4=="") {
        ...
        $.ajax({
            type:"post",
            url:"module/budget/bgt_brrutin_admcab/viewdatabradmcb.php?module=cekdatasudahada",
            ...
            success:function(data){
                ...
                if (tconfrm_d=="boleh") {
                    ...
                    document.getElementById("d-form1").action = "module/budget/bgt_brrutin_admcab/aksi_brrutinadmincab.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
