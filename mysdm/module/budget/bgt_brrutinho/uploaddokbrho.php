<?PHP
    ...
    $edit = mysqli_query($cnmy, "SELECT * FROM dbmaster.t_brrutin0 WHERE idrutin='$pidrutin'");
    ...
    $pfilterkrypilih="";
    $query ="select distinct karyawanid FROM dbmaster.t_karyawan_posisi WHERE (karyawanid='$pidcard' OR IFNULL(id_admin,'')='$pidcard')";
...
<script>
    ...
    if (ok_) {
        ...
        if (r==true) {
            ...
            document.getElementById("d-form2").action = "module/budget/bgt_brrutinho/aksi_brrutinho.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
...
<div class="">
    ...
    <div class="row">
        ...
        <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=$act&idmenu=$_GET[idmenu]"; ?>' id='d-form2' name='form1' data-parsley-validate class='form-horizontal form-label-left'  enctype='multipart/form-data'>
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    $query = "select * from dbimages.img_brrutin1 where idrutin='$_GET[id]' "
                            . " AND idrutin IN (select distinct IFNULL(idrutin,'') from dbmaster.t_brrutin0 where( userid='$pidcard' "
                            . " OR karyawanid IN $pfilterkrypilih ) and kode=1)";
                    ...
                    if ($ketemu>0) {
                        ...
                        while ($i= mysqli_fetch_array($tampil)) {
                            ...
                            if (!empty($gambar2)) {
                                ...
                                //$namapengaju="img_".$no."IDRUT_.png";
                                $namapengaju="img_".$no."IDRUT_".$pnidrtn."_.png";
