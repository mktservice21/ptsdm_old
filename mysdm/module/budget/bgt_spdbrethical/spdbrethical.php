<?PHP
    ...
    $ptglpilih01="";
    $ptglpilih02="";
    if (isset($_SESSION['SPDBRETKARYA'])) $pkryidpilih=$_SESSION['SPDBRETKARYA'];
    if (isset($_SESSION['SPDBRETTGL01'])) $ptglpilih01=$_SESSION['SPDBRETTGL01'];
    if (isset($_SESSION['SPDBRETTGL02'])) $ptglpilih02=$_SESSION['SPDBRETTGL02'];
...
<div class="">
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>
                <?PHP
                $judul="Permintaan Dana BR Ethical";
                if ($pact=="tambahbaru")
                    echo "Input $judul";
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        var eaksi = "module/budget/bgt_spdbrethical/aksi_spdbrethical..php";
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/budget/bgt_spdbrethical/viewdatatabelpdbreth.php?module="+module+"&idmenu="+idmenu,
                    ...
                    function ProsesDataHapus(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("d-form2").action = "module/budget/bgt_spdbrethical/aksi_spdbrethical..php?module="+module+"&act=hapus&idmenu="+idmenu+"&kethapus="+txt+"&ket="+ket+"&id="+noid;
