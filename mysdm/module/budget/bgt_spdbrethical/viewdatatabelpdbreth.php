<?PHP
    ...
    $_SESSION['SPDBRETKARYA']=$_POST['ukryid'];
    $_SESSION['SPDBRETTGL01']=$_POST['uperiode1'];
    $_SESSION['SPDBRETTGL02']=$_POST['uperiode2'];
...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#datatablespd').DataTable( {
            ...
            "ajax":{
                url :"module/budget/bgt_spdbrethical/mydatapdbreth.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+eaksi+"&ukryid="+ekryid+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
