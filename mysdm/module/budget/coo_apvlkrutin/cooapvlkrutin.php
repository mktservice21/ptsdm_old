<?PHP
    ...
    $aksi="module/budget/coo_apvlkrutin/aksi_apvcutiho.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['COOAPLKRTSTS'])) $apvpilih=$_SESSION['COOAPLKRTSTS'];
    if (!empty($_SESSION['COOAPLKRTBLN1'])) $tgl_pertama=$_SESSION['COOAPLKRTBLN1'];
    if (!empty($_SESSION['COOAPLKRTBLN2'])) $tgl_akhir=$_SESSION['COOAPLKRTBLN2'];
    //if (!empty($_SESSION['COOAPLKRTAPVBY'])) $pkaryawanid=$_SESSION['COOAPLKRTAPVBY'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/budget/coo_apvlkrutin/viewdatatablecooapvlkrtn.php?module="+module+"&idmenu="+idmenu+"&act="+act,
...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="title_left">
            <h3>
                Approve Biaya Rutin & Biaya Luar Kota By COO
            </h3>
                        ...
                        <div class="form-group">
                            <select class='form-control input-sm' id='cb_karyawan' name='cb_karyawan' onchange="KosongkanData()" data-live-search="true">
                                ...
                                if ($pgroupid=="1" OR $pgroupid=="24") {
                                    ...
                                    //$query .= " AND jabatanId NOT IN ('08', '10', '18', '20', '04', '05')";
                                }else{
