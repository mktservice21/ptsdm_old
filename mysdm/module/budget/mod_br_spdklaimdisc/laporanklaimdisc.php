...
<BODY>
    ...
    $query = "select a.idinput, a.karyawanid, a.tgl, a.tglspd, a.divisi, a.nomor, a.nodivisi, a.kodeid, a.subkode, a.jenis_rpt, 
        a.tgl_apv1, a.gbr_apv1, a.tgl_apv2, a.gbr_apv2, a.tgl_dir, a.gbr_dir, a.tgl_dir2, a.gbr_dir2, a.keterangan, 
    ...
    $query = "select a.divisi, a.pengajuan, a.COA4 as coa4, a.klaimId as brid, "
            ...
            . " FROM hrd.klaim as a LEFT JOIN MKT.distrib0 b on a.distid=b.distid "
            . " LEFT JOIN hrd.karyawan as c on a.karyawanid=c.karyawanId "
            . " WHERE 1=1 ";
    $query .=" AND klaimId IN (select DISTINCT IFNULL(bridinput,'') bridinput FROM $tmp02)";
    $query = "create TEMPORARY table $tmp03 ($query)"; 
    mysqli_query($cnmy, $query);
    $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
        
    $query = "ALTER table $tmp03 ADD COLUMN batal varchar(1), ADD COLUMN nama_cabang varchar(150)";
    mysqli_query($cnmy, $query); $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
    ...
    mysqli_query($cnmy, "UPDATE $tmp05 SET amount=jml_adj, jumlah=jml_adj, aktivitas1=ketadj1, aktivitas2=ketadj2");
    $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
    ...
    if ($ketemu>0) {
        ...
        if (!empty($ntgl_keluar)) $ntgl_keluar = date("d F Y", strtotime($ntgl_keluar));
    ...
    <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
        ...
        <tbody>
            <?PHP
                ...
                $query = "select distinct urutan from $tmp04 order by urutan";
                ...
                while ($row1= mysqli_fetch_array($tampil1)) {
                    ...
                    $query = "select * from $tmp04 WHERE IFNULL(urutan,'')='$purutan' order by urutan";
