...
function ReloadTandaTangan(){
        ...
        $('<input type="button" value="Reject" class="btn btn-danger">').bind('click', function(e){
                ProsesDataReject('reject', 'chkbox_br[]')
        }).appendTo($tools)
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            if (ekaryawan=="") {
                alert("Yang akan approve kosong....");
                return false;
            }
            
            $.ajax({
                type:"post",
                url:"module/budget/mod_fin_ttdbyspd/aksi_ttdbyspd.php?module="+module+"&idmenu="+idmenu+"&act=approvedirekturebyfin",
                data:"ket=apvdirfin"+"&uttd="+uttd+"&unobr="+allnobr+"&ukaryawan="+ekaryawan+"&uketapv="+eketapv,
