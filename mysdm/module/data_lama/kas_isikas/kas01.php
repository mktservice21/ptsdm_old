...
<?php
    ...
    user1='$userid', nobukti='$nobukti' WHERE kasid='$kasid'"; //echo"$query";
			...
			$query = "insert into hrd.kas (kasid,karyawanid,nama,periode1,kode,aktivitas1,aktivitas2,jumlah,periode2,user1,nobukti,coa4) 
					  values ('$kasid','$karyawanid','$nama','$periode1','$kodeid','$aktiv1','$aktiv2','$jumlah','$periode2','$userid','$nobukti','$pcoa4pilih')"; //echo"$query";
