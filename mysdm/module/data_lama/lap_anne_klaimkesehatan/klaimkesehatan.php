...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Lap. Klaim Kesehatan</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                    ...
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <div class='input-group date' id='thn01'>
                                                <input type='text' id='tglfrom' name='tahun' required='required' class='form-control' placeholder='tgl awal' value='<?PHP echo $tgl_pertama; ?>' placeholder='dd mmm yyyy' Readonly>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-6'>
                                        <input type="checkbox" id="detail" name="detail" value="D" checked> Detail
                                        <input type="checkbox" id="rekap" name="rekap" value="R" checked> Rekap
                                    </div>
                                </div>
