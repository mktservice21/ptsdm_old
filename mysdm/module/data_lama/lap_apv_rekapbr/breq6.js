...
function get_dokter() {   
   ...
   document.getElementById("breq100").action = "breq100.php";
   document.getElementById("breq100").submit();
}
...
function disp_confirm(pText_)  {
	...
	if (ok_) {
		...
		if (r==true) {
			...
			document.getElementById("breq100").action = "breq101.php";
			document.getElementById("breq100").submit();
			return 1;
		}
	} else {
...
function disp_ks(pText_)  {
	document.getElementById("breq100").action = "ksview2.php";
	document.getElementById("breq100").submit();
	return 1;
}
...
function disp_hapus(pText_)  {
	...
	if (ok_) {
		...
		if (r==true) {
			//document.write("You pressed OK!")
			document.getElementById("breq100").action = "breq202.php";
			document.getElementById("breq100").submit();
			return 1;
		}
	} else {
