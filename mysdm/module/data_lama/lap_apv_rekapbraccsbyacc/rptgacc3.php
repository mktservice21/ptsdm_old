...
<html>
<head>
  <title>Rekap Budget Request via SBY</title>
...
<body>
<form id="rptgacc3" action="rptgacc2.php" method=post>
<?php
	   ...
	   if ($_SESSION['JABATANID']=='12' OR $_SESSION['GROUP']=='1') { //adm       
			if ($divprodid=="PIGEO" or $divprodid=="PEACO") {
				$query = "select * from hrd.br0 where divprodid='$divprodid'
						  and via='Y' and app_acc='$periode' order by app_acc"; //echo"$query";// and tgl <= '$akhir'";
			} else {
