...
function showCOANya(divisi, coa){
    ...
    $.ajax({
        type:"post",
        url:"module/data_lama/lap_br_dccdss/viewdata.php?module=viewdatacombocoa&data1="+ediv+"&data2="+coa,
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Bulanan DCC dan DSS</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                            ...
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        ...
                                        <?PHP
                                          $query = "select cabang.iCabangId, cabang.nama from dbmaster.icabang as cabang where cabang.aktif='Y' order by nama"; 
                                          $query = "select DISTINCT cabangid iCabangId, nama from hrd.br_area where nama <> '' and aktif='Y' order by nama"; 
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="divprodid" name="divprodid" onchange="showCOANya('divprodid', 'kodeid')">
                                            <?PHP
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="kodeid" name="kodeid">
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <div class='input-group date' id='thn01'>
                                                <input type='text' id='tahun1' name='tahun1' required='required' class='form-control' placeholder='tgl awal' value='<?PHP echo $tgl_pertama; ?>' placeholder='dd mmm yyyy' Readonly>
