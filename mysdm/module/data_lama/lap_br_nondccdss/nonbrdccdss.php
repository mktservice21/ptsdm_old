...
function showCOANya(divisi, coa){
    ...
    $.ajax({
        type:"post",
        url:"module/data_lama/lap_br_nondccdss/viewdata.php?module=viewdatacombocoa&data1="+ediv+"&data2="+coa,
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Bulanan NON DCC dan DSS</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
