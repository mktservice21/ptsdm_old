                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-6'>
                                        <input type="checkbox" id="chklamp" name="chklamp" value="L"> Lampiran
                                        <input type="checkbox" id="chklamp1" name="chklamp1" value="C"> CA
                                        <input type="checkbox" id="chklamp2" name="chklamp2" value="S">  Via Surabaya
                                    </div>
                                </div>
