...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>View/Edit/Delete BR OTC by Tgl. Transfer</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                    ...
                    <div class='col-md-6 col-xs-12'>
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Periode Tgl Transfer <span class='required'></span></label>
                                    <div class='col-md-6'>
                                        <div class="form-group">
