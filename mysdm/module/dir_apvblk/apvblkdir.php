<?php
    $aksi="module/dir_apvblk/aksi_apvblkdir.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['DIRBLKAPVTGL1'])) $tgl_pertama = $_SESSION['DIRBLKAPVTGL1'];
    if (!empty($_SESSION['DIRBLKAPVTGL2'])) $tgl_akhir = $_SESSION['DIRBLKAPVTGL2'];
    if (!empty($_SESSION['DIRBLKAPVKET'])) $apvpilih = $_SESSION['DIRBLKAPVKET'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/dir_apvblk/viewdatatable.php?module="+ket,
