<?php
    ...
    $kodeinput = " AND kode=2 ";//untuk BLK
    ...
    $_SESSION['DIRBLKAPVKET'] = $cket;
    $_SESSION['DIRBLKAPVTGL1'] = $mytgl1;
    $_SESSION['DIRBLKAPVTGL2'] = $mytgl2;
    ...
    $sql.=" AND ( (Date_format(periode1, '%Y-%m') between '$tgl1' and '$tgl2') OR (Date_format(periode2, '%Y-%m') between '$tgl1' and '$tgl2') OR (Date_format(tgl, '%Y-%m') between '$tgl1' and '$tgl2') ) ";
...
<script>
    ...
    function ProsesData(ket, cekbr){
        ...
        $.ajax({
            type:"post",
            url:"module/dir_apvblk/aksi_apvblkdir.php?module="+module+"&idmenu="+idmenu+"&act="+ket,
