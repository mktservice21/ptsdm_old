...
if ($module=="appdirca") {
    ...
    if (!empty($noidbr) AND !empty($karyawanapv)) {
        ...
        if ($act=="simpan_ttdallam") {
            ...
            mysqli_query($cnmy, "update $dbname.t_ca0 set dir='$karyawanapv', tgl_dir=NOW(), gbr_dir='$gbrapv' WHERE idca in $noidbr $apvfinance");
            ...
            mysqli_query($cnmy, "update $dbname.t_ca0 set dir=NULL, tgl_dir=NULL, gbr_dir=NULL WHERE idca in $noidbr $apvfinance");
            $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; exit; }
            ...
            mysqli_query($cnmy, "update $dbname.t_ca0 set stsnonaktif='Y', "
