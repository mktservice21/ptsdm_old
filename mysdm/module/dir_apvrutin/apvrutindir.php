<?php
    $aksi="module/dir_apvrutin/aksi_apvrutindir.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['DIRRTNAPVTGL1'])) $tgl_pertama = $_SESSION['DIRRTNAPVTGL1'];
    if (!empty($_SESSION['DIRRTNAPVTGL2'])) $tgl_akhir = $_SESSION['DIRRTNAPVTGL2'];
    if (!empty($_SESSION['DIRRTNAPVKET'])) $apvpilih = $_SESSION['DIRRTNAPVKET'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/dir_apvrutin/viewdatatable.php?module="+ket,
