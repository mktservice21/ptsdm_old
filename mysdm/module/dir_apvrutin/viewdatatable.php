<?php
    ...
    $kodeinput = " AND kode=1 ";//untuk RUTIN
    ...
    $_SESSION['DIRRTNAPVKET'] = $cket;
    $_SESSION['DIRRTNAPVTGL1'] = $mytgl1;
    $_SESSION['DIRRTNAPVTGL2'] = $mytgl2;
    ...
    $sql.=" AND ( (Date_format(bulan, '%Y-%m') between '$tgl1' and '$tgl2') OR (Date_format(tgl, '%Y-%m') between '$tgl1' and '$tgl2') ) ";
...
<script>
    ...
    function ProsesData(ket, cekbr){
        ...
        $.ajax({
            type:"post",
            url:"module/dir_apvrutin/aksi_apvrutindir.php?module="+module+"&idmenu="+idmenu+"&act="+ket,
