                    ...
                    <div class='x_panel'>
                        <div class='x_content form-horizontal form-label-left'>
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-xs-9'>
                                    <select class='soflow' name='cb_cabangid' id='cb_cabangid' onchange="ShowDataArea()">
                                        <?php
                                        echo "<option value='' selected>--Pilih--</option>";
                                        if ($fjbtid=="38") {
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-xs-9'>
                                    <select class='soflow' name='cb_custid' id='cb_custid' onchange="">
                                        <?php
                                        echo "<option value='' selected>--Pilih--</option>";
                                        if (!empty($pidcabang) AND !empty($pidarea)) {
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-xs-6'>
                                    <input type='text' id='e_sdmbonus' name='e_sdmbonus' class='form-control col-md-7 col-xs-12 inputmaskrp2' onblur="" value='<?PHP echo $pbonus; ?>' >
                                </div>
                            </div>
