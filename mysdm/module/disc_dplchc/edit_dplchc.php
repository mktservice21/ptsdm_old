...
if ($pact=="editdata"){
    ...
    $query = "SELECT * FROM dbdiscount.t_dpl WHERE nourut='$pidbr'";
    ...
    $pnodpl=$row['nodpl'];
    $ptahun=$row['tahun'];
    $pidsemester=$row['semester'];
    $pnotes=$row['keterangan'];
    $pidproduk=$row['iprodid'];
    
    $pdistcount=$row['discount'];
    $pbelimin=$row['beli_min'];
    $pbelimax=$row['beli_max'];

    $pnmproduk= getfield("select nama as lcfields from MKT.iproduk WHERE iprodid='$pidproduk'");
                        ...
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <input type='hidden' id='e_idprod' name='e_idprod' class='form-control col-md-7 col-xs-12' value='<?PHP echo $pidproduk; ?>' Readonly>
                                        <input type='text' id='e_nmprod' name='e_nmprod' class='form-control col-md-7 col-xs-12' value='<?PHP echo $pnmproduk; ?>' Readonly>
                                    </div>
                                </div>
                                
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Pembelian Minimal <span class='required'></span></label>
                                    <div class='col-xs-3'>
                                        <input type='text' id='e_belimin' name='e_belimin' class='form-control col-md-7 col-xs-12 inputmaskrp2' onblur="" value='<?PHP echo $pbelimin; ?>' >
                                    </div>
                                </div>
                                
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Pembelian Maksimal <span class='required'></span></label>
                                    <div class='col-xs-3'>
                                        <input type='text' id='e_belimax' name='e_belimax' class='form-control col-md-7 col-xs-12 inputmaskrp2' onblur="" value='<?PHP echo $pbelimax; ?>' >
                                    </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-3'>
                                        <input type='text' id='e_discount' name='e_discount' class='form-control col-md-7 col-xs-12 inputmaskrp2' onblur="" value='<?PHP echo $pdistcount; ?>' >
                                    </div>
                                </div>
