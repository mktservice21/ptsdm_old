<?PHP
    ...
    $_SESSION['DKDMSTDOKTCAB']=$pcabangid;
...
<script>
    $(document).ready(function() {
        var aksi = "module/dkd/dkd_masterdokter/aksi_masterdokterdkd.php";
        ...
        var dataTable = $('#dtabelmstdr').DataTable( {
            ...
            "ajax":{
                url :"module/dkd/dkd_masterdokter/mydata_dr.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&ucabid="+ecabid, // json datasource
