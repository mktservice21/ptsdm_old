                                    ...
                                    <div class='x_content'>
                                        ...
                                        <table id='dtabel' class='table table-striped table-bordered' width='100%'>
                                            ...
                                            <?PHP
                                                ...
                                                if ($pact=="tambahbaru" OR $pact=="editdata") {
                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'>
                                ...
                                <div hidden class='form-group'>
                                    ...
                                    <div class='col-xs-4'>
                                        <select class='soflow' name='cb_jv' id='cb_jv' onchange="">
                                            <?php
                                            echo "<option value='EC' selected>Extra Call</option>";
                                            ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>&nbsp; <span class='required'></span></label>
                                    <div class='col-xs-9'>
                                        <button type='button' class='btn btn-dark btn-xs add-row' onclick=''>&nbsp; &nbsp; &nbsp; Tambah Extra Call &nbsp; &nbsp; &nbsp;</button>
                                    </div>
                                </div>
                                        ...
                                        <table id='dtabel' class='table table-striped table-bordered' width='100%'>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width='10px' align='center' class='divnone'></th><!--class='divnone' -->
                                                    <th width='5px' align='center'>&nbsp;</th>
                                                    <th width='5px' class='divnone' align='center'>EC</th>
                                            ...
                                            <?PHP
                                                ...
                                                if ($pact=="tambahbaru" OR $pact=="editdata") {
                                                    ...
                                                    while ($nrd= mysqli_fetch_array($tampild)) {
                                                        ...
                                                        $pchkpilih="<input type='checkbox' name='record'>";
                                                        $pbuton="<button type='button' class='btn btn-warning btn-xs' onclick=\"EditDataDetail('chkbox_br[]', '$nnjmlrc')\">Edit</button>";
                                                        if ($pjenis<>"EC") {
                                                            $pnmjenis="";
                                                            $pbuton="";
                                                            $pchkpilih="";
                                                        ...
                                                        echo "<td nowrap class='divnone'>$pnmjenis<input type='hidden' id='m_jv[$nnjmlrc]' name='m_jv[$nnjmlrc]' value='$pnmjenis'></td>";
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".add-row").click(function(){
            ...
            markup += "<td nowrap class='divnone'>" + i_jv + "<input type='hidden' id='m_jv["+i_idjmlrec+"]' name='m_jv["+i_idjmlrec+"]' value='"+i_jv+"'></td>";
            ...
            markup += "<td >" + i_saran + "<span hidden><textarea class='form-control' id='txt_saran["+i_idjmlrec+"]' name='txt_saran["+i_idjmlrec+"]'>"+i_saran+"</textarea></span></td>";
            markup += "</tr>";
    ...
    function EditDataDetail(xchk, xidjmlrec) {
        ...
        var xsaran = document.getElementById('txt_saran['+xidjmlrec+']').value;     
        ...
        document.getElementById('e_saran').value=xsaran;
                ...
                if (data=="boleh") {
                    ...
                    if (ok_) {
                        ...
                        if (r==true) {
                            ...
                            document.getElementById("form_data1").action = "module/dkd/dkd_realwekplan/aksi_realwekplan.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
