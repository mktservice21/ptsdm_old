...
function simpandatattd() {
    var ket="simpandatattdvstpln";
    ...
    document.getElementById("d-form2").action = "module/dkd/dkd_ttddkdvisit/aksi_ttddkdvisit.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
