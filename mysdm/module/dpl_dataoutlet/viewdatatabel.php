...
<script>
    $(document).ready(function() {
        var aksi = "module/dpl_dataoutlet/aksi_dataoutlet.php";
        ...
        var dataTable = $('#datatableotldpl').DataTable( {
            ...
            "ajax":{
                url :"module/dpl_dataoutlet/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi, //+"&uidjabatan="+eidjabatan // json datasource
