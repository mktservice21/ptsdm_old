...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Incentive AM/SPV</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
                            ...
                            <div class='col-md-6 col-xs-12'>
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group'>
                                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>AM/SPV <span class='required'></span></label>
                                                ...
                                                <select class='form-control' name='cb_karyawan' id='cb_karyawan' onchange="">
                                                    ...
                                                    if ($pidjabatan=="18" OR $pidjabatan=="10") {
                                                        ...
                                                        if ($pidkaryawan=="0000000158") {
                                                            $query_data = "select distinct a.karyawanid as karyawanid, b.nama as nama 
                                                                from sls.ispv0 as a join ms.karyawan as b on a.karyawanid=b.karyawanid 
