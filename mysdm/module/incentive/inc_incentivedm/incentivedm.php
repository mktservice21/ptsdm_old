...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Incentive DM</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
            ...
            default:
                ...
                <script type="text/javascript">
                    ...
                    function showDataKaryawan() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/incentive/viewdatainc.php?module=viewdatadmidkary",
                            data:"ubulan="+ibulan,
                            beforeSend: function () {
