<?PHP
    ...
    $pidkaryawan="";
    if (!empty($_SESSION['KSDTDRKRY'])) $pidkaryawan = $_SESSION['KSDTDRKRY'];
...
<div class="">
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/ks_datauserdr/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        var eaksi = "module/ks_datauserdr/aksi_datauserdr.php";
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/ks_datauserdr/viewdatatabel_ksusrdr.php?module=viewdata",
