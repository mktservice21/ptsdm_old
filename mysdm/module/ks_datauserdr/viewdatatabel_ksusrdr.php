<?PHP
    ...
    $_SESSION['KSDTDRKRY']=$_POST['ukryid'];
...
<script>
    $(document).ready(function() {
        var aksi = "module/ks_datauserdr/aksi_datauserdr.php";
        ...
        var dataTable = $('#datatablekasbon').DataTable( {
            ...
            "ajax":{
                url :"module/ks_datauserdr/mydata_ksusrdr.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&uidkry="+eidkry+"&uidpilihkry="+eidpilihkry, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/ks_datauserdr/aksi_datauserdr.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+"&ket="+ket+"&id="+noid;
