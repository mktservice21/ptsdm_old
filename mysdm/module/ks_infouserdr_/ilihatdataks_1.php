...
/*
	...
	*/
	...
	$query = "SELECT * FROM hrd.br0 WHERE dokterid='$dokterid'";
	...
	while ($mulai <= $akhir) {
		...
		$total__ = show_kartu($srid,$tglawal1,$mulai,$dokterid,$cn,$br,$tmp00); 
...
function show_kartu($psrid,$ptglawal_,$pbulan,$pdokterid,$pcn,$br,$tmp00) {
  //kartu status	
