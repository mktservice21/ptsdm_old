...
$sql = "select a.idapotik, a.nourut_ks, a.srid as srid, a.bulan as bulan, "
...
$sql.=" FROM hrd.ks1 as a JOIN hrd.dokter as b on a.dokterid=b.dokterId "
        ...
        . " LEFT JOIN hrd.mr_apt as d on a.idapotik=d.idapotik ";//a.aptid=d.aptId AND a.srid=d.srid 
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $pidpilih=$pkaryawanid."".$ppilihdoktid."".$pbulan_pl."".$pidapotik."".$idno."".$pnourutks;
    ...
    $phapus="<input type='button' value='Hapus' class='btn btn-danger btn-xs' onClick=\"ProsesDataHapus('hapus', '$pidpilih')\">";
