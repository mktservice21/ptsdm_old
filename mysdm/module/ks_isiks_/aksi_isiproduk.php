                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-4'>
                                        ...
                                        <input type='text' class='form-control' id='txt_nmapotik' name='txt_nmapotik' value='<?PHP echo "$ppilaptnm ($ppilaptid)"; ?>' Readonly>
                                    </div>
                                </div>
