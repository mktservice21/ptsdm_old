<?php
    ...
    $bnmdrcari="";
    if (!empty($_SESSION['KSLSTDRNEW'])) $bnmdrcari=$_SESSION['KSLSTDRNEW'];
...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="title_left">
            <h3>
                <?PHP
                $judul="Lihat Inputan KS Dokter Baru";
                if ($pact=="tambahbaru")
                    echo "Input $judul";
            ...
            default:
                ...
                <script>
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/ks_lihatinputksdrbaru/viewdatatabel_lihatinputks.php?module="+module+"&idmenu="+idmenu+"&act="+act+"&unmdokt="+enmdokt,
