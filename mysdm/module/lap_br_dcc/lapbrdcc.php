<?PHP include "module/lap_br_dcc/fungsi_combo.php"; ?>
<script>
    ...
    function selectRegionCekBox(data){
        ...
        $.ajax({
            type:"post",
            url:"module/lap_br_dcc/viewdata.php?module=viewregioncab&data1="+cB+"&data2="+cB,
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Budget Request</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
