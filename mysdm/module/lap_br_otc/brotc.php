...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Budget Request OTC</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                                ...
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group'>
                                            <label class='control-label col-md-3 col-sm-3 col-xs-12' for='cb_tgltipe'>Periode By <span class='required'></span></label>
                                            <div class='col-xs-9'>
                                        ...
                                        <div class='form-group'>
                                            <label class='control-label col-md-3 col-sm-3 col-xs-12' for='e_dokter'>Report Tipe <span class='required'></span></label>
                                            <div class='col-xs-9'>
                                                <select class='form-control' id="cb_rpttipe" name="cb_rpttipe">
