...
<script>
    function SelAllCheckBox(nmbuton, data){
        ...
        if (nmbuton=="chkbtndivprod"){
            ...
            $.ajax({
                type:"post",
                url:"module/lap_br_realisasi/viewdata.php?module=viewkodedivisi&data1="+mycek,
    ...
    function selectRegionCekBox(data){
        ...
        $.ajax({
            type:"post",
            url:"module/lap_br_realisasi/viewdata.php?module=viewregioncab&data1="+cB+"&data2="+cB,
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Realisasi Budget Request</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                                ...
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group grp-periode'>
                                            <label class='control-label control-periode col-md-3 col-sm-3 col-xs-12' for='thn01'>Periode <span class='required'></span></label>
                                            <div class='col-md-6'>
                                                <div class="form-group grp-periode">
                                                    <div class='input-group date input-periode' id='thn01'>
                                                    ...
                                                    <!--
                                                    <div class='input-group date' id='thn02'>
                                                        <input type='text' id='thn02' name='e_periode02' required='required' class='form-control' placeholder='tgl akhir' value='<?PHP echo $tgl_akhir; ?>' placeholder='dd mmm yyyy' Readonly>
                                                        <span class="input-group-addon">
                                                           <span class="glyphicon glyphicon-calendar"></span>
                                                        </span>
                                                    </div>
