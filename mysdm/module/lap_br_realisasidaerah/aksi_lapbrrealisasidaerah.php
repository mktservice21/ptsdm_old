...
<?php
    ...
    $query = "select a.brId, a.divprodid, a.kode, b.nama nama_kode, c.region, a.idcabang icabangid, c.nama nama_cabang, a.jumlah, a.jumlah1 from hrd.br0 a 
   ...
   //FORMAT(realisasi1,2,'de_DE') as  
    $sql = "select divprodid, region_ytd region, idcabang icabangid, nama_ytd nama_cabang, kode, nama_kode, sum(jumlah) as jumlah, sum(jumlah1) as jumlah1 "
            . " from dbmaster.v_br0_all where "
            . " DATE_FORMAT(tgltrans,'%Y-%m-%d') between '$periode01' and '$periode02' and retur<>'Y' "
            . " $karyawan $filterdivprod $filterkode $filtercab $filterdok"
            . " $fillamp $filca $filvia $kodeit";
    $sql .= "group by divprodid, region, icabangid, nama_cabang, kode, nama_kode";
    ...
    echo "<table width='100%' align='center' border='0' class='table table-striped table-bordered'>";
        echo "<tr>";
            ...
            echo "<td valign='top'>";
                ...
                echo "<tr><td align='left'><center><h1>Report Realisasi Budget Request Per Daerah</h1></center></td></tr>";
