<?PHP include "module/lap_br_realisasidaerahbln/fungsi_combo.php"; ?>
<script>
    ...
    function selectRegionCekBox(data){
        ...
        $.ajax({
            type:"post",
            url:"module/lap_br_realisasidaerahbln/viewdata.php?module=viewregioncab&data1="+cB+"&data2="+cB,
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h4>Laporan Realisasi Budget Request Per Daerah Per Bulan</h4></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                                ...
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group grp-periode'>
                                            ...
                                            <div class='col-md-6'>
                                                <div class="form-group grp-periode">
                                                    <div class='input-group date input-periode' id='cbln01'>
                                                    ...
                                                    <div class='input-group date input-periode' id='cbln01'>
                                                        <input type='text' id='cbln01' name='e_periode02' required='required' class='form-control' placeholder='tgl akhir' value='<?PHP echo $tgl_akhir; ?>' placeholder='dd mmm yyyy' Readonly>
                                                        <span class="input-group-addon">
                                                           <span class="glyphicon glyphicon-calendar"></span>
                                                        </span>
                                                    </div>
                            ...
                            <div class='col-md-6 col-xs-12'>
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group'>
                                            <label class='control-label col-md-3 col-sm-3 col-xs-12'>Cabang &nbsp;<input type="checkbox" id="chkbtndaerah" value="deselect" onClick="SelAllCheckBox('chkbtndaerah', 'chkbox_cabangdaerah[]')" checked/><span class='required'></span></label>
                                            <div class='col-md-9 col-sm-9 col-xs-12'>
