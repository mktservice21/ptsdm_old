<?PHP include "module/lap_br_realisasidaerahcab/fungsi_combo.php"; ?>
<script>
    ...
    function selectRegionCekBox(data){
        ...
        $.ajax({
            type:"post",
            url:"module/lap_br_realisasidaerahcab/viewdata.php?module=viewregioncab&data1="+cB+"&data2="+cB,
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h4>Laporan Realisasi Budget Request Per Cabang</h4></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
