...
if ($module=='datakaryawan' AND $act=='update')
{
    ...
    if (!empty($pkaryawan)) {
        ...
        mysqli_query($cnit, "UPDATE hrd.karyawan set AKTIF='$paktif', atasanId='$patasan', jabatanId='$pjabatan', iCabangId='$pidcabang', areaId='$pareaid', divisiId='$pdivisi' WHERE karyawanId='$pkaryawan'");
