<?php
    ...
    if ($ppilihrpt=="excel") {
        ...
        header("Content-Disposition: attachment; filename=Laporan_Budget_Request_By_Karyawan.xls");
    }
...
<HTML>
<HEAD>
    <title>Laporan Budget Request By Karyawan</title>
...
<div id='n_content'>
    ...
    <center><div class='h1judul'>Laporan Budget Request By Karyawan</div></center>
