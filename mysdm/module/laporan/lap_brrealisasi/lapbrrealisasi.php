<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Laporan Realisasi Budget Request Ethical</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
                                            ...
                                            <div class='col-md-6'>
                                                <div class="form-group grp-periode">
                                                    <div class='input-group date grp-periode' id='thn01'>
                                                        <input type='text' id='e_periode01' name='e_periode01' required='required' class='form-control' placeholder='tgl awal' value='<?PHP echo $tgl_pertama; ?>' placeholder='yyyy' Readonly>
