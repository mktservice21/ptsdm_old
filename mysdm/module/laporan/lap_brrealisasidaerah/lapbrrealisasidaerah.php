<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Laporan Realisasi BR (DCC/DSS) Ethical Per Daerah</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
        include "module/laporan/lap_brrealisasidaerah/fungsi_combo.php";
            ...
            default:
                ...
                <script>
                    ...
                    function selectRegionCekBox(data){
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/laporan/lap_brrealisasidaerah/viewdata.php?module=viewregioncab&data1="+cB+"&data2="+cB,
