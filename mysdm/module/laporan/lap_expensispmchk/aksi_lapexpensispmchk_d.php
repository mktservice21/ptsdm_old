<?php
    ...
    if ($ppilihrpt=="excel") {
        ...
        header("Content-Disposition: attachment; filename=Laporan_Detail_Expenses_CHC_PM.xls");
    }
...
<HTML>
<HEAD>
    <title>Laporan Detail Expenses CHC By PM</title>
...
<div id='n_content'>
    ...
    <center><div class='h1judul'>Laporan Detail Expenses CHC By PM</div></center>
    
    <div id="divjudul">
        <table class="tbljudul">
            <?PHP
            echo "<tr> <td>Periode </td> <td>:</td> <td><b>$tgl01 s/d. $tgl02</b></td> </tr>";
