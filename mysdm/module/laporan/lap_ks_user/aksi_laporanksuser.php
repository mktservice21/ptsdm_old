<?php
    ...
    if ($ppilihrpt=="excel") {
        ...
        header("Content-Disposition: attachment; filename=Laporan Monitoring User KS.xls");
    }
...
//echo "$pidkaryawan = $nmkaryawan ($pjbtid)<br/>cabang : $filtercabang, KRY : $filterkaryawan"; goto hapusdata;
...
<HTML>
<HEAD>
    <title>Laporan Monitoring User KS</title>
...
<div id='n_content'>
    ...
    <center><div class='h1judul'>Laporan Monitoring User KS</div></center>
