...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Sewa Rumah</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div class='col-sm-6'>
                                    ...
                                    <div class="form-group">
                                        <div class='input-group date' id='cbln02'>
                                            <input type='text' id='e_periode02' name='e_periode02' required='required' class='form-control' placeholder='tgl awal' value='<?PHP echo $tgl_pertama; ?>' placeholder='dd mmm yyyy' Readonly>
                                            <span class="input-group-addon">
                                               <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class='input-group date' id='cbln01'>
                                            <select class='form-control' name='cb_divisi' id='cb_divisi' style='width: 100%;' onchange="">
                                                ...
                                                <?PHP
                                                $query = "select divprodid, nama from MKT.divprod WHERE br='Y' and divprodid NOT IN ('OTHER', 'OTHERS') order by divprodid";
                                ...
                                <div class='col-sm-8'>
                                    ...
                                    <div class="form-group">
                                        <div class='input-group date' id='cbln01'>
                                            <select class='form-control' name='cb_rpttype' id='cb_rpttype' style='width: 100%;' onchange="">
                                                <option value='D'>No Divisi</option>                                                
                                                <option value='T' selected>Tgl Transfer</option>
                                                <option value='B'>Bulan Transfer</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
