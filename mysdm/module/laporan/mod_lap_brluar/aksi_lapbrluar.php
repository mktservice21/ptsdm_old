...
<?php
    ...
    $tmp02 =" dbtemp.DTBRRTNOTC02_".$_SESSION['IDCARD']."_$now ";
    $tmp03 =" dbtemp.DTBRRTNOTC03_".$_SESSION['IDCARD']."_$now ";
	...
	br.divisi,
	br.tgltrans,
	br.jmltrans, br.icabangid, br.areaid
        FROM dbmaster.t_brrutin0 br WHERE br.divisi<>'OTC' AND br.kode=2 AND br.stsnonaktif <> 'Y' $fperiode $fdivisi $fstsapv ";
    
    $query = "create temporary table $tmp01 ($query)";
    mysqli_query($cnit, $query);
    $erropesan = mysqli_error($cnit); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
                    
    $query = "select br.*, b1.nourut, b1.nobrid, b1.qty, b1.rp, b1.rptotal, b1.notes, b1.coa, i.nama nama_brid, c1.NAMA4 nama_coa, k.nama "
            . " from $tmp01 br "
            . " JOIN dbmaster.t_brrutin1 AS b1 ON b1.idrutin = br.idrutin LEFT JOIN dbmaster.t_brid AS i "
            . " ON b1.nobrid = i.nobrid LEFT JOIN dbmaster.coa_level4 c1 ON c1.COA4 = b1.coa "
            . " LEFT JOIN hrd.karyawan AS k ON br.karyawanid = k.karyawanId ";
    $query = "create temporary table $tmp02 ($query)";
    mysqli_query($cnit, $query);
    $erropesan = mysqli_error($cnit); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
    
    $query = "select br.*, c.nama nama_cabang, aa.Nama nama_area "
            . " FROM $tmp02 br "
        ...
        <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
            ...
            <tbody>
                <?PHP
                    ...
                    $total=0;
                    $query = "select * from $tmp03 order by periode1, periode2, nama, idrutin, nobrid";
