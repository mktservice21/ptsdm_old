<?PHP
    ...
    if ($_GET['ket']=="excel") {
        ...
        header("Content-Disposition: attachment; filename=LAPORAN $nmtipe BIAYA LUAR KOTA OTC.xls");
    }
...
<html>
<head>
    <title>LAPORAN <?PHP echo $nmtipe; ?> BIAYA LUAR KOTA OTC</title>
...
<?php
    ...
    $query = "select idrutin, kode, tgl, bulan, kodeperiode, periode1, periode2,
        ...
        AND kode='2' $fperiode $fkaryawan $fcabang";
...
if ($erptby=="S") {
?>
    <center><h2><u>LAPORAN BIAYA LUAR KOTA OTC</u></h2></center>
...
?>
    <center><h2><u>LAPORAN DETAIL COA BIAYA LUAR KOTA OTC</u></h2></center>
