...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Klaim Pengobatan</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                    ...
                    <div class='col-md-6 col-xs-12'>
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                    ...
                                    <div class='col-sm-12'>
                                        ...
                                        <div class="form-group">
                                            <select class='form-control' id="cb_karyawan" name="cb_karyawan">
                                                <?PHP
                                                $query = "select karyawanId, nama from hrd.karyawan WHERE IFNULL(nama,'')<>'' ";
                                                ...
                                                while ($z= mysqli_fetch_array($tampil)) {
                                                    $pnamakry=$z['nama'];
                                                    echo "<option value='$z[karyawanId]'>$pnamakry</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class='form-group'>
                                    <div class='col-sm-12'>
                                        <b>Jenis Pengobatan</b> <input type="checkbox" id="chkjenisobat" value="deselect" onClick="SelAllCheckBox('chkjenisobat', 'chkbox_jnsobat[]')" checked/>
                                        <div class="form-group">
                                            <div id="kotak-multi2" class="jarak">
                                                <?PHP
                                                    $query = "select * from dbmaster.t_brid a WHERE nobrid in ('10', '11', '16', '17', '18', '19')";
