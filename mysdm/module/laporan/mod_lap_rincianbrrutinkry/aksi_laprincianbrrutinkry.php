<?php
    ...
    if ($ppilihrpt=="excel") {
        ...
        header("Content-Disposition: attachment; filename=Laporan Rincian Biaya Rutin Per Karyawan.xls");
    }
...
$query = "select divisi, idrutin, kodeperiode, bulan, karyawanid, nama_karyawan as nmkaryawan "
        ...
        . " AND IFNULL(kode,0)=1  "
        . " $pfilterapv AND karyawanid='$pidkaryawan' "
...
<HTML>
<HEAD>
    <title>Laporan Rincian Biaya Rutin Per Karyawan</title>
...
<div id='n_content'>
    ...
    <center><div class='h1judul'>Laporan Rincian Biaya Rutin Per Karyawan</div></center>
    
    <div id="divjudul">
        <table class="tbljudul">
            <tr><td>Karyawan</td><td>:</td><td><?PHP echo "<b>$nmkaryawan</b>"; ?></td></tr>
    ...
    <table id='mydatatable1' class='table table-striped table-bordered' width="100%" border="1px solid black">
        ...
        <tbody>
            ...
            echo "<tr>";
            echo "<td colspan='6' align='center'><b>TOTAL</b></td>";
            if ($ppilihrpt=="excel") {
