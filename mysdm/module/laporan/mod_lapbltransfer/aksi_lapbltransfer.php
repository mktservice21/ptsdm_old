...
<?php
    ...
    $query="select a.karyawanid, k.nama nama_kry, b.b_norek, 
         a.nama_karyawan, a.atasan1, a.atasan2, a.atasan3, a.atasan4,
        SUM(a.jumlah) jumlah from dbmaster.t_brrutin0 a 
        ...
        <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
            ...
            <tbody>
                <?PHP
                    ...
                    $query = "select * from $tmp01 order by nama_kry, karyawanid";
                    ...
                    if ($records) {
                        ...
                        while ($reco <= $records) {
                            ...
                            $pnmkaryawan_non=$row['nama_karyawan'];
                            while (($reco <= $records) AND $row['karyawanid']==$pkaryawanid) {
                                
                                $nmkaryawan=$row['nama_kry'];
                                $pnmkaryawan_non=$row['nama_karyawan'];
                                $idkaryawan=$row['karyawanid'];
                                
                                if ($idkaryawan=="0000002200") $nmkaryawan=$pnmkaryawan_non;
