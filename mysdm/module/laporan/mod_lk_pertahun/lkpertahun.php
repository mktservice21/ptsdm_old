...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Biaya Luar Kota Per Tahun</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
...
<script>
    ...
    function ShowDataJabatan(){
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_lk_pertahun/viewdata.php?module=viewdatajabatan",
