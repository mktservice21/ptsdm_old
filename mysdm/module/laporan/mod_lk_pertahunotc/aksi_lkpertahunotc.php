<?PHP
    ...
    if ($ppilihrpt=="excel") {
        ...
        header("Content-Disposition: attachment; filename=LAPORAN LUAR KOTA OTC PER TAHUN.xls");
    }
    ...
    $query = "select idrutin, bulan, karyawanid, nama_karyawan, divisi, icabangid, jumlah,"
            . " atasan1, atasan2, atasan3, atasan4"
            . " from dbmaster.t_brrutin0 WHERE IFNULL(stsnonaktif,'')<>'Y' "
            . " AND kode='2' AND YEAR(bulan)='$ptahun' AND divisi='OTC'";//AND ifnull(tgl_fin,'') <> '' AND ifnull(tgl_fin,'0000-00-00') <> '0000-00-00' 
    ...
    $query = "update $tmp02 a JOIN dbmaster.t_karyawan_kontrak b ON a.nama_karyawan=b.nama AND"
            ...
            . " SET a.karyawanid=b.id, a.icabangid=b.icabangid_o, a.areaid=b.areaid_o WHERE a.karyawanid='0000002200'";
    mysqli_query($cnmy, $query);
...
<html>
<head>
    <title>LAPORAN LUAR KOTA OTC PER TAHUN</title>
