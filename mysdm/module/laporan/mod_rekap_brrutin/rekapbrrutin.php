...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Rekap Biaya Rutin</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-6'>
                                        <select class='form-control input-sm' id='e_periode' name='e_periode' onchange="ShowData()">
                                            <option value="1" selected>Periode 1</option>
                                ...
                                <div hidden class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="sts_apv" name="sts_apv" onchange="ShowData()">
...
<script>
    ...
    function hapus_data(pText, act) {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_rekap_brrutin/viewdata.php?module=hapusdata&act=hapus",
            data:"e_periode="+iperiode+"&bulan1="+ibulan+"&sts_apv="+istsapv+"&unobukti="+inobrdiv+"&uiddata="+inodata,
    ...
    function simpan_data(pText, act) {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_rekap_brrutin/viewdata.php?module=simpandata&act=simpan",
            data:"e_periode="+iperiode+"&bulan1="+ibulan+"&sts_apv="+istsapv+"&unobukti="+inobrdiv+"&uiddata="+inodata,
            success:function(data){
                $("#loading2").html("");
    ...
    function CariBuktiSudahAda() {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_rekap_brrutin/viewdata.php?module=caribuktisudahada",
    ...
    function ShowNoBukti() {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_rekap_brrutin/viewdata.php?module=viewnomorbukti",
            data:"uperiode="+iperiode+"&utgl="+ibulan,
            success:function(data){
    ...
    function HitungTotalJumlahData() {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_rekap_brrutin/viewdata.php?module=hitungtotaldata&act=hitung",
