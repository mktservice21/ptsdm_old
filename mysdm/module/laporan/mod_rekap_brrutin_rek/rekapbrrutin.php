...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Rekap Biaya Rutin Rekening Bank</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
...
<script>
    ...
    function hapus_data(pText, act) {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_rekap_brrutin_rek/viewdata.php?module=hapusdata&act=hapus",
    ...
    function simpan_data(pText, act) {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan/mod_rekap_brrutin_rek/viewdata.php?module=simpandata&act=simpan",
            data:"e_periode="+iperiode+"&bulan1="+ibulan+"&sts_apv="+istsapv+"&unobukti="+inobrdiv+"&uiddata="+inodata,
            success:function(data){
                $("#loading2").html("");
