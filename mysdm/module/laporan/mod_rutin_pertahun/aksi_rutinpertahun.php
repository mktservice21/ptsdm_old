<?PHP
    ...
    if ($ppilihrpt=="excel") {
        ...
        header("Content-Disposition: attachment; filename=LAPORAN BIAYA RUTIN PER TAHUN.xls");
    }
    ...
    <div id="kotakjudul">
        <div id="isikiri">
            <table class='tjudul' width='100%'>
                <tr><td width="150px"><b>LAPORAN BIAYA RUTIN PER TAHUN JANUARI - DESEMBER <?php echo $ptahun; ?></b></td></tr>
            </table>
        </div>
        <div id="isikanan">
