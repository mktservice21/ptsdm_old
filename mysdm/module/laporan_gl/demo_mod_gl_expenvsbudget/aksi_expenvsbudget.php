...
if ($ppilihrpt=="excel") {
    ...
    header("Content-Disposition: attachment; filename=Report Expense VS Budget Demo.xls");
}
...
$query = "SELECT tipe, bulan, coa4, SUM(jumlah) as jumlah FROM dbtest.proses_budget_expenses WHERE "
        . " tahun='$ptahun' ";
...
<HTML>
<HEAD>
  <TITLE>Report Expense VS Budget (DEMO)</TITLE>
...
<BODY onload="initVar()">
    ...
    echo "<div id='div_konten'>";
        ...
        echo "<b>Report Expense VS Budget (DEMO)</b><br/>";
...
?>
    ...
    <script>
        function LihatDataJenis(icoa) {
            ...
            $.ajax({
                type:"post",
                url:"module/laporan_gl/demo_mod_gl_expenvsbudget/aksi_viewdataexpbgt.php?module=viewdatajenis",
