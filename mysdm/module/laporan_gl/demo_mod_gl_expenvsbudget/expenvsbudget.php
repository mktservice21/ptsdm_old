<?php
    ...
    $query = "select * from dbtest.maping_karyawan_dep WHERE karyawanid='$fkaryawan'";
    $tampil2= mysqli_query($cnmy, $query);
    $ketemu2= mysqli_num_rows($tampil2);
    if ((INT)$ketemu2>0) $pbolehpilihdep=true;
    
    
    $query = "select DISTINCT divisi_pengajuan from dbtest.maping_karyawan_dep WHERE karyawanid='$fkaryawan' AND IFNULL(divisi_pengajuan,'')='ALL'";
    $tampil= mysqli_query($cnmy, $query);
    $ketemu= mysqli_num_rows($tampil);
    if ((INT)$ketemu>0) {
        ...
        $query = "select DISTINCT divisi_pengajuan from dbtest.maping_karyawan_dep WHERE karyawanid='$fkaryawan' AND IFNULL(divisi_pengajuan,'') NOT IN ('ALL', '')";
        $tampil= mysqli_query($cnmy, $query);
        $ketemu= mysqli_num_rows($tampil);
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Expense VS Budget (DEMO)</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="cb_dept" name="cb_dept" onchange="ShowDariDepartemen()">
                                            ...
                                            if ($pbolehpilihdep==false) {
                                                ...
                                                if ($psemuadep==false) {
                                                    $query .=" AND iddep IN (select IFNULL(iddep,'') FROM dbtest.maping_karyawan_dep WHERE karyawanid='$fkaryawan')";
                                                }
...
<script>
    ...
    function ShowCoaDariBudget() {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan_gl/demo_mod_gl_expenvsbudget/viewdataexpbgt.php?module=viewdatacoadep",
    ...
    function ShowRegion() {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan_gl/demo_mod_gl_expenvsbudget/viewdataexpbgt.php?module=viewdataregion",
    ...
    function ShowCabang() {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan_gl/demo_mod_gl_expenvsbudget/viewdataexpbgt.php?module=viewdatacabang",
