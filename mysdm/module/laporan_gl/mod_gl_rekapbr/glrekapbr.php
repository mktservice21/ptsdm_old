...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Rekap Budget Request</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
...
<script>
    ...
    function ShowData()  {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan_gl/mod_gl_rekapbr/viewdata.php?module="+imodule,
    ...
    function ShowDataNoBR(nno)  {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan_gl/mod_gl_rekapbr/viewdata.php?module=showdatanobr",
