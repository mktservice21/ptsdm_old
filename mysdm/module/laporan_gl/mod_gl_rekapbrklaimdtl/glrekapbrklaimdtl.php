...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Rekap Detail Budget Request Klaim Discount</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-6'>
                                        <select class='form-control input-sm' id='e_stsspd' name='e_stsspd' onchange="ShowData()">
                                            ...
                                            <option value="2">Permintaan Dana</option>
                                        </select>
                                    </div>
                                </div>
...
<script>
    ...
    function ShowData()  {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan_gl/mod_gl_rekapbrklaimdtl/viewdata.php?module="+imodule,
    ...
    function ShowDataNoBR(nno)  {
        ...
        $.ajax({
            type:"post",
            url:"module/laporan_gl/mod_gl_rekapbrklaimdtl/viewdata.php?module=showdatanobr",
