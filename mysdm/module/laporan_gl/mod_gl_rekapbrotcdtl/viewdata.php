...
?>
    <div class='form-group'>
        <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Tipe Periode <span class='required'></span></label>
        <div class='col-md-6'>
            <select class='form-control input-sm' id='e_ststipe' name='e_ststipe'>
                <option value="I" selected>Input</option>
                <option value="T">Transfer</option>
                <option value="S">Rpt. SBY</option>
...
?>
    ...
    $query = "select a.*, b.nama, b.subnama, FORMAT(a.jumlah,0,'de_DE') rpjumlah from dbmaster.t_suratdana_br a JOIN "
            ...
            . " AND a.divisi IN ('OTC') AND IFNULL(a.pilih,'')='Y'"
            . " order by a.idinput, a.divisi, a.nomor, a.nodivisi";
