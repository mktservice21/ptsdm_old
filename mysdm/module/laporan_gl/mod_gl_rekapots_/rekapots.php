...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Rekap Outstanding Dana Klaim</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                    ...
                    <div class='col-md-6 col-xs-12'>
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="divprodid" name="divprodid">
                                            <?PHP
                                            $query = "select DivProdId from MKT.divprod WHERE br='Y' AND DivProdId NOT IN ('OTC', 'OTHER') ";
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>CA dan Realisasi SPD <span class='required'></span></label>
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="ca_darispd" name="ca_darispd" onchange="BukaTutupLamp()">
...
<script>
    function BukaTutupLamp(){
        var epilchk = document.getElementById('ca_darispd').value;
        if (epilchk=="T") {
            div_lamp.style.display = 'block';
        }else{
            div_lamp.style.display = 'none';
        }
    }
</script>