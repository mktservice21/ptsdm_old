...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Rekap Outstanding Dana Klaim OTC</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="divprodid" name="divprodid">
                                            <?PHP
                                            $query = "select DivProdId from MKT.divprod WHERE br='Y' AND DivProdId IN ('OTC') ";
