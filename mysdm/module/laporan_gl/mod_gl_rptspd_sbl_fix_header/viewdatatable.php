<?php
    ...
    if ($pses_grpuser!="1" AND $pses_grpuser!="22" AND $pses_grpuser!="24" AND $pses_grpuser!="34" AND $pses_grpuser!="41") {//41=audit
                ...
                while ($row= mysqli_fetch_array($tampil)) {
                    ...
                    if ($pdivisi=="OTC") {
                        if ( ($pkode=="1" AND $psubkode=="03") ) {
                            ...
                            $pmymodule2="module=lapbrotcpermo&act=input&idmenu=134&ket=excel&ispd=$idno";
                        }
                    }else{
                        if ($pmystsyginput==1) {
