...
?>
        ...
        <script>
            function ShowDataKaryawanCabang() {
                ...
                $.ajax({
                    type:"post",
                    url:"module/laporan_gl/mod_progresexpen/viewdataprogexp.php?module=viewdatakaryawancabjbt",
        ...
        <div class="">
            ...
            <div class="page-title"><div class="title_left"><h3>Report Progres Budget Request</h3></div></div><div class="clearfix"></div>
                                        ...
                                        <div class='form-group'>
                                            <div class='col-sm-12'>
                                                ...
                                                <div class='input-group date' id='cbln02'>
                                                    <input type="text" class="form-control" id='e_bulan2' name='e_bulan2' required='required' placeholder='MMMM yyyy' value='<?PHP echo $pbulanpilih; ?>' Readonly>
                                                    <span class='input-group-addon'>
                                                        <span class='glyphicon glyphicon-calendar'></span>
                                                    </span>
                                                </div>
