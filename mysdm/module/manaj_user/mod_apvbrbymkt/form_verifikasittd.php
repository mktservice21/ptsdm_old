...
$ptombolappv=$_POST['ubtnapv'];
$pdokterid_uc=$_POST['uiduser'];
$pdokterid = $pdokterid_uc;

$pfilterbrid=$_POST['ubrid'];
$pkryidapv=$_POST['uidkryapv'];
$pkryjbtapv=$_POST['uidjbtapv'];
$pdataimage=$_POST['udataimage'];
$pkrynmapv=$_POST['unmkryapv'];
$pkryjbtnmapv=$_POST['unmjbtapv'];
...
<div class='modal-dialog modal-lg'>
    ...
    <div class='modal-content'>
        ...
        <div class='modal-header'>
            ...
            <h4 class='modal-title'>Confirm - Verifikasi Realisasi Budget Request (KI)</h4>
        </div>
        <br/>
        <div class="">
                        ...
                        <div class='x_panel'>
                            ...
                            <div class='x_content'>
                                <div class='col-md-12 col-sm-12 col-xs-12'>
                                    ...
                                    <div hidden class='form-group'>
                                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Img TTD <span class='required'></span></label>
                                        <div class='col-md-6 col-sm-6 col-xs-12'>
                                            <textarea class='form-control col-md-7 col-xs-12' id='e_imgttd' name='e_imgttd'><?PHP echo $pdataimage; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-8 col-sm-8 col-xs-12'>
                                            <?PHP
                                                echo "<button type='button' class='btn btn-success' onclick=\"disp_confirm_approve('Simpan ?', 'simpanapvreal', '')\">Save</button>";
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-8 col-sm-8 col-xs-12'>
                                            ...
                                            <input type='text' id='e_apvnmkry' name='e_apvnmkry' class='form-control col-md-7 col-xs-12' value='<?PHP echo "$pkrynmapv"; ?>' Readonly>
                                            <input type='text' id='e_apvnmjbt' name='e_apvnmjbt' class='form-control col-md-7 col-xs-12' value='<?PHP echo "$pkryjbtnmapv"; ?>' Readonly>
                                        </div>
                                    </div>
...
<script>
    ...
    function disp_confirm_approve(pText_, ket, data_img) {
        ...
        var data_img =document.getElementById('e_imgttd').value;
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if (iberhasil=="berhasil") {
                            alert(iberhasil);
                            document.getElementById(ibtnapv).disabled=true;
