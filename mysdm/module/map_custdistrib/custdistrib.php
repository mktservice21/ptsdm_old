<?php
    ...
    $piddistpl=$_SESSION['MAPCUSTDISIDCAB'];
    $pidecabpl=$_SESSION['MAPCUSTDISIDARE'];
    $pfilterpl=$_SESSION['MAPCUSTDISFILTE'];
            ...
            default:
                ...
                <script>
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/map_custdistrib/viewdatatabelecustd.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                    ...
                    function ShowDataEcabangDist() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/map_custdistrib/viewdatacustd.php?module=caridataecust",
