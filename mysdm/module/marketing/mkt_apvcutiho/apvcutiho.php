<?PHP
    ...
    $aksi="module/marketing/mkt_apvcutiho/aksi_apvcutiho.php";
    $hari_ini = date("Y-m-d");
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/marketing/mkt_apvcutiho/viewdatatableaapvcutiho.php?module="+module+"&idmenu="+idmenu+"&act="+act,
