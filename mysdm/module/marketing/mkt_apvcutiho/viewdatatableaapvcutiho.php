...
session_start();
    ...
    $now=date("mdYhis");
    $tmp01 =" dbtemp.tmpapvcutiho01_".$userid."_$now ";
    $tmp02 =" dbtemp.tmpapvcutiho02_".$userid."_$now ";
    $tmp03 =" dbtemp.tmpapvcutiho03_".$userid."_$now ";
    ...
    $query .= " AND IFNULL(a.pengajuan,'')='HO' ";
...
<script>
    ...
    function ProsesDataUnApprove(ket, cekbr){
        ...
        $.ajax({
            type:"post",
            url:"module/marketing/mkt_apvcutiho/aksi_apvcutiho.php?module="+module+"&idmenu="+idmenu+"&act="+ket,
