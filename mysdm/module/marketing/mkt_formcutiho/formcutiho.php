...
<div class="">
    ...
    <div class="row">
        ...
        $pcabid_pl=$_SESSION['FCUTICAB'];
        $pjbtid_pl=$_SESSION['FCUTIJBT'];
        $pkryid_pl=$_SESSION['FCUTIKRY'];
        $ptgl1_pl01=$_SESSION['FCUTITGL01'];
        $ptgl1_pl02=$_SESSION['FCUTITGL02'];
            ...
            default:
                ...
                <script>
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/marketing/mkt_formcutiho/viewdatatablefcutiho.php?module="+module+"&idmenu="+idmenu+"&act="+act,
