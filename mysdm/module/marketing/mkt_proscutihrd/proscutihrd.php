<?PHP
    ...
    $aksi="module/marketing/mkt_proscutihrd/aksi_apvcutieth.php";
    $hari_ini = date("Y-m-d");
            ...
            ?>
                ...
                <script>
                    ...
                    function pilihData(ket){
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/marketing/mkt_proscutihrd/viewdatatablefcutihrd.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                <div class='x_panel'>
                                    ...
                                    <div class="well" style="overflow: auto; margin-top: -5px; margin-bottom: 5px; padding-top: 10px; padding-bottom: 6px;">
                                        ...
                                        <input class='btn btn-default' type=button value='Isi Pengajuan (+)' onclick="window.location.href='<?PHP echo "?module=$pmodule&idmenu=$pidmenu&act=tambahbaru"; ?>';">
                                    </div>
