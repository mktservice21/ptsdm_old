...
?>
        ...
        <div class="">
            ...
            <div class="page-title"><div class="title_left"><h3>Report Data Cuti</h3></div></div><div class="clearfix"></div>
                                        ...
                                        <div class='form-group'>
                                            <div class='col-sm-12'>
                                                ...
                                                <div class='input-group date' id='thn01'>
                                                    <input type="text" class="form-control" id='e_tahun' name='e_tahun' required='required' placeholder='yyyy' value='<?PHP echo $ptahun; ?>' Readonly>
