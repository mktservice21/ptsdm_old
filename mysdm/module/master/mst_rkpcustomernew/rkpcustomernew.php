...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="title_left">
            <h3>
                <?PHP
                $judul="Rekap Data Customer/Outlet Baru";
                if ($pact=="tambahbaru")
                    echo "Input $judul";
            ...
            default:
                ...
                <script>
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/master/mst_rkpcustomernew/viewdatatablerkpcust.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                                ...
                                <div class="form-group">
                                    <select class='form-control input-sm' id="cb_cabang" name="cb_cabang" onchange="">
                                        <?PHP
                                            ...
                                            $query_cb .=" AND LEFT(nama,5) NOT IN ('PEA -', 'OTC -')";
                                            if ($fgroupidcard=="1" OR $fgroupidcard=="24") {
                                            }else{
                                                if ($fkaryawan=="0000002329" OR $fkaryawan=="0000000158") {
                                                    $query_cb .=" AND region='B' ";
                                                }elseif ($fkaryawan=="0000000159") {
                                                    $query_cb .=" AND region='T' ";
                                                }else{
                                                    if ($fjbtid=="20") {
