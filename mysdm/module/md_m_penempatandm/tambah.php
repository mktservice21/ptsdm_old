...
function disp_confirm(pText_)  {
    ...
    if (ok_) {
        ...
        if (r==true) {
            ...
            document.getElementById("demo-form2").action = "module/md_m_penempatandm/aksi_penempatandm.php";
...
if ($_GET['act']=="editdata"){
    ...
    $edit = mysqli_query($cnmy, "SELECT * FROM dbmaster.v_penempatandm WHERE icabangid='$_GET[idcab]' "
            . "and karyawanid='$_GET[id]' and Date_format(tgl1,'%Y%m%d')='$_GET[tgl]'");
            ...
            <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=input&idmenu=$_GET[idmenu]"; ?>' 
                ...
                <div class='form-group'>
                    ...
                    <div class='col-md-6 col-sm-6 col-xs-12'>
                        <div class='input-group '>
                        <span class='input-group-btn'>
                            <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal' onClick="getDataKaryawanJbt('e_idkaryawan', 'e_karyawan', '08')">Go!</button>
                        </span>
