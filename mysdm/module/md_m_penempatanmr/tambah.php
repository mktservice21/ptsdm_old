...
function getDataAreaCabang(data1, data2, icabang) {
    ...
    $.ajax({
        type:"post",
        url:"config/viewdata_ms.php?module=viewdataareacabang&data1="+data1+"&data2="+data2,
...
function disp_confirm(pText_)  {
    ...
    if (ok_) {
        ...
        if (r==true) {
            ...
            document.getElementById("demo-form2").action = "module/md_m_penempatanmr/aksi_penempatanmr.php";
...
if ($_GET['act']=="editdata"){
    $act="update";
    $edit = mysqli_query($cnit, "SELECT * FROM dbmaster.v_penempatanmr WHERE icabangid='$_GET[idcab]' and divisiid='$_GET[divisi]' "
            ...
            <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=input&idmenu=$_GET[idmenu]"; ?>' 
                ...
                <div class='form-group'>
                    ...
                    <div class='col-md-6 col-sm-6 col-xs-12'>
                        <select class='form-control' id='cb_divisi' name='cb_divisi'>
                            ...
                            $sql="SELECT DivProdId, nama FROM dbmaster.divprod where br='Y' $fildiv order by nama";
                ...
                <div class='form-group'>
                    ...
                    <div class='col-md-6 col-sm-6 col-xs-12'>
                        <div class='input-group '>
                        <span class='input-group-btn'>
                            <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal' onClick="getDataKaryawanJbt('e_idkaryawan', 'e_karyawan', '15')">Go!</button>
                        </span>
