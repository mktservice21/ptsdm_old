...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Cek Selisih Closing Sales Per Distributor (LAMA)</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/md_m_slscekselisih_lama/aksi_slscekselisih.php?module="+ket,
