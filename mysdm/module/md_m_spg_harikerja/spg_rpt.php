<?PHP
    ...
    $query = "select a.id_spg, a.nama, a.jabatid, a.penempatan, a.icabangid, a.alokid, a.areaid from dbmaster.t_spg_data a where a.id_spg = '$pidspg' AND "
            . " DATE_FORMAT(a.periode,'%Y%m')='$pbulan' ";
    ...
    $pjml_lebihkurang=$sp['lebihkurang'];
...
<div id='n_content'>
    ...
    <div id="kotakjudul">
        <div id="isikiri">
            <table class='tjudul' width='100%'>
                ...
                ?>
                <tr><td width="210px" colspan="2"><b>Standar Hari Kerja Bulan <?PHP echo $nperiode; ?> : Hari <?PHP echo "$pjharikerjasistem"; ?></td></tr>
            </table>
        </div>
        <div id="isikanan">
    ...
    <table id='datatable2' class='table table-striped table-bordered' width="100%" border="1px solid black">
            <thead>
                ...
                <th align="center" nowrap>Selisih (lebih/kurang)</th>
            ...
            <?PHP
                ...
                echo "<td nowrap>$pjml_lebihkurang</td>";
