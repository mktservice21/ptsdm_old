            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function HapusValidate(){
                        ...
                        var etgl1=document.getElementById('tgl1').value;
                        var ket="";
                        var pText_="Hapus Data Posisi Submit";
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                $.ajax({
                                    type:"post",
                                    url:"module/md_m_spg_harikerja/hapus_validasi.php?module="+module+"&act=hapus"+"&idmenu="+idmenu,
                    ...
                    function ValidasiDataInput(){
                        ...
                        var pText_="Data yang sudah di submit tidak bisa diubah dan dihapus.\n\
                                cek kembali datanya...\n\
                                Jika Ingin merubah, hubungi Admin HO OTC!!!\n\
