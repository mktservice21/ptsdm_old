                    ...
                    <div class='x_panel'>
                            ...
                            <div class='col-sm-8'>
                               ...
                               <div class="form-group">
                                   ...
                                   <input type='button' class='btn btn-dark btn-xs' id="s-submit" value="Sudah Proses HOS" onclick="RefreshDataTabel('4')">&nbsp;
                                   <input type='button' class='btn btn-default btn-xs' id="s-submit" value="Sudah Proses FIN" onclick="RefreshDataTabel('5')">&nbsp;
                               </div>
                           </div>
