            ...
            <tbody>
                ...
                while( $sp=mysqli_fetch_array($query) ) {
                    ...
                    if ((double)$pjmlhk==0) {
                        ...
                        $ptotalspg=(double)$pinsentif+(double)$pinsentif_tambahan;
                    }
                    ...
                    echo "<td nowrap $pcolor>$pnmspg $txt_all</td>";
    ...
    function HitungJumlahTotalCexBox() {
        ...
        for(k=0;k< chklength1;k++)
        {
            if (chk_arr1[k].checked == true) {
                ...
                //total per spg
                nTotal_perspg =parseInt(ajml_inc)+parseInt(ajml_incbot)+parseInt(ajml_gptj)+parseInt(ajml_tmakan);
