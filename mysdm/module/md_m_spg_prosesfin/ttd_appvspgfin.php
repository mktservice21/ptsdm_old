...
function ReloadTandaTangan(){
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            $.ajax({
                type:"post",
                url:"module/md_m_spg_prosesfin/simpanpd.php?module=simpan"+"&idmenu="+idmenu+"&act=simpan_ttdallam",
                data:"unoidbr="+allnobr+"&utglpengajuan="+itglpengajuan+"&unobrdiv="+inodivbr+"&uperiode="+iperiode+"&uttd="+uttd,
