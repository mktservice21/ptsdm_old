...
function ReloadTandaTangan(){
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            $.ajax({
                type:"post",
                url:"module/md_m_spg_prosesfin/viewdata.php?module=simpan"+"&idmenu="+idmenu+"&act=simpan_ttdallam",
                data:"ket=approve"+"&uttd="+uttd+"&unoidbr="+allnobr+"&uketapv="+eketapv+"&utipests="+itipests,
