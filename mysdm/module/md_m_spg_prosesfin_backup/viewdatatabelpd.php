<?php
    ...
    $tmp01 = CariDataSPGBR("2", $bulan, $pidcabang, "", $cket);
                ...
                <div class='x_panel'>
                    ...
                    <?PHP }elseif ($cket=="2") { ?>
                        ...
                        <div class='col-sm-3'>
                            <small>&nbsp;</small>
                           <div class="form-group">
                               <input type='button' class='btn btn-danger btn-sm' id="s-submit" value="Hapus No BR" onclick='disp_confirm("hapus", "chkbox_br[]")'>
                           </div>
                       </div>
                    <?PHP } ?>
