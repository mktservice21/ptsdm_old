...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left">
            <h2>
                <?PHP
                $judul="Approve Data SPG Per Bulan";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/md_m_spg_prosesmgr/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    function ShowTombol() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/md_m_spg_prosesmgr/viewdata.php?module=gantitombol",
                            data:"utipe="+etipe,
                    ...
                    function KlikDataTabel(sts) {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/md_m_spg_prosesmgr/viewdatatabel.php?module="+ket,
                                ...
                                <div class="form-group">
                                    <select class='form-control input-sm' id='e_cabangid' name='e_cabangid' onchange="Kosongkan()">
                                        <?PHP
                                            ...
                                            $query = "select icabangid_o, nama from dbmaster.v_icabang_o WHERE aktif='Y' AND i_spg='Y' AND nama NOT IN ('OTHER1', 'OTHER2', 'AMBON', 'IRIAN JAYA') ORDER BY nama";
