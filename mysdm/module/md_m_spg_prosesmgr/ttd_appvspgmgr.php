...
function ReloadTandaTangan(){
        ...
        $('<input type="button" value="Reject" class="btn btn-danger">').bind('click', function(e){
                ProsesDataReject('Reject...?', 'reject')
        }).appendTo($tools)
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            $.ajax({
                type:"post",
                url:"module/md_m_spg_prosesmgr/aksi_spgprosesmgr.php?module="+module+"&idmenu="+idmenu+"&act=simpan_ttdallam",
                data:"ket=approve"+"&uttd="+uttd+"&unobr="+allnobr+"&uketapv="+eketapv,
