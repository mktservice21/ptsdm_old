...
if ($_GET['module']=="gantitombol") {
        ...
        <div id="c_tombol">
            <div class='col-sm-6'>
               ...
               <div class="form-group">
                   ...
                   if ($ptipe=="A") {
                       ?>
                       <input type='button' class='btn btn-success btn-xs' id="s-submit" value="Belum Approve" onclick="RefreshDataTabel('1')">&nbsp;
                       <input type='button' class='btn btn-info btn-xs' id="s-submit" value="Sudah Approve" onclick="RefreshDataTabel('2')">&nbsp;
                       <?PHP
                   }else{
    ...
    $query = "UPDATE dbmaster.t_spg_gaji_br0 set apv4=NULL, apvtgl4=NULL WHERE "
            . " idbrspg IN $pnoid";
    mysqli_query($cnmy, $query);
    $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo "ERROR...."; exit; }
    
    mysqli_query($cnmy, "UPDATE dbimages.img_spg_gaji_br0 SET apvgbr4=NULL, apvgbr4=NULL WHERE idbrspg IN $pnoid");
