...
function ShowCOA(udiv, ucoa) {
    ...
    $.ajax({
        type:"post",
        url:"module/md_m_tickets/viewdata.php?module=viewcoadivisi",
...
function disp_confirm(pText_,ket)  {
    ...
    if (ok_) {
        ...
        if (r==true) {
            ...
            document.getElementById("demo-form2").action = "module/md_m_tickets/aksi_tickets.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
