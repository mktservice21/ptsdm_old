<?PHP
    ...
    $aksi="module/mod_apv_biayarutinho/aksi_aprovepm.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['BRRTNAPVSTS'])) $apvpilih=$_SESSION['BRRTNAPVSTS'];
    if (!empty($_SESSION['BRRTNAPVBLN1'])) $tgl_pertama=$_SESSION['BRRTNAPVBLN1'];
    if (!empty($_SESSION['BRRTNAPVBLN2'])) $tgl_akhir=$_SESSION['BRRTNAPVBLN2'];
    //if (!empty($_SESSION['BRRTNAPVBY'])) $pkaryawanid=$_SESSION['BRRTNAPVBY'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_biayarutinho/viewdatatableapvbrho.php?module="+module+"&idmenu="+idmenu+"&act="+act,
