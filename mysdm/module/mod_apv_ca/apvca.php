<?PHP
    ...
    $aksi="module/mod_apv_ca/aksi_apvca.php";
    $hari_ini = date("Y-m-d");
    $tgl_pertama = date('01 F Y', strtotime('-3 month', strtotime($hari_ini)));
    ...
    if (!empty($_SESSION['APVCAISI_TGL1'])) $tgl_pertama = $_SESSION['APVCAISI_TGL1'];
    if (!empty($_SESSION['APVCAISI_TGL2'])) $tgl_akhir = $_SESSION['APVCAISI_TGL2'];
    if (!empty($_SESSION['APVCAISI_STSAPV'])) $stsapv = $_SESSION['APVCAISI_STSAPV'];
    if (!empty($_SESSION['APVCAISI_KET'])) $apvpilih = $_SESSION['APVCAISI_KET'];
    if (!empty($_SESSION['APVCAISI_DIV'])) $pildivisi = $_SESSION['APVCAISI_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_ca/viewdatatable.php?module="+ket,
