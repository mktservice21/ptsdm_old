<?PHP
    ...
    $aksi="module/mod_apv_cabiayaotc/aksi_apvca.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['APVCAISIOTC_TGL1'])) $tgl_pertama = $_SESSION['APVCAISIOTC_TGL1'];
    if (!empty($_SESSION['APVCAISIOTC_TGL2'])) $tgl_akhir = $_SESSION['APVCAISIOTC_TGL2'];
    if (!empty($_SESSION['APVCAISIOTC_STSAPV'])) $stsapv = $_SESSION['APVCAISIOTC_STSAPV'];
    if (!empty($_SESSION['APVCAISIOTC_KET'])) $apvpilih = $_SESSION['APVCAISIOTC_KET'];
    if (!empty($_SESSION['APVCAISIOTC_DIV'])) $pildivisi = $_SESSION['APVCAISIOTC_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_cabiayaotc/viewdatatable.php?module="+ket,
...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="title_left">
            <h3>
                Approve Cash Advance, Biaya Rutin & Luar Kota OTC
            </h3>
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <div class="well" style="overflow: auto; margin-top: -5px; margin-bottom: 5px; padding-top: 10px; padding-bottom: 6px;">
                        ...
                        <input onclick="pilihData('sudahfin')" class='btn btn-default btn-sm' type='button' name='buttonview4' value='Sudah Proses Finance'>
                    </div>
