<?PHP
    ...
    $aksi="module/mod_apv_service/aksi_apvservice.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['APVCASERVICE_TGL1'])) $tgl_pertama = $_SESSION['APVCASERVICE_TGL1'];
    if (!empty($_SESSION['APVCASERVICE_TGL2'])) $tgl_akhir = $_SESSION['APVCASERVICE_TGL2'];
    if (!empty($_SESSION['APVCASERVICE_STSAPV'])) $stsapv = $_SESSION['APVCASERVICE_STSAPV'];
    if (!empty($_SESSION['APVCASERVICE_KET'])) $apvpilih = $_SESSION['APVCASERVICE_KET'];
    if (!empty($_SESSION['APVCASERVICE_DIV'])) $pildivisi = $_SESSION['APVCASERVICE_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_service/viewdatatable.php?module="+ket,
