...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_bg_budget/aksi_budgetteam.php";
        ...
        var dataTable = $('#datatabledg').DataTable( {
            ...
            "ajax":{
                url :"module/mod_bg_budget/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_bg_budget/aksi_budgetteam.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+"&ket="+ket+"&id="+noid;
