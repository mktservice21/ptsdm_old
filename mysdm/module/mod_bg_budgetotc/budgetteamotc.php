<?PHP
    ...
    if (!empty($_SESSION['DBPERENTY1'])) $tgl_pertama = $_SESSION['DBPERENTY1'];
    if (!empty($_SESSION['DBPERENTY2'])) $tgl_akhir = $_SESSION['DBPERENTY2'];
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_bg_budgetotc/viewdatatabel.php?module="+ket,
