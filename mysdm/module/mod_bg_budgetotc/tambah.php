...
if ($_GET['act']=="editdata"){
    ...
    $edit = mysqli_query($cnmy, "SELECT * FROM dbmaster.t_budget_otc WHERE idbudget='$_GET[id]'");
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                          <select class='form-control input-sm' id='cb_kodeid' name='cb_kodeid' data-live-search="true">
                                              ...
                                              <?PHP 
                                                    $query = "select kodeid, nama, urutan from dbmaster.t_budget_kode_otc order by urutan";
...
<script type="text/javascript">
    ...
    function ShowDataKode(){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_bg_budgetotc/viewdata.php?module=viewdatakode",
    ...
    function disp_confirm(pText_,ket)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_bg_budgetotc/aksi_budgetteamotc.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
