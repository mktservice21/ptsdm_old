<?php
    ...
    if ($pgroupid=="1" OR $pgroupid=="24" or $pgroupid=="25") {
        ...
        if ($puserid=="144") {
            $sql.=" AND (user1='$puserid' OR user1='$pcardid' OR ( (user1='0000001043' OR user1='1043') AND ( karyawanid='$pcardid' OR karyawanid='0000002073' ) ) ) ";//MULYA RAYA PETRA SEJAHTERA
        }else{
            $sql.=" AND (user1='$puserid' OR user1='$pcardid' OR ( (user1='0000001043' OR user1='1043') AND karyawanid='$pcardid' ) ) ";
        }
    }
    ...
    if ($tgltipe=="4") $filtipe="Date_format(IFNULL(bulan,''), '%Y-%m-%d')";
	...
	k.jumlah AS jumlah,
	k.jmlkuranglebih AS jmlkuranglebih,
	k.bulan,
	k.periode1,
	k.periode2,
	k.tgl AS tgl,
        ...
        <table id='datatableklaim' class='table table-striped table-bordered' width='100%'>
            ...
            <tbody>
                ...
                while ($row= mysqli_fetch_array($tampil)) {
                    ...
                    $pjumlah = $row["jumlah"];
                    $pjmkuranglebihrp = $row["jmlkuranglebih"];
                    ...
                    if (empty($pjmkuranglebihrp)) $pjmkuranglebihrp=0;
                    ...
                    if ($puserid1=="0000001043") {
                        $pedit="<a class='btn btn-success btn-xs' href='?module=$pmodule&act=editdataperiode&idmenu=$pidmenu&nmun=$pidmenu&id=$pklaimid'>Edit Periode</a>";
                        $phapus="";
                        $pprint="";
                    }
