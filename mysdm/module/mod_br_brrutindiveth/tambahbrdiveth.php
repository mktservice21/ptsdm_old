                        ...
                        <div class='x_content'>
                            ...
                            <?PHP if ($pstsmobile=="Y") { ?>
                                <br/>&nbsp;<div style="overflow-x:auto;">
                                    <?PHP
                                        include "module/mod_br_brrutindiveth/inputdetailmobilediveth.php";
                                    ?>
                                </div>
                            <?PHP }else{
                                include "module/mod_br_brrutindiveth/inputdetailbrdiveth.php";
                            }
                            ?>
                    ...
                    <div class='col-md-12 col-sm-12 col-xs-12'>
                        <h2>
                            ...
                            if (empty($sudahapv)) {
                                ...
                                include "module/mod_br_brrutindiveth/ttd_brrutindiveth.php";
                                echo "</div>";
                                }
                            ?>
...
<script>
    ...
    function showKodePeriode() {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_brrutindiveth/viewdatabrdiveth.php?module=getkodeperiode",
            data:"ubulan="+ibulan,
    ...
    function showPeriode() {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_brrutindiveth/viewdatabrdiveth.php?module=getperiode",
    ...
    function disp_confirm(pText_, ket)  {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_brrutindiveth/viewdatabrdiveth.php?module=cekdatasudahada",
                ...
                if (data=="boleh") {
                    ...
                    if (ok_) {
                        ...
                        if (r==true) {
                            ...
                            document.getElementById("demo-form2").action = "module/mod_br_brrutindiveth/aksi_brrutindiveth.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
