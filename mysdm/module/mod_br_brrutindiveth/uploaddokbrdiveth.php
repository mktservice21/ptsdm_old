        ...
        <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=$act&idmenu=$_GET[idmenu]"; ?>' id='demo-form2' name='form1' data-parsley-validate class='form-horizontal form-label-left'  enctype='multipart/form-data'>
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <?PHP
                    $query = "select * from dbimages.img_brrutin1 where idrutin='$_GET[id]' AND idrutin IN (select distinct IFNULL(idrutin,'') from dbmaster.t_brrutin0 where(userid='$_SESSION[IDCARD]' OR karyawanid='$_SESSION[IDCARD]') and kode=1)";
