<?php
    ...
    $query .=" AND karyawanid='$pidcard' AND kode=1 ";
    ...
    function ProsesDataHapusCa(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_br_brrutindiveth/aksi_brrutindiveth.php?module="+module+"&act=hapus&idmenu="+idmenu+"&kethapus="+txt+"&ket="+ket+"&id="+noid;
