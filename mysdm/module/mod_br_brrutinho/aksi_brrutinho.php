...
// Hapus 
if ($module=='entrybrrutinho' AND $act=='hapus')
{
    $puserid="";
    $pnamalengkap="";
...
elseif ($module=='entrybrrutinho' AND $act=='ttdupdate')
{
...
elseif ($module=='entrybrrutinho' AND $act=='uploaddok')
{
    $kodenya=$_POST['e_id'];
    if (!empty($kodenya)) {
...
elseif ($module=='entrybrrutinho' AND $act=='hapusgambar')
{
    $kodenya=$_GET['id'];
    $idgam="";
...
elseif ($module=='entrybrrutinho' AND ($act=='input' OR $act=='update'))
{
    ...
    if (empty($pdivisiid)) $pdivisiid="HO";
