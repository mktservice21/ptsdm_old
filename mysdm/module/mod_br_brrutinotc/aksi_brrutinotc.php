...
//HAPUS DATA
if ($module=='entrybrrutinotc' AND $act=='hapus')
{
...
elseif ($module=='entrybrrutinotc' AND $act=='hapusgambar')
{
...
elseif ($module=='entrybrrutinotc' AND $act=='uploaddok')
{
    ...
    if ($num_records) {
        for ($i=1; $i < $num_records; $i++) {
            ...
            if (!empty($bltotal)) {
                ...
                $query = "insert into $dbname.t_brrutin1 (idrutin,nobrid,qty,rp,rptotal,notes,coa,tgl1,obat_untuk,km) "
                        . " values ('$kodenya','$blid','$blqty','$blnilai','$bltotal','$blnote', '$coadet','$tglkuitansi','$cbisikesehatan','$isikmdetail')";
                mysqli_query($cnmy, $query);
