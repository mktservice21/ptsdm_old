<?PHP
    ...
    if (!empty($_SESSION['FINRUTPERENTYOTC1'])) $tgl_pertama = $_SESSION['FINRUTPERENTYOTC1'];
    if (!empty($_SESSION['FINRUTPERENTYOTC2'])) $tgl_akhir = $_SESSION['FINRUTPERENTYOTC2'];
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_brrutinotc/viewdatatabel.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                    ...
                    function ProsesData(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("demo-form2").action = "module/mod_br_brrutinotc/aksi_brrutinotc.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+txt+"&ket="+ket+"&id="+noid;
