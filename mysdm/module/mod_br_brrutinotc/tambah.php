...
if ($_GET['act']=="editdata"){
    ...
    $edit = mysqli_query($cnmy, "SELECT * FROM dbmaster.v_brrutin0 WHERE kode=1 AND idrutin='$_GET[id]'");
                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <?PHP if ($_SESSION['MOBILE']=="Y") { ?>
                                    ...
                                    <div style="overflow-x:auto;">
                                        <?PHP include "module/mod_br_brrutin/inputdetailmobile.php"; ?>
                                    </div>
                                <?PHP }else{
                    ...
                    <div class='col-md-12 col-sm-12 col-xs-12'>
                        <h2>
                            ...
                            if (empty($sudahapv)) {
                                ...
                                include "module/mod_br_brrutinotc/ttd_biayarutinotc.php";
                                echo "</div>";
                                }
                            ?>
                            <?PHP
    ...
    function disp_confirm(pText_, ket)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_br_brrutinotc/aksi_brrutinotc.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
