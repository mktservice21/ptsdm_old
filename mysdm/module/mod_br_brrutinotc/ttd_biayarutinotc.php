...
$(document).ready(function() {
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            document.getElementById("demo-form2").action = "module/mod_br_brrutinotc/aksi_brrutinotc.php?module="+module+"&act="+tact+"&idmenu="+idmenu;
        ...
        function cekStatusInput() {
            ...
            $.ajax({
                type:"post",
                url:"module/mod_br_brrutinotc/cekdoubleotc.php?module=cekdouble",
