<?PHP
    ...
    $edit = mysqli_query($cnmy, "SELECT a.idrutin, a.karyawanid, b.nama FROM dbmaster.t_brrutin0 a JOIN "
            . " hrd.karyawan b on a.karyawanid=b.karyawanId WHERE a.idrutin='$_GET[id]'");
