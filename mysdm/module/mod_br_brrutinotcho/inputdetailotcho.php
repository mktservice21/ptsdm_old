        ...
        while ($uc=mysqli_fetch_array($tampil)){
            ...
            if ($ada>0) {
                ...
                while ($c=mysqli_fetch_array($cari)){
                    ...
                    if ((int)$tgpid==19) {
                        ...
                        $pisidetail="Tgl. :<input type='date' class='input-xs' name='$nmisitgl1' id='$nmisitgl1' value='$uptglkuitansi'><br/>s/d."
                                . "<input type='date' class='input-xs' name='$nmisitgl2' id='$nmisitgl2' value='$uptglkuitansi2'>";
                        $cmbisi="<select class='input-sm' id='$nmisicmb' name='$nmisicmb'><option value='' $seltkes0>Karyawan</option><option value=1 $seltkes1>Istri</option><option value=2 $seltkes2>Anak</option></select>";
                    }
            ...
            for ($i=1; $i <=$tjml; $i++) {
                ...
                if ((int)$tgpid==19) {
                    ...
                    $pisidetail="Tgl. :<input type='date' class='input-xs' name='$nmisitgl1' id='$nmisitgl1' value=''><br/>s/d."
                            . "<input type='date' class='input-xs' name='$nmisitgl2' id='$nmisitgl2' value=''>";
                    $cmbisi="<select class='input-sm' id='$nmisicmb' name='$nmisicmb'><option value='' selected>Karyawan</option><option value=1>Istri</option><option value=2>Anak</option></select>";
                }
