<?PHP
    ...
    $edit = mysqli_query($cnmy, "SELECT a.idrutin, a.karyawanid, a.nama_karyawan, b.nama FROM dbmaster.t_brrutin0 a "
            . " JOIN hrd.karyawan b on a.karyawanid=b.karyawanid WHERE a.idrutin='$_GET[id]'");
    $r    = mysqli_fetch_array($edit);
    $idajukan=$r['karyawanid'];
    $idnomor=$r['idrutin'];
    $nmajukan=$r['nama'];
    if ($idajukan=="0000002200" || $idajukan=="0000002083" || (DOUBLE)$idajukan==2200 || (DOUBLE)$idajukan==2083) {
        $nmajukan=$r['nama_karyawan'];
    }
?>
<script>
