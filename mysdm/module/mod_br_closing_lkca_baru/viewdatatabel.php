...
<?PHP
    ...
    $pidinputpd=""; $pidinputbank=""; $psudahapvspd=false;
    ...
    $ptutup_bank="hidden";
                ...
                if ($pjenispilih=="2" AND $stsreport=="C") {
                    ...
                    if (!empty($pidinputpd)) {
                        $query = "select nodivisi, apv1, tgl_apv1 from dbmaster.t_suratdana_br WHERE idinput='$pidinputpd'";
                        $tampil= mysqli_query($cnit, $query);
                        $ketemu= mysqli_num_rows($tampil);
                        if ($ketemu>0){
                            $sc= mysqli_fetch_array($tampil);
                            $pdivnomor=$sc['nodivisi'];
                            if (!empty($sc['tgl_apv1']) AND $sc['tgl_apv1']<>"0000-00-00") $psudahapvspd=true;
                        }
                ...
                <div class='col-md-6 col-xs-12'>
                    <div class='x_panel'>
                        <div class='x_content form-horizontal form-label-left'>
                            ...
                            <div class='form-group'>
                                <label class='control-label col-md-5 col-sm-5 col-xs-12' for=''>CA <?PHP echo $perBlnThn2; ?><span class='required'></span></label>
                                <div class='col-xs-5'>
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-xs-5'>
                                    <input type='text' id='e_jmltrsf' name='e_jmltrsf' class='form-control col-md-7 col-xs-12 inputmaskrp2' value='<?PHP echo $gtottrans; ?>'>
                                </div>
                            </div>
            ...
            <tbody>
                <?PHP
                    ...
                    while ($row= mysqli_fetch_array($tampil)) {
                        ...
                        $ptxt_saldoreal="<input type='text' value='$prprutin' id='txtsaldo[$pkaryawanid]' name='txtsaldo[$pkaryawanid]' class='inputmaskrp2 inputbaya' autocomplete='off' size='8px' Readonly $nstyle_text>";
                        ...
                        $ptxt_jmladj="<input type='text' value='$pjumlahadj' id='txtjmladj[$pkaryawanid]' name='txtjmladj[$pkaryawanid]' class='inputmaskrp2 inputbaya' autocomplete='off' size='8px' Readonly $nstyle_text>";
...
<script>
    ...
    function disp_confirm_simpanclose(pText_,ket)  {
        ...
        var ijmltrf =document.getElementById('e_jmltrsf').value;
        if(ijmltrf==""){
            ijmltrf="0";
        }
        if (ijml=="0" && ijmltrf=="0") {
