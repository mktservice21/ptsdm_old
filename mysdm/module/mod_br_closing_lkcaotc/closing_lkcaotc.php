...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left">
            <h2>
                <?PHP
                $judul="Closing Biaya Luar Kota dan CA OTC Per Bulan";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_closing_lkcaotc/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_closing_lkcaotc/viewdatatabel.php?module="+ket,
