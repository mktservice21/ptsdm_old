            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function BuatLapTransferUlang(ntxt_ket){
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_danabank/transferulang.php?module="+ntxt_ket,
                        ...
                        <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=input&idmenu=$_GET[idmenu]"; ?>' 
                            ...
                            <div class='col-sm-6'>
                               ...
                               <div class="form-group">
                                   ...
                                   <?PHP if ($pses_grpuser=="1" OR $pses_grpuser=="24" OR $pses_grpuser=="25" OR $pses_grpuser=="28" OR $pses_grpuser=="26") { ?>
