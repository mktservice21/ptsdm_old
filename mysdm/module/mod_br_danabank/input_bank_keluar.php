    ...
    <div class='modal-content'>
        ...
        <div class="">
            ...
            <div class="row">
                ...
                <form method='POST' action='<?PHP echo "?module=brdanabank&act=inputbankkeluar&idmenu=258"; ?>' 
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                if (epilchk==true){//JIKA Dari No BR/Divisi
                    ...
                    $.ajax({
                        type:"post",
                        url:"module/mod_br_danabank/simpan_bank_spd_keluar_new.php?module="+module+"&act="+ists+"&idmenu="+idmenu,
