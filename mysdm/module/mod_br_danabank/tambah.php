                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-xs-5'>
                                            ...
                                            <span class='input-group-btn'>
                                                <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal' onClick="getDataNoDivisi('cb_nodivisipil2', 'cb_nodivisipil', 'cb_nodivisipil3', '<?PHP echo "$pses_idcard"; ?>', '<?PHP echo "$pses_grpuser"; ?>')">Pilih</button>
                                            </span>
                                            <input type='text' class='form-control' id='cb_nodivisipil' name='cb_nodivisipil' value='<?PHP echo $pnodivisi; ?>' Readonly>
                                            <input type='hidden' class='form-control' id='cb_nodivisipil2' name='cb_nodivisipil2' value='<?PHP echo $pnodivisi; ?>' Readonly>
                                            <input type='hidden' class='form-control' id='cb_nodivisipil3' name='cb_nodivisipil3' value='<?PHP echo $pnodivisi; ?>' Readonly>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function getDataBRSlip(data1, data2){
        ...
        var inodivisi=document.getElementById('cb_nodivisipil').value;
        $.ajax({
            type:"post",
            url:"config/viewdata_ms.php?module=viewdatabrperdivisi&data1="+data1+"&data2="+data2,
    ...
    function disp_confirm(pText_,ket)  {
        ...
        var edarispd = document.getElementById('cb_darispd').value;
        ...
        if (edarispd=="T") {
            if (ekodesub=="") {
                var eket = document.getElementById('e_ket').value;
                if (eket=="") {
...
<script>
    function getDataNoDivisi(data1, data2, data3, idkry, ibuka){
        var etgl=document.getElementById('e_tglmasuk').value;
        var epnospd=document.getElementById('cb_nospd').value;
        $.ajax({
            type:"post",
            url:"config/viewdata_ms.php?module=viewdataspddivisiperuserid2",
            data:"udata1="+data1+"&udata2="+data2+"&udata3="+data3+"&uidkry="+idkry+"&ubuka="+ibuka+"&utgl="+etgl+"&upnospd="+epnospd,
            success:function(data){
                $("#myModal").html(data);
    ...
    function HapusPilihNoDivisi() {
        document.getElementById('cb_nodivisipil').value="";
        document.getElementById('cb_nodivisipil2').value="";
        document.getElementById('cb_nodivisipil3').value="";
