...
elseif ($module=='entrybr')
{
    ...
    if ($act=='input') {
    $sql="insert into dbbudget.t_br (NOID, TGL, TGL_PERLU, divprodid, KARYAWANID, ICABANGID, AKTIVITAS1, MODIFUN)VALUES"
            . "('$kodenya', '$ptglinput', '$ptglperlu', '$pdivprodid', '$pkaryawan', '$pidcabang', '$paktivitas1', '$_SESSION[IDCARD]')";
    }else{
        $sql="update dbbudget.t_br set TGL='$ptglinput', TGL_PERLU='$ptglperlu', divprodid='$pdivprodid', AKTIVITAS1='$paktivitas1', ICABANGID='$pidcabang', MODIFUN='$_SESSION[IDCARD]' where"
                . " NOID='$kodenya'";
    }
    ...
    $sql="insert into dbbudget.t_br_d (NOID, kode, RP, AKTIVITAS2)VALUES"
            . "('$kodenya','$_POST[e_akun]', '$rpnya', '$paktivitas1')";
    mysqli_query($cnmy, $sql);
