...
if ($_GET['act']=="editdata"){
    ...
    $edit = mysqli_query($cnmy, "SELECT * FROM dbmaster.v_t_br_bulan WHERE idbr='$_GET[id]'");
                    ...
                    <div class='x_panel'>
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for='cb_divisi'>Pengajuan Untuk <span class='required'></span></label>
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='cb_jenispeng' name='cb_jenispeng' onchange="">
                                            <option value='' selected>-- Pilihan --</option>
                                            <?PHP
                                            if (!empty($pjenispengajuan)) {
                                                if ($pjenispengajuan=="LK") {
                                                    echo "<option value='RT'>Biaya Rutin</option>";
                                                    echo "<option value='LK' selected>Biaya Luar Kota</option>";
                                                }elseif ($pjenispengajuan=="RT") {
                                                    echo "<option value='RT' selected>Biaya Rutin</option>";
