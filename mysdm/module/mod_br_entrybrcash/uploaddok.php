        ...
        <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=$act&idmenu=$_GET[idmenu]"; ?>' id='demo-form2' name='form1' data-parsley-validate class='form-horizontal form-label-left'  enctype='multipart/form-data'>
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <?PHP
                    $query = "select * from dbimages.img_ca0 where idca='$_GET[id]' AND idca IN (select distinct IFNULL(idca,'') from dbmaster.t_ca0 where userid='$_SESSION[IDCARD]')";
                    ...
                    if ($ketemu>0) {
                        ...
                        while ($i= mysqli_fetch_array($tampil)) {
                            ...
                            if (!empty($gambar2)) {
								...
								$namapengaju="img_".$no."IDRUTCA_".$pnidrtn."_.png";
