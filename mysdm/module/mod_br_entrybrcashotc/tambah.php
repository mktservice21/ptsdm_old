                    ...
                    <div class='x_panel'>
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for='thnbln01x'>Periode </label>
                                    <div class='col-md-3'>
                                ...
                                <?PHP if ($_SESSION['MOBILE']=="Y") { ?>
                                    ...
                                    <div style="overflow-x:auto;">
                                        <?PHP include "module/mod_br_entrybrcash/inputdetailmobile.php"; ?>
                                    </div>
                                <?PHP }else{
                    ...
                    <div class='col-md-12 col-sm-12 col-xs-12'>
                        <h2>
                            ...
                            if (empty($sudahapv)) {
                                ...
                                include "module/mod_br_entrybrcashotc/ttd_ca.php";
                                echo "</div>";
                                }
                            ?>
                            <?PHP
