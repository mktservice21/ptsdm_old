...
if ($pmodule=="getkunjungan"){
    ...
    $pnkryid=$_POST['e_idkaryawan'];
    $pntgl01=$_POST['e_periode01'];
    $pntgl02=$_POST['e_periode02'];
    ...
    echo "<input type='hidden' id='txt_kryid' name='txt_kryid' value='$pnkryid' Readonly>";
    echo "<input type='hidden' id='txt_etgl01' name='txt_etgl01' value='$ntgl01' Readonly>";
    echo "<input type='hidden' id='txt_etgl02' name='txt_etgl02' value='$ntgl02' Readonly>";
    
    //echo "$ntgl01 s/d. $ntgl02"; exit;
}
?>
...
<script>
    $(document).ready(function() {
        ...
        var eperi01 =document.getElementById('txt_etgl01').value;
        var eperi02 =document.getElementById('txt_etgl02').value;
        var icar =document.getElementById('txt_kryid').value;
        ...
        $.ajax({
            ...
            data:"ubulan="+eperi01+"&ubulan2="+eperi02+"&umr="+icar,
