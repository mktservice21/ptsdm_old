<?PHP
    ...
    if (!empty($_SESSION['FINLURPERENTYOTC1'])) $tgl_pertama = $_SESSION['FINLURPERENTYOTC1'];
    if (!empty($_SESSION['FINLURPERENTYOTC2'])) $tgl_akhir = $_SESSION['FINLURPERENTYOTC2'];
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrybrluarkotaotc/viewdatatabel.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                    ...
                    function ProsesData(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("demo-form2").action = "module/mod_br_entrybrluarkotaotc/aksi_entrybrluarkotaotc.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+txt+"&ket="+ket+"&id="+noid;
