<?PHP
    ...
    //$_SESSION['FINLURTGLTIPEOTC']=$_POST['utgltipe'];
    $_SESSION['FINLURPERENTYOTC1']=$_POST['uperiode1'];
    $_SESSION['FINLURPERENTYOTC2']=$_POST['uperiode2'];
    //$_SESSION['FINLURDIVOTC']=$_POST['udivisi'];
    //$_SESSION['FINLURCABOTC']=$_POST['uarea'];
...
<form method='POST' action='<?PHP echo "?module='$pmodule'&act=input&idmenu=$pidmenu"; ?>' id='d-form2' name='form2' data-parsley-validate class='form-horizontal form-label-left'>
    ...
    <div class='x_content'>
        <table id='datatableblkotc' class='table table-striped table-bordered' width='100%'>
            <thead>
                <tr>
                    <th width='7px'>No</th>
            ...
            <tbody>
                ...
                $sql.=" AND kode=2 AND IFNULL(stsnonaktif,'')<>'Y' AND divisi='OTC' ";
...
<script>
    $(document).ready(function() {
        var dataTable = $('#datatableblkotc').DataTable( {
            //"stateSave": true,
            //"order": [[ 2, "desc" ]],
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_br_entrybrluarkotaotc/aksi_entrybrluarkotaotc.php?module="+module+"&act=hapus&idmenu="+idmenu+"&kethapus="+txt+"&ket="+ket+"&id="+noid;
