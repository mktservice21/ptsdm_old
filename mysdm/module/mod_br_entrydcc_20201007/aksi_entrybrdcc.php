    ...
    if ($pact=="hapus") {
        ...
        if ($pact=="simpan") {
            ...
            $query = "insert into hrd.br0 (brid, tgl, divprodid, COA4, kode, user1, aktivitas1, aktivitas2, ccyid, "
                    ...
                    . " lampiran, ca, via, noslip, mrid, dokterId, realisasi2) VALUES"
                    ...
                    . " '$pinplampiran', '$pinpca', '$pinpsby', '$pnoslip', '$pmrid', '$pdoktermrid', '$pchkrealjenis')";
            mysqli_query($cnmy, $query);
            $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; exit; }
        ...
        $query = "UPDATE hrd.br0 SET tgltrans='$ptgltransf', tgl='$ptglinput', "
                ...
                . " jumlah='$prpnya', cn='$prpcn', realisasi1='$pnmrealisasi', realisasi2='$pchkrealjenis', "
