...
if ($pact=="editdata") {
    ...
    if (!empty($pdokteridmr)) {
        $prel2_tojenis=TRIM($r['realisasi2']);
                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <div style="margin-bottom:2px;">
                                            <input type="radio" id="chksesuai" name="rb_jenisreal" value="S" <?PHP echo $pchkjenisreal1; ?> onclick="CekDataRealisasi()"> Sesuai Nama Dokter &nbsp;
                                            <input type="radio" id="chkrelasi" name="rb_jenisreal" value="R" <?PHP echo $pchkjenisreal2; ?> onclick="CekDataRealisasi()"> Relasi Dokter &nbsp;
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>
                                        <button type='button' class='btn btn-warning btn-xs' onclick='CariNamaDokter()'>Realisasi</button> 
                                        <span class='required'></span></label>
                                    <div class='col-xs-9'>
                                        <input type='text' id='e_realisasi' name='e_realisasi' class='form-control col-md-7 col-xs-12' value="<?PHP echo $rprelalisasi; ?>" <?PHP echo $pnmreal_readonly; ?> >
                                    </div>
                                </div>
