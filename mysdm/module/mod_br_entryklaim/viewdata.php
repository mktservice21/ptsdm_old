...
if ($_GET['module']=="viewdatacombocoa"){
    ...
    $pcoapilih="755-31";
    if ($divprodid=="EAGLE") $pcoapilih="751-31";
    elseif ($divprodid=="PIGEO") $pcoapilih="752-31";
    elseif ($divprodid=="PEACO") $pcoapilih="753-31";
    elseif ($divprodid=="OTC") $pcoapilih="754-31";
    
    $query = "SELECT COA4, NAMA4 FROM dbmaster.coa_level4 where COA4='$pcoapilih' ";
    $query .= " order by COA4";
