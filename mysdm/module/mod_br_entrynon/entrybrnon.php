<?PHP
    ...
    if ($fidgrouppil=="25") $ppilihdiv="HO";
    else $ppilihdiv=$_SESSION['FINNONDIV'];
    
    $ppilkryuser=$fkaryawan;
    if (!empty($_SESSION['FINNONUSPL'])) $ppilkryuser = $_SESSION['FINNONUSPL'];
    ...
    $query ="select krycab.karyawanId, b.nama, b.jabatanId, krycab.iCabangId, b.aktif, b.tglmasuk, b.tglkeluar, krycab.iCabangId icabangkaryawan from (
    ...
    $query = "INSERT INTO hrd.tempkaryawandccdss_inp "
            . " select karyawanId, nama, jabatanId, iCabangId, aktif, tglmasuk, tglkeluar, iCabangId icabangkaryawan from hrd.karyawan "
    ...
    $query = "UPDATE hrd.tempkaryawandccdss_inp a JOIN hrd.karyawan b on a.karyawanid=b.karyawanid SET "
            . " a.icabangkaryawan=b.icabangid WHERE IFNULL(b.icabangid,'')<>'' AND a.jabatanId IN ('08', '20')";
    mysqli_query($cnmy, $query);
    $erropesan = mysqli_error($cnmy);
    if (!empty($erropesan)) { 
        exit;
...
<div class="">
    ...
    <div class="page-title"><div class="title_left">
            <h3>
                <?PHP
                if ($pnmactid=="tambahbaru") {
                    echo "Tambah Budget  Request NON DCC/DSS";
                }elseif ($pnmactid=="editdata") {
                    echo "Edit Budget  Request NON DCC/DSS";
                }else{
                    echo "Entry Budget  Request NON DCC/DSS";
                }
                ?>
            </h3>
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function PilihData1() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrynon/viewdatatabel.php?module="+module+"&act="+act+"&idmenu="+idmenu+"&nmun="+idmenu,
                    ...
                    function PilihData2() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrynon/viewdatatabelreal.php?module="+module+"&act="+act+"&idmenu="+idmenu+"&nmun="+idmenu,
                    ...
                    function PilihData3() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrynon/viewdatatabelsby.php?module="+module+"&act="+act+"&idmenu="+idmenu+"&nmun="+idmenu,
                            data:"utgltipe="+etgltipe+"&uperiode1="+etgl1+"&uperiode2="+etgl2+"&udivisi="+edivisi+"&uidc="+eidc+"&utipeproses="+etipeproses+"&uidkarpilih="+eidkarpilih,
                            success:function(data){
                                $("#c-data").html(data);
                                $("#loading").html("");
                    ...
                    function PilihData4() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrynon/viewdatatabeleditkaryawan.php?module="+module+"&act="+act+"&idmenu="+idmenu+"&nmun="+idmenu,
                            data:"utgltipe="+etgltipe+"&uperiode1="+etgl1+"&uperiode2="+etgl2+"&udivisi="+edivisi+"&uidc="+eidc+"&utipeproses="+etipeproses+"&uidkarpilih="+eidkarpilih,
                            success:function(data){
                                $("#c-data").html(data);
                                $("#loading").html("");
                    ...
                    function TambahDataInputPajak(eidbr){
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrynon/tambah_pajak.php?module=viewisipajak",
                            data:"uidbr="+eidbr,
                            success:function(data){
                                $("#myModal").html(data);
                            }
...
Status pada SPD akan berubah menjadi BATAL (merah)...');
                            ...
                            if (r==true) {
                                ...
                                var txt;
                                if (ket=="reject" || ket=="hapus" || ket=="pending" || ket=="batal") {
                                ...
                                document.getElementById("demo-form2").action = "module/mod_br_entrynon/aksi_entrybrnon.php?module="+module+"&act="+ket+"&idmenu="+idmenu+"&kethapus="+txt+"&ket="+ket+"&id="+noid;
                        ...
                        <div class='col-sm-2'>
                            ...
                            <div class="form-group">
                                <select class='form-control input-sm' id="cb_tipeisi" name="cb_tipeisi">
                                    ...
                                    <?PHP
                                    $sa=""; $sb=""; $sc="";
                                    if ($_SESSION['FINNONTIPE']=="A") $sa=" selected";
                                    if ($_SESSION['FINNONTIPE']=="B") $sb=" selected";
                                    if ($_SESSION['FINNONTIPE']=="C") $sc=" selected";
                                    ?>
                                    <option value="A" <?PHP echo $sa; ?>>Realisasi</option>
                                    <option value="B" <?PHP echo $sb; ?>>Input Tgl Rpt. SBY</option>
                                    <option value="C" <?PHP echo $sc; ?>>Edit Data Karyawan</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class='col-sm-2'>
                            ...
                            <div class="form-group">
                                <select class='form-control input-sm' id="cb_tgltipe" name="cb_tgltipe">
                                    ...
                                    if ($_SESSION['FINNONTGLTIPE']=="5") $se=" selected";
                                    if (empty($_SESSION['FINNONTGLTIPE'])) $sd="selected"
                                    ?>
