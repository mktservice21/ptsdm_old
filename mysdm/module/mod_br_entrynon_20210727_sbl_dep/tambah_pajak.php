...
<script>
    ...
    function disp_confirm_pajak(pText_,nid)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                $.ajax({
                    type:"post",
                    url:"module/mod_br_entrynon/simpan_pajakethnon.php?module="+module+"&act="+eact+"&idmenu="+idmenu,
    ...
    function disp_edit_data(pText_,nid)  {
        $.ajax({
            type:"post",
            url:"module/mod_br_entrynon/viewpajakedit.php?module=caridatapajak",
            data:"uid="+nid,
            success:function(data){
    ...
    function disp_hapusdata_pajak(pText_,nid)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                $.ajax({
                    type:"post",
                    url:"module/mod_br_entrynon/simpan_pajakethnon.php?module="+module+"&act=hapus&idmenu="+idmenu,
                    data:"uid="+nid,
                    success:function(data){
                        if (data.length > 2) {
                            alert(data);
