...
<script>
    ...
    function showPosting(subpost, epost){
        ...
        var egrpid = document.getElementById('cb_grpbiaya').value;
        
        $.ajax({
            type:"post",
            url:"module/mod_br_entryotc/viewdata.php?module=viewdataposting&data1="+esubpost+"&data2="+epost,
            data:"usubpost="+esubpost+"&upost="+epost+"&ugrpid="+egrpid,
            success:function(data){
                $("#"+epost).html(data);
    ...
    function ShowDataPostingBR() {
        var egrpid = document.getElementById('cb_grpbiaya').value;
        
        $.ajax({
            type:"post",
            url:"module/mod_br_entryotc/viewdata.php?module=viewdatapostingsubgrp",
            data:"ugrpid="+egrpid,
            success:function(data){
                $("#cb_subpost").html(data);
            }
        });
...
if ($_GET['act']=="editdata"){
	...
	$ncarisudahclosebrid=CariSudahClosingBRID1($_GET['id'], "D");
    
    //$edit = mysqli_query($cnmy, "SELECT * FROM dbmaster.v_br_otc WHERE brOtcId='$_GET[id]'");
    $edit = mysqli_query($cnmy, "SELECT * FROM hrd.br_otc WHERE brOtcId='$_GET[id]'");
    ...
    $edit2 = mysqli_query($cnmy, "SELECT * FROM hrd.br_otc_ext WHERE brotcid='$_GET[id]'");
    $r2    = mysqli_fetch_array($edit2);
    
    $tokoo=$r2['icustid_o'];
    if (!empty($tokoo))
        $tokoonm = getfield ("select nama as lcfields from MKT.icust_o where icustid_o='$tokoo'");
    ...
    $idbankreal=getfield ("select id as lcfields from hrd.br_otc_bank where brOtcId='$_GET[id]'");
                    ...
                    <div class='col-md-6 col-xs-12'>
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'>
                                ...
                                <div class='form-group'>
                                      ...
                                      <div class='col-xs-9'>
                                          <select class='soflow' id='e_idcabang' name='e_idcabang' onchange="showArea('e_idcabang', 'cb_areasdm')">
                                              ...
                                              <?PHP
                                                $tampil=mysqli_query($cnmy, "SELECT distinct icabangid_o, nama from dbmaster.v_icabang_o "
                                                        . " where aktif='Y' AND icabangid_o NOT IN ('JKT_MT', 'JKT_RETAIL') ORDER BY 2,1");
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for='cb_alokasi'>Biaya Untuk <span class='required'></span></label>
                                    <div class='col-xs-9'>
                                        <select class='soflow' name='cb_grpbiaya' id='cb_grpbiaya' onchange="ShowDataPostingBR()">
                                            <?PHP
                                            $tampil=mysqli_query($cnmy, "SELECT gkode as gkode, nama_group as nama_group FROM hrd.brkd_otc_group order by 1");
                                            echo "<option value='' selected>-- Pilihan --</option>";
                                            while($a=mysqli_fetch_array($tampil)){ 
                                                $pgbiayakd=$a['gkode'];
                                                $pgbiayanm=$a['nama_group'];
                                                
                                                if ($pgbiayakd==$pgrpbiaya)
                                                    echo "<option value='$pgbiayakd' selected>$pgbiayanm</option>";
                                                else
                                                    echo "<option value='$pgbiayakd'>$pgbiayanm</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='soflow' id='cb_coa' name='cb_coa'>
                                            <?PHP
                                            if ($_GET['act']=="editdata"){
                                                $tampil=mysqli_query($cnmy, "select distinct COA4, NAMA4 from dbmaster.coa_level4 where kodeid='$kodeid' OR subpost = '$subposting' order by NAMA4");
                                                //echo "<option value='' selected>-- Pilihan --</option>";
                                                while($a=mysqli_fetch_array($tampil)){ 
                                                    if ($a['COA4']==$coa)
                                            ...
                                            <select class='soflow' name='cb_custsdm' id='cb_custsdm' onchange="showAreaByToko('e_idcabang', 'cb_areasdm', 'cb_custsdm')">
                                                ...
                                                while($a=mysqli_fetch_array($tampil)){
                                                    if ($a['icustid_o']==$tokoo)
                                                        echo "<option value='$a[icustid_o]' selected>$a[nama] ($a[icustid_o])</option>";
                                                    else
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <textarea class='form-control' id='e_aktivitas2' name='e_aktivitas2' rows='2' placeholder='Keterangan Detail'><?PHP echo $aktivitas2; ?></textarea>
                                    </div>
                                </div>
                                            ...
                                            <div style="margin-bottom:2px;">
                                                <select class='soflow' name='cb_pph' id='cb_pph' onchange="ShowPPH()">
                                                    ...
                                                    if ($pjnspph=="pph21") {
                                                        ...
                                                        echo "<option value='pph11'>PPH21 Non NPWP (3%)</option>";
                                                        ...
                                                        echo "<option value='pph11'>PPH21 Non NPWP (3%)</option>";
                                                    }elseif ($pjnspph=="pph11") {// PPH 21 non npwp
                                                        echo "<option value=''></option>";
                                                        echo "<option value='pph21'>PPH21</option>";
                                                        echo "<option value='pph23'>PPH23</option>";
                                                        echo "<option value='pph10'>PPH Pasal 4 ayat 2 (10%)</option>";
                                                        echo "<option value='pph15'>PPH Hadiah (15%)</option>";
                                                        echo "<option value='pph11' selected>PPH21 Non NPWP (3%)</option>";
                                                    }else{
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <div class="checkbox">
                                            ...
                                            <label><input type="checkbox" value="ca" id="cx_ca" name="cx_ca" <?PHP echo $chkca; ?> onClick="CheckBoxLCV('cx_ca')"> PC-M </label> &nbsp;&nbsp;&nbsp;
...
<script>
    ...
    function ShowPPH(){
        ...
        if (epph=="pph21") {
            ...
            document.getElementById("e_jmlpph").value = "3";
            HitungPPH();
        }else{
            document.getElementById("e_jmlpph").value = "0";
            document.getElementById("e_jmlrppph").value = "0";
    ...
    function HitungJumlahUsulan(){
        ...
        if ( (epph=="pph21" || epph=="pph23" || epph=="pph10" || epph=="pph15" || epph=="pph11") && echkpilihsby==false ) {
