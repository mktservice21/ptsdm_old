            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-6 col-sm-6 col-xs-12'>
                              <select class='soflow' id='e_idjns' name='e_idjns' onchange="">
                                  <?PHP
                                    if ($ppilidjenis=="K") {
                                        echo "<option value='A'>Advance</option><option value='K' selected>Klaim</option><option value='S'>Sudah Minta Uang</option>";
                                    }elseif ($ppilidjenis=="S") {
                                        echo "<option value='A'>Advance</option><option value='K'>Klaim</option><option value='S' selected>Sudah Minta Uang</option>";
                                    }else{
                                        echo "<option value='A' selected>Advance</option><option value='K'>Klaim</option><option value='S'>Sudah Minta Uang</option>";
                                    }
                                    ?>
                              </select>
                        </div>
