...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_br_kaskecilcab/aksi_kaskecilcab.php";
        ...
        var dataTable = $('#datatablekasbon').DataTable( {
            ...
            "ajax":{
                url :"module/mod_br_kaskecilcab/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&utgltipe="+etgltipe+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_br_kaskecilcab/aksi_kaskecilcab.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+"&ket="+ket+"&id="+noid;
