...
if (empty($puserid)) {
    ...
    $dbname = "dbmaster";
// Hapus 
if ($module=='bgtkaskecilcabangotc' AND $act=='hapus')
{
...
elseif ($module=='bgtkaskecilcabangotc')
{
    ...
    $putkpengajuan="OTC";//$_POST['cb_untuk'];
    ...
    if (empty($pkdgsm)) $pkdgsm="0000001851";
    ...
    if ($act=="input") {
        ...
        $query = "INSERT INTO $dbname.t_kaskecilcabang (idkascab, bulan, tanggal, pengajuan, karyawanid, icabangid_o, areaid_o, divisi, jabatanid, jumlah, keterangan, coa4, userid, nmrealisasi, norekening)values"
                . "('$kodenya', '$pbulanpilih', '$periode1', '$putkpengajuan', '$pkaryawanid', '$pidcabang', '$pidarea', '$pdivisi', '$pjabatanid', '$pjumlah', '$pket', '$pcoapilih', '$puserid', '$pnmreal', '$pnorek')";
    }else{
        $query = "UPDATE $dbname.t_kaskecilcabang SET divisi='$pdivisi', tanggal='$periode1', bulan='$pbulanpilih', "
                . " karyawanid='$pkaryawanid', icabangid_o='$pidcabang', areaid_o='$pidarea', jabatanid='$pjabatanid', "
    ...
    $query = "UPDATE $dbname.t_kaskecilcabang SET pengajuan='$putkpengajuan', atasan1='', atasan2='', atasan3='', atasan4='$pkdgsm' WHERE idkascab='$kodenya' LIMIT 1";
    ...
    $query = "select coa from $dbname.t_uangmuka_kascabang WHERE icabangid_o='$pidcabang'";
