...
function ReloadTandaTangan(){
        ...
        $('<input type="button" value="Update TTD" class="btn btn-success">').bind('click', function(){
                Tampilkan("image");
        }).appendTo($tools)
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            if (iid=="") {
                ...
                document.getElementById("demo-form2").action = "module/mod_br_kaskecilcabotc/aksi_kaskecilcabotc.php?module="+module+"&act=simpaneditttd&idmenu="+idmenu;
