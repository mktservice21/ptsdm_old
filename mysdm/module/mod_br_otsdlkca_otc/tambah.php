...
$pperiodeots = date('F Y', strtotime('-1 month', strtotime($hari_ini)));
                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-4'>
                                        ...
                                        <input type='text' id='e_idnobukti' name='e_idnobukti' class='form-control col-md-7 col-xs-12' value='<?PHP echo $pnobukti; ?>' Readonly>
                                    </div>
                                </div>
                                ...
                                <div class='form-group'>
                                      ...
                                      <div class='col-xs-9'>
                                          <select class='soflow' id='cb_karyawan' name='cb_karyawan'>
                                              ...
                                              <?PHP
                                                $tampil=mysqli_query($cnmy, "select karyawanId, nama from hrd.karyawan WHERE divisiid='OTC' AND "
...
<script>
    function TampilkanDataOustanding() {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_otsdlkca_otc/viewdatatabel_ots.php?module=dataotseth",
    ...
    function disp_confirm(pText_,ket)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_br_otsdlkca_otc/simpan_ots.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
