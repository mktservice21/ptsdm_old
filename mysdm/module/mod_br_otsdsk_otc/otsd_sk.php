...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left">
            <h2>
                <?PHP
                $judul="Outstanding Service Kendaraan (OTC)";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_otsdsk_otc/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_otsdsk_otc/viewdatatabel.php?module="+ket,
                            data:"eket="+ket+"&uidc="+eidc+"&idmenu="+idmenu+"&module="+module+"&utgl1="+etgl1+"&utgl2="+etgl2+"&usts="+ests,
                        ...
                        <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=input&idmenu=$_GET[idmenu]"; ?>' id='demo-form2' name='form1' data-parsley-validate class='form-horizontal form-label-left' target="_blank">
                            ...
                            <div class='col-sm-2'>
                                ...
                                <div class="form-group">
                                    <div class='input-group date' id='cbln02'>
                                        <input type='text' id='bulan2' name='bulan2' required='required' class='form-control input-sm' placeholder='tgl awal' value='<?PHP echo $tgl_pertama; ?>' placeholder='dd mmm yyyy' Readonly>
                                        <span class="input-group-addon">
                                           <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                            ...
                            <div class='col-sm-3'>
                                ...
                                <div class="form-group">
                                    ...
                                    <button hidden type='button' class='btn btn-info btn-xs' onclick="disp_confirm('')">Preview</button>
                                    <?PHP
                                    if ($_SESSION['MOBILE']!="Y") {
                                        echo "<button hidden type='button' class='btn btn-danger btn-xs' onclick=\"disp_confirm('excel')\">Excel</button>";
                                    }
                                    ?>
                                </div>
                            </div>
