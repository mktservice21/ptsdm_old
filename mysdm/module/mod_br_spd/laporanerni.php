...
?>    
        ...
        <div id="isikiri">
            <table class='tjudul' width='100%'>
                <?PHP
                    ...
                    echo "<tr><td width='250px'><b>Budget Request Team $pdivisi : </b></td><td nowrap>$nodivisi</td></tr>";
    ...
    <br/>&nbsp;<br/>&nbsp;
        ...
        echo "<tr align='center'>";
        //echo "<td>Ernilya</td> <td></td> <td>(Marianne Prasanti)</td> <td></td> <td>($nnama_ss_mktdir)</td>";
