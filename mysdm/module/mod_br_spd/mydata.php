<?php
    ...
    $sql = "SELECT idinput, DATE_FORMAT(tgl,'%d/%m/%Y') as tgl, "
            ...
            . " nomor, nodivisi, pilih, karyawanid, jenis_rpt, userproses, DATE_FORMAT(tgl_proses,'%d/%m/%Y') tgl_proses, jenis_rpt, tgl_dir, tgl_apv2 ";
    ...
    while( $row=mysqli_fetch_array($query) ) {  // preparing an array
        ...
        if ($pjenisrpt=="K") $pnmpengajuan_jenis="Klaim PC-M";
