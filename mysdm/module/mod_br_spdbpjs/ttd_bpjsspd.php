...
function ReloadTandaTangan(){
        ...
        $('<input type="button" value="Simpan Dana BPJS" class="btn btn-dark">').bind('click', function(){
                Tampilkan("image");
        }).appendTo($tools)
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            var inodiv = document.getElementById('e_nodivisi').value;
            var ijmlrpminta = document.getElementById('e_txtrpminta').value;
            var nperiode = document.getElementById('e_txtperiode1').value;
            var nttdgbr = document.getElementById('txtgambar').value;
            ...
            var myurl = document.getElementById('e_txturl').value;
            if (nperiode=="") {
            ...
            ok_ = 1;
            if (ok_) {
                var r = confirm('pastikan tanda tangan terisi...!!!\n\
Apakah akan melakukan proses simpan...?!!!\n\
...
dan No Divisi '+inodiv+'. ');
                if (r==true) {
                    ...
                    $.ajax({
                        ...
                        data:"uperiode="+nperiode+"&unodiv="+inodiv+"&ujmlrpminta="+ijmlrpminta+"&uttdimg="+uttd,
