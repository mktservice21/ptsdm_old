    ...
    if (!empty($pnodivisi)) {
        ...
        if ($ketemu>0) {
            ...
            if (!empty($kodenya)) {
                ...
                $query = "INSERT INTO dbmaster.t_suratdana_br (idinput, divisi, kodeid, subkode, nomor, tgl, nodivisi, jumlah, keterangan, "
                        . " userid, tglinput, coa4, pilih, tglf, tglt, apv1, tgl_apv1, apv2, tgl_apv2) VALUES "
                        . " ('$kodenya', '$pdivisi', '$pkodeid', '$psubkode', '', '$ptanggal', '$pnodivisi', '$pmintadanarp', '', "
                        . " '$puserid', NOW(), '$pcoa4', 'Y', '$pbulan', '$pbulan', '$puserid', NOW(), '$puserid', NOW())";
