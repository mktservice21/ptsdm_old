...
<div class="">
    ...
    <div class="page-title"><div class="title_left">
            <h3>
                <?PHP
                $judul="Permintaan Dana Kas Kecil";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_spdkas/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        var eaksi = "module/mod_br_spdkas/aksi_spdkas.php";
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_spdkas/viewdatatabel.php?module=viewdata",
