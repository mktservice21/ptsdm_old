...
<div class="">
    ...
    <div class="page-title"><div class="title_left">
            <h3>
                <?PHP
                $judul="Permintaan Dana Kas Kecil Cabang";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_spdkascab/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        var eaksi = "module/mod_br_spdkascab/aksi_spdkascab.php";
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_spdkascab/viewdatatabel.php?module=viewdata",
                        ...
                        <form method='POST' action='<?PHP echo "$aksi?module=$_GET[module]&act=input&idmenu=$_GET[idmenu]"; ?>' 
                            ...
                            <div class='col-sm-5'>
                               ...
                               <div class="form-group">
                                   ...
                                   <a href="?module=finproseskkcab&idmenu=360&act=360" class='btn btn-dark btn-xs' >Proses Kas Kecil</a>
                               </div>
                           </div>
                       </form>
