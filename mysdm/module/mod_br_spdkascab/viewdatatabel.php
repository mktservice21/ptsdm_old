...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#datatablespd').DataTable( {
            ...
            "ajax":{
                url :"module/mod_br_spdkascab/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+eaksi+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_br_spdkascab/aksi_spdkascab.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+"&ket="+ket+"&id="+noid;
...
<form method='POST' action='<?PHP echo "?module='bgtpdkaskecilcabang'&act=input&idmenu=350"; ?>' id='d-form2' name='form2' data-parsley-validate class='form-horizontal form-label-left'>
    <div class='x_content'>
