...
if ($_GET['module']=="viewkode"){
    ...
    $query = "SELECT MAX(SUBSTRING_INDEX(nodivisi, '/', 1)) as pnomor FROM dbmaster.t_suratdana_br WHERE subkode NOT IN ('03', '21') AND stsnonaktif<>'Y' $nfilsubkode AND YEAR(tgl)='$tahuninput' AND divisi='$pdivsi'";// AND kodeid='$pkode'
