...
<?php
	...
	a.nama nama_area, br.nama_karyawan, br.atasan1, br.atasan2, br.atasan3, br.atasan4 
        FROM
                dbmaster.t_ca0 AS br
        LEFT JOIN hrd.karyawan AS k ON br.karyawanid = k.karyawanId
        LEFT JOIN MKT.iarea AS a ON br.areaid = a.areaId and br.icabangid=a.iCabangId WHERE br.stsnonaktif <> 'Y' AND br.divisi='OTC' $fperiode";
    ...
    <div class="clearfix"></div>
        ...
        <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
            <thead>
                ...
                <th align="center">CA <?PHP echo "$pbulan "; ?></th>
            </thead>
            <tbody>
                <?PHP
                    $no=1;
