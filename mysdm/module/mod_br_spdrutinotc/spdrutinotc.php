...
<div class="">
    ...
    <div class="page-title"><div class="title_left">
            <h3>
                <?PHP
                $judul="Permintaan Dana Rutin / Luar Kota OTC";
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        var eaksi = "module/mod_br_spdrutinotc/aksi_spdrutinotc.php";
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_spdrutinotc/viewdatatabel.php?module=viewdata",
