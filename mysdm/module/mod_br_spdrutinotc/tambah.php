            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <div class='x_panel'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                          <select class='form-control input-sm' id='cb_kode' name='cb_kode' onchange="ShowSubKode();" data-live-search="true">
                                              ...
                                              <?PHP
                                                $query = "select distinct kodeid, nama from dbmaster.t_kode_spd WHERE kodeid IN ('1', '2') order by kodeid";
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                          <select class='form-control input-sm' id='cb_kodesub' name='cb_kodesub' data-live-search="true" onchange="ShowDataKode();">
                                              <option value='' selected>-- Pilihan --</option>
                                              <?PHP
                                                $query = "select distinct kodeid, subkode, subnama from dbmaster.t_kode_spd where kodeid='$pkode' AND CONCAT(kodeid,subkode) IN ('103', '221', '236') order by subkode";
                        ...
                        <div id="n_periode_rtn">
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Periode Rutin/LK</label>
                                    <div class='col-md-3'>
                        ...
                        <div hidden id="n_periode_ca">

                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Periode CA <span class='required'></span></label>
                                    <div class='col-md-5'>
                                        <div class='input-group date' id=''>
                                            <input type="text" class="form-control" id='tgl01' name='e_periode1' autocomplete='off' required='required' placeholder='d F Y' value='<?PHP echo $eperiode1; ?>'>
                                            <span class='input-group-addon'>
                                                <span class='glyphicon glyphicon-calendar'></span>
                                            </span>

                                            <input type="text" class="form-control" id='tgl02' name='e_periode2' autocomplete='off' required='required' placeholder='d F Y' value='<?PHP echo $eperiode2; ?>'>
                                            <span class='input-group-addon'>
                                                <span class='glyphicon glyphicon-calendar'></span>
                                            </span>
                                        </div>
                                ...
                                <div class='form-group'>
                                    ...
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>
                                        <div id="lbl_rtn">
                                            <button type='button' class='btn btn-info btn-xs' onclick='HitungJumlahData()'>Hitung Jumlah</button> <span class='required'></span>
                                        </div>
                                        
                                        <div hidden id="lbl_ca">
                                            <button type='button' class='btn btn-info btn-xs' onclick='TampilkanDataCARTN()'>Tampilkan Data</button> <span class='required'></span>
                                        </div>
                                    </label>
                                    <div class='col-md-3'>
...
<script type="text/javascript">
    ...
    function ShowKode() {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_spdrutinotc/viewdata.php?module=viewkode",
            data:"upilihca="+nca,
    ...
    function ShowSubKode() {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_spdrutinotc/viewdata.php?module=viewsubkode",
            data:"ukode="+ikode,
            success:function(data){
    ...
    function BukaTutupPilihan() {
        var ikodesub = document.getElementById('cb_kodesub').value;
        if (ikodesub=="36") {
            n_periode_rtn.style.display="none";
            n_periode_ca.style.display="block";
            lbl_rtn.style.display="none";
            lbl_ca.style.display="block";
        }else{
            n_periode_rtn.style.display="block";
            n_periode_ca.style.display="none";
            lbl_rtn.style.display="block";
            lbl_ca.style.display="none";
        }
    }
    ...
    function ShowNoBukti() { 
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_spdrutinotc/viewdata.php?module=viewnomorbukti",
    ...
    function TampilkanDataCARTN(){
        var eidinput = document.getElementById('e_id').value;
        var idiv = document.getElementById('cb_divisi').value;
        var ikode = document.getElementById('cb_kode').value;
        var ikodesub = document.getElementById('cb_kodesub').value;
        var itgl1 = document.getElementById('tgl01').value;
        var itgl2 = document.getElementById('tgl02').value;
        var iadvance = "";
        //alert(ikodesub); return false;
        $.ajax({
            type:"post",
            url:"module/mod_br_spdrutinotc/datacarutin.php?module=tampilkandatacarutin&uact=caridata",
            data:"udivisi="+idiv+"&ukode="+ikode+"&ukodesub="+ikodesub+"&utgl1="+itgl1+"&utgl2="+itgl2+"&uadvance="+iadvance+"&eidinput="+eidinput+"&uact=caridata",
            success:function(data){
                //document.getElementById('e_jmlusulan').value=data;
                $("#s_div").html(data);
            }
    ...
    function CariDataOTC() {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_spdrutinotc/dataotc.php?module=viewdataotc&ket=detail",
        ...
        */
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_br_spdrutinotc/aksi_spdrutinotc.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
