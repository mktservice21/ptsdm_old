...
<?php
        ...
        $gbrttd_dir2=$ra['gbr_dir2'];
			...
			if (!empty($tgljakukannya)) $tgljakukannya = date("Ymd", strtotime($tgljakukannya));
				...
				if (!empty($tgljakukannya)) {
					if ((double)$tgljakukannya>='20200703') {
    ...
    $nmadvance="**Sudah Ada Bukti";
    if ($padvance=="K") $nmadvance="* Sudah Ada Bukti";
...
?>    
        ...
        <div id="isikiri">
            <table class='tjudul' width='100%'>
                <?PHP
                    ...
                    echo "<tr><td width='250px'><b>Budget Request Team $pdivisi : </b></td><td>$nodivisi</td></tr>";
                    
                    $nket_status="**Cash Advance";
                    if ($padvance=="B") $nket_status="**Petty Cash Marketing";
                    if ($padvance=="K") $nket_status="**Klaim PC-M";
            ...
            <?PHP
                ...
                echo "<tr><td colspan='10'></td></tr>";
						...
						if ($idinputspd=="1976" OR $idinputspd=="2115x") {//
							...
							$gtotal_real=(double)$gtotal_real+1;
						}
    ...
    <br/>&nbsp;<br/>&nbsp;
        ...
        echo "<tr align='center'>";
        //echo "<td>Marianne</td> <td></td> <td>(Marianne Prasanti)</td> <td></td> <td>($nnama_ss_mktdir)</td>";
