...
<script>
    ...
    function pilihData(ket, periode1, periode2, ikaryawan, ilevel, idivisi, ketapv){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_validasi/viewdata.php?module="+ket,
    ...
    function ProsesData(ket, cekbr, ikaryawan){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_validasi/aksi_brvalidasi.php?module="+ket,
            data:"uket="+ket+"&chkbox_br="+allnobr+"&ketrejpen="+txt+"&ukaryawan="+ekaryawan,
            success:function(data){
                
                pilihData(ket,<?PHP echo $pildata; ?>);
                alert(data);
            }
        });
...
<?PHP
    $aksi="module/mod_br_validasi/aksi_brvalidasi.php";
    $hari_ini = date("Y-m-d");
...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Validasi Budget Request By Marketing Service</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <div class="well" style="overflow: auto">
                        <input onclick="pilihData('validate',<?PHP echo $pildata; ?>)" class='btn btn-default' type='button' name='buttonview1' value='List Data'>
                        <input onclick="pilihData('unproses',<?PHP echo $pildata; ?>)" class='btn btn-default' type='button' name='buttonview2' value='Sudah Validasi'>
                     ...
                     <div class='col-sm-3'>
                        ...
                        <div class="form-group">
                            <div class='input-group date'>
                                ...
                                <input type='hidden' class='form-control input-sm' id='e_ketapv' name='e_ketapv' value='VALIDATE' Readonly>
                            </div>
                        </div>
                    </div>
