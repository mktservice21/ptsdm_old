...
session_start();
    ...
    $query = "select 
        ...
        f.NORESI,f.TGLKIRIM,f.TGLTERIMA, f.IGROUP 
        ...
        LEFT JOIN dbmaster.t_barang_keluar_kirim f on a.IDKELUAR=f.IDKELUAR WHERE 1=1 ";//a.DIVISIID IN $filterdivgroup
    ...
    if ($ppilihsts=="REJECT") {
        ...
        if ($ppilihsts=="ALLDATA") {
            ...
            if ($ppilihsts=="APPROVE") {
                $query .=" AND ( IFNULL(a.APV1_TGL,'')='' OR IFNULL(a.APV1_TGL,'0000-00-00')='0000-00-00' OR IFNULL(a.APV1_TGL,'0000-00-00 00:00:00')='0000-00-00 00:00:00') ";
            }elseif ($ppilihsts=="UNAPPROVE") {
                $query .=" AND ( IFNULL(a.APV1_TGL,'')<>'' AND IFNULL(a.APV1_TGL,'0000-00-00')<>'0000-00-00' AND IFNULL(a.APV1_TGL,'0000-00-00 00:00:00')<>'0000-00-00 00:00:00') ";
            }
        }
...
<script>
    ...
    function ProsesDataUnApprove(ket, cekbr){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_brg_aprovepch/aksi_aprovepch.php?module="+module+"&idmenu="+idmenu+"&act="+ket,
        ...
        <table id='datatablestockopn' class='table table-striped table-bordered' width='100%'>
            ...
            <tbody>
                ...
                while ($row1= mysqli_fetch_array($tampil1)) {
                    ...
                    if ($ptglapvpm=="0000-00-00" OR $ptglapvpm=="0000-00-00 00:00:00") $ptglapvpm="";
