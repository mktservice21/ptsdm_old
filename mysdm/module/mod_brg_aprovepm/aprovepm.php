<?PHP
    ...
    $aksi="module/mod_brg_aprovepm/aksi_aprovepm.php";
    $hari_ini = date("Y-m-d");
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_brg_aprovepm/viewdatatable.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                        ...
                        <div class="form-group">
                            <select class='form-control input-sm' id='cb_karyawan' name='cb_karyawan' data-live-search="true">
                                ...
                                if ($pgroupid=="1" OR $pgroupid=="24") {
                                    $query .=" AND (karyawanid in (select distinct IFNULL(APVBY,'') from dbmaster.t_divisi_gimick) OR karyawanId ='$pkaryawanid' )";
                                }else{
