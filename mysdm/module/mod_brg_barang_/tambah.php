...
<script>
    ...
    function ShowDataGrpProd(iwewenang) {
        var ecbgrp =document.getElementById('cb_gprod').value;
        
        $.ajax({
            type:"post",
            url:"module/mod_brg_barang/viewdata.php?module=viewdatabrand",
            data:"uwewenang="+iwewenang+"&ucbgrp="+ecbgrp,
    ...
    function disp_confirm(pText_,ket)  {
        ...
        var esuppid =document.getElementById('cb_supplier').value;
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_brg_barang/aksi_barang.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
                        ...
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-3'>
                                            <select class='form-control input-sm' id='cb_tipebrg' name='cb_tipebrg' data-live-search="true">
                                              <?PHP
                                                $query = "select IDTIPE, NAMA_TIPE from dbmaster.t_barang_tipe WHERE IFNULL(AKTIF,'')<>'N' ";
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-3'>
                                            <select class='form-control input-sm' id='cb_gprod' name='cb_gprod' data-live-search="true" onchange="ShowDataGrpProd('<?PHP echo $ppilihanwewenang; ?>')">
                                              <?PHP
                                                $pnpilihdiv=$pdivisiid;
                                                $query = "select distinct DIVISIID, DIVISINM from dbmaster.t_divisi_gimick WHERE IFNULL(STSAKTIF,'')='Y' ";
                                                ...
                                                while ($row= mysqli_fetch_array($tampil)) {
                                                    ...
                                                    if ($npdivid==$pdivisiid) {
                                                        ...
                                                        if ($pbelumdiv==false) $pnpilihdiv=$npdivid;
                                                        $pbelumdiv=true;
                                                    }
                                                }
                                              ?>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Brand <span class='required'></span></label>
                                    <div class='col-xs-3'>
                                          <select class='form-control input-sm' id='cb_brand' name='cb_brand' data-live-search="true">
                                              <?PHP 
                                              echo "<option value='0' selected>--Pilihan--</option>";
                                              ...
                                              if ($ketemu==1 AND $pgetact=="tambahbaru") {
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-3'>
                                          <select class='form-control input-sm' id='cb_supplier' name='cb_supplier' data-live-search="true">
