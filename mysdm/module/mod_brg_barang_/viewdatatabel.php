...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_brg_barang/aksi_barang.php";
        ...
        var dataTable = $('#datatablegmcbrg').DataTable( {
            ...
            "ajax":{
                url :"module/mod_brg_barang/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&udivprod="+edivprod+"&uwwnpilihan="+ewwnpilihan, // json datasource
