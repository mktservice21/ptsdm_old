...
if ($ketemu>0) {
    ...
    if (!empty($ntglp)) $tgl1 = date('d F Y', strtotime($ntglp));
                        ...
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <input type='text' id='e_noresi' name='e_noresi' class='form-control col-md-7 col-xs-12' value='<?PHP echo $pnomorresi; ?>' >
                                        <br/>*)kosongkan noresi untuk menghapus/batal input, lalu klik save
                                    </div>
