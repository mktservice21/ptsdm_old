...
$sql = "SELECT PILIHAN, IDKELUAR, DATE_FORMAT(TANGGAL,'%d/%m/%Y') as TANGGAL, DIVISIID, "
        ...
        . " ICABANGID, NAMA_CABANGETH, ICABANGID_O, NAMA_CABANGOTC, NORESI, TGLTERIMA, NAMAAREAETH, NAMAAREAOTC, AREAID, AREAID_O ";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $pnmareaeth=$row['NAMAAREAETH'];
    $pnmareaotc=$row['NAMAAREAOTC'];
	...
	if (empty($pcabangpil)) {
		$pcabangpil=$pidcabpl;
		if ($pcabangpil=="JKT_RETAIL") $pcabangpil="JAKARTA RETAIL";
		if ($pcabangpil=="JKT_MT") $pcabangpil="JAKARTA - MODERN TRADE";
	}
