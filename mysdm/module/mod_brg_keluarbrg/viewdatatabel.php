...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_brg_keluarbrg/aksi_keluarbrg.php";
        ...
        var dataTable = $('#datatablegmcbrg').DataTable( {
            ...
            "ajax":{
                url :"module/mod_brg_keluarbrg/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&udivprod="+edivprod+"&uwwnpilihan="+ewwnpilihan+"&ubulan="+ebulan, // json datasource
        ...
        <table id='datatablegmcbrg' class='table table-striped table-bordered' width='100%'>
            <thead>
                <tr>
                    ...
                    <th width='10px'>YG. MENGAJUKAN</th>
