<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Laporan Stock Gimmick Cabang</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
            ...
            default:
                ...
                <script>
                    function disp_confirm(pText)  {
                        ...
                        var pilcabangid=false;
                        var chk_arrcab =  document.getElementsByName('chkbox_cabangid[]');
                        chklength = chk_arrcab.length;
                        for(k=0;k< chklength;k++)
                        {
                            if (chk_arrcab[k].checked == true) {
                                pilcabangid=true;
                                break;
                            }
                        }
                        
                        if (pilcabangid==false) {
                            ...
                            <div class='col-md-6 col-xs-12'>
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group'>
                                            <label class='control-label col-md-3 col-sm-3 col-xs-12'>Cabang &nbsp;<input type="checkbox" id="chkbtncabang" value="deselect" onClick="SelAllCheckBox('chkbtncabang', 'chkbox_cabangid[]')" checked/><span class='required'></span></label>
                                            <div class='col-md-9 col-sm-9 col-xs-12'>
                ...
                <script>
                    ...
                    function ShowDataGrpProduk() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_brg_lapgimcabang/viewdata.php?module=caridatagrpprod",
                    ...
                    function ShowDataCabang() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_brg_lapgimcabang/viewdata.php?module=caridatacabang",
                            data:"udivuntuk="+edivuntuk,
                            success:function(data){
                    ...
                    function RefreshProduk() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_brg_lapgimcabang/viewdata.php?module=caridataprduk",
