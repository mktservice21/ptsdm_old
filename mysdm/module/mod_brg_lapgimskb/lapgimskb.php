<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Laporan Keluar Barang Gimmick</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
            ...
            default:
                ...
                <script>
                    ...
                    function ShowDataGrpProduk() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_brg_lapgimskb/viewdata.php?module=caridatagrpprod",
                    ...
                    function ShowDataCabang() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_brg_lapgimskb/viewdata.php?module=caridatacabang",
                            data:"udivuntuk="+edivuntuk,
                            success:function(data){
                    ...
                    function RefreshProduk() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_brg_lapgimskb/viewdata.php?module=caridataprduk",
