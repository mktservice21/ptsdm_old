            ...
            default:
                ...
                <script>
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_brg_penerima/viewdatatabel.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                    ...
                    function ProsesData(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("d-form2").action = "module/mod_brg_penerima/aksi_penerima.php?module="+module+"&idmenu="+idmenu+"&act="+ket+"&kethapus="+"&ket="+ket+"&id="+noid;
