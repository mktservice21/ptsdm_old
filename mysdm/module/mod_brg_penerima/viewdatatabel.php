...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_brg_penerima/aksi_penerima.php";
        ...
        var dataTable = $('#datatablegmcbrg').DataTable( {
            ...
            "columnDefs": [
                ...
                { className: "text-nowrap", "targets": [0, 1, 5,6,7,8] }//nowrap
            ...
            "ajax":{
                url :"module/mod_brg_penerima/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&uwwnpilihan="+ewwnpilihan, // json datasource
                type: "post",  // method  , by default get
                data:"uwwnpilihan="+ewwnpilihan,
