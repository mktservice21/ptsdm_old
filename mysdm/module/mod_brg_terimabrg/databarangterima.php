            ...
            <tbody>
                ...
                while ($row1= mysqli_fetch_array($tampil1)) {
                    ...
                    while ($row= mysqli_fetch_array($tampil)) {
                        ...
                        $ptxt_jml="<input style='text-align:right;' type='text' value='$pjml' id='txt_njml[$pidbarang]' name='txt_njml[$pidbarang]' class='inputmaskrp2 inputbaya' size='8px' onblur=\"HitungJumlahDataKeluar('txt_njml[$pidbarang]')\">";
