...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_budget_realisasi/aksi_budg_realisasi.php";
        ...
        //alert(etgl1);
        var dataTable = $('#datatablebmreal').DataTable( {
            "processing": true,
            "serverSide": true,
            "stateSave": true,
            "order": [[ 0, "desc" ]],
            ...
            "columnDefs": [
                ...
                { className: "text-right", "targets": [5,6] },//right
            ...
            "ajax":{
                url :"module/mod_budget_realisasi/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&utgltipe="+etgltipe+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_budget_realisasi/aksi_budg_realisasi.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+"&ket="+ket+"&id="+noid;
...
<form method='POST' action='<?PHP echo "?module='realisasibudgetmarketing'&act=input&idmenu=218"; ?>' id='d-form2' name='form2' data-parsley-validate class='form-horizontal form-label-left'>
    ...
    <div class='x_content'>
        <table id='datatablebmreal' class='table table-striped table-bordered' width='100%'>
            <thead>
                <tr>
                    <th width='7px'>NO</th>
