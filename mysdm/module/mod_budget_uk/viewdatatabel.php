<?PHP
    ...
    $_SESSION['BMRTIPE']="";
    $_SESSION['BMRTGLTIPE']=$_POST['utgltipe'];
    $_SESSION['BMRPERENTY1']=$_POST['uperiode1'];
    $_SESSION['BMRPERENTY2']=$_POST['uperiode2'];
...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_budget_uk/aksi_uangmuka.php";
        ...
        //alert(etgl1);
        var dataTable = $('#datatablebuk').DataTable( {
            "processing": true,
            "serverSide": true,
            "stateSave": true,
            "order": [[ 0, "desc" ]],
            ...
            "ajax":{
                url :"module/mod_budget_uk/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&utgltipe="+etgltipe+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_budget_uk/aksi_uangmuka.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+"&ket="+ket+"&id="+noid;
...
<form method='POST' action='<?PHP echo "?module='uangmuka'&act=input&idmenu=233"; ?>' id='d-form2' name='form2' data-parsley-validate class='form-horizontal form-label-left'>
    ...
    <div class='x_content'>
        <table id='datatablebuk' class='table table-striped table-bordered' width='100%'>
            <thead>
                <tr>
                    <th width='7px'>NO</th>
                    <th width='50px'></th>
