...
if ($pact=="editdata"){
    ...
    $edit = mysqli_query($cnmy, "SELECT * FROM dbmaster.t_uangmuka_kascabang WHERE icabangid_o='$pidkodeinput'");
...
$query = "select nama as nama from MKT.icabang_o WHERE icabangid_o='$pidkodeinput'";
                    ...
                    <div class='x_panel'>
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Tgl. Tambahan </label>
                                    <div class='col-md-3 col-sm-3 col-xs-12'>
    ...
    function disp_confirm(pText_,ket)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_budget_ukkaskecilcabchc/aksi_ukkaskecilcabchc.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
