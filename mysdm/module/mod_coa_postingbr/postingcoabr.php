...
<div class="">
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_coa_postingbr/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_coa_postingbr/viewdatatabel.php?module="+ket,
