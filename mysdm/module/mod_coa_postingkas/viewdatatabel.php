        ...
        <table id='datatablercbi' class='table table-striped table-bordered' width='100%'>
            ...
            <tbody>
                <?PHP
                    $awal = 1;
                    $lewat = 0;
                    $sql = "SELECT kodeid, nama FROM hrd.bp_kode order by kodeid, nama";
                    ...
                    while ($t= mysqli_fetch_array($tampil)) {
                        ...
                        $query = "select a.divisi, a.kodeid, a.COA4, b.NAMA4 from dbmaster.posting_coa_kas a JOIN dbmaster.coa_level4 b on a.COA4=b.COA4 where a.kodeid='$nobrid'";
            ...
            <div class='col-sm-4'>
                ...
                <div class="form-group">
                    <select class='form-control input-sm' id="cb_coa" name="cb_coa">
                        <?PHP
                        $fildiv="";
                        $query = "select * from dbmaster.v_coa_all where 1=1 order by DIVISI, COA4, NAMA4";
    ...
    function disp_confirm(pText_)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_coa_postingkas/aksi_postingcoakas.php";
