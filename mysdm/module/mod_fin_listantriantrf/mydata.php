...
$sql = "SELECT idgroup, idantrian, DATE_FORMAT(tanggal,'%d/%m/%Y') as tanggal, status_trf, "
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $pnamaststrf="";
    if ($pststrf=="CA") $pnamaststrf="Tunai/Cash";
    if ($pststrf=="BC") $pnamaststrf="BCA";
    if ($pststrf=="NB") $pnamaststrf="NON BCA";
    if ($pststrf=="VA") $pnamaststrf="Virtual Account";
    if ($pststrf=="PY") $pnamaststrf="Payroll";
    if ($pststrf=="TG") $pnamaststrf="Tagihan";
    
    
    $pbtnedit = "<a class='btn btn-success btn-xs' href='?module=$pmodule&act=editdata&idmenu=$pidmenu&nmun=$pidmenu&id=$pgroupid'>Edit</a>";
