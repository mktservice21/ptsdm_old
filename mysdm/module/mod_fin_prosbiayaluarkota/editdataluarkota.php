...
<html>
    <head>
        ...
        <script>
            ...
            function SimpanData(idrutin, nourut, noid, eqty, qrp, etotal, ealasan, etotsemua, ekm) {
                ...
                //alert(iidrutin+", "+inourut+", "+inoid+", "+iqty+", "+irp+", "+itotal+", "+ialasan+", "+itotsemua+", "+ikm); return false;
                ...
                if (ok_) {
                    ...
                    if (r==true) {
                        ...
                        $.ajax({
                            ...
                            data:"uidrutin="+iidrutin+"&unourut="+inourut+"&uinoid="+inoid+"&uiqty="+iqty+"&uirp="+irp+"&uitotal="+itotal+"&uialasan="+ialasan+"&uitotsemua="+itotsemua+"&ukm="+ikm,
                ...
                while ($uc=mysqli_fetch_array($tampil)){
                    ...
                    if ($ada>0) {
                        ...
                        while ($c=mysqli_fetch_array($cari)){
                            ...
                            $kmdetailisi="<span $nb_txt1>&nbsp; &nbsp;...&nbsp;&nbsp;&nbsp; <b>KM : </b><input type='text' class='input-sm inputmaskrp2' name='$nmkmdetail' id='$nmkmdetail' size='10px' value='$upkmdetail'></span>";
                            ...
                            echo "<td>
                                    ...
                                    <input type='button' id='$nmsave' name='$nmsave' value='Save' onclick=\"SimpanData('$nmidrutnya', '$nmnourutnya', '$nmnoidnya', '$nmqty', '$nmrp', '$nmtot', '$nmalasan', 'e_totalsemua', '$nmkmdetail')\">
                    ...
                    for ($i=1; $i <=$tjml; $i++) {
                        ...
                        $nmsavenya="<input type='$inputestisibtn' id='$nmsave' name='$nmsave' value='Save' onclick=\"SimpanData('$nmidrutnya', '$nmnourutnya', '$nmnoidnya', '$nmqty', '$nmrp', '$nmtot', '$nmalasan', 'e_totalsemua', '$nmkmdetail')\">";
                        echo "<tr>";
                        echo "<td>$no</td>";
                        echo "<td>$uc[nama]</td>";
                        ...
                        echo "<td><input type='$phide' size='1px' id='$nmqty' name='$nmqty' class='input-sm inputmaskrp2' autocomplete='off' onblur=\"hit_total('$nmqty','$nmrp','$nmtot')\" value='1'> "
                                ...
                                . " <input type='$inputestisi' size='12px' id='$nmtot' name='$nmtot' class='input-sm inputmaskrp2' autocomplete='off' onblur='findTotal()' value='' $readon>"
                                . "$kmdetailisi</td>";
