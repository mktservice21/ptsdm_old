...
$(document).ready(function() {
        ...
        $('<input type="button" value="Rekap Data" class="btn btn-success">').bind('click', function(e){
                RekapData('rekapdata', 'chkbox_br[]')
        }).appendTo($tools)
        
        $('<input type="button" value="Rekap Data Excel" class="btn btn-info">').bind('click', function(e){
                RekapData('excel', 'chkbox_br[]')
        }).appendTo($tools)
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            //simpan data ke DB
            var cmt = confirm('Anda harus menambahkan tanda tangan....!!!');
            if (cmt == false) {
                return false;
            }            
            ...
            $.ajax({
                type:"post",
                url:"module/mod_fin_prosbiayaluarkota/aksi_prosbiayaluarkota.php?module="+module+"&idmenu="+idmenu+"&act=simpan_ttdallfin",
