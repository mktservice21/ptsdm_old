...
<?php
    ...
    $kodeinput = " AND br.kode=2 "; //membedakan biaya luar kota dan rutin
    ...
    $_SESSION['PROSBLK_TIPE'] = $isitipe;
    $_SESSION['PROSBLK_KET'] = $cket;
    $_SESSION['PROSBLK_TGL1'] = $mytgl1;
    $_SESSION['PROSBLK_TGL2'] = $mytgl2;
    $_SESSION['PROSBLK_KRY'] = $karyawan;
    $_SESSION['PROSBLK_LVL'] = $lvlposisi;
    $_SESSION['PROSBLK_DIV'] = $divisi;
    $_SESSION['PROSBLK_STSAPV'] = $stsapv;
...
<form method='POST' action='' id='d-form2' name='d-form2' data-parsley-validate class='form-horizontal form-label-left'>
    ...
    <div class='x_content'>
        ...
        <table id='datatableprosblk' class='table table-striped table-bordered' width='100%'>
            <thead>
                <tr>
                    <th width='20px'>
            ...
            <tbody>
                ...
                $sql.=" AND ((DATE_FORMAT(br.periode1,'%Y-%m') between '$tgl1' AND '$tgl2') OR (DATE_FORMAT(br.periode2,'%Y-%m') between '$tgl1' AND '$tgl2')) ";
...
?>
    ...
    <?PHP
        if (strtoupper($cket)=="APPROVE") {
            ...
            include "ttd_prosbiayaluarkota.php";
            echo "</div>";
        }
    ?>
</form>
...
<script>
    $(document).ready(function() {
        //alert(etgl1);
        var dataTable = $('#datatableprosblk').DataTable( {
            "stateSave": true,
            "order": [[ 0, "desc" ]],
    ...
    function ProsesData(ket, cekbr){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_fin_prosbiayaluarkota/aksi_prosbiayaluarkota.php?module="+module+"&idmenu="+idmenu+"&act="+ket,
    ...
    function disp_confirm(pText_, act)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_fin_prosbiayaluarkota/aksi_prosbiayaluarkota.php?module="+module+"&idmenu="+idmenu+"&act="+act;
