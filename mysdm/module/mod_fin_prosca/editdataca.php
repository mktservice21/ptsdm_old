...
<html>
    <head>
        ...
        <script>
            ...
            function SimpanDataPeriode(iidca, nperiode) {
                var iperiode = document.getElementById(nperiode).value;
                
                //alert(iidca+", "+iperiode); return false;
                ...
                if (ok_) {
                    ...
                    if (r==true) {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_fin_prosca/simpandatacaperiode.php?module=simpandatanyaperiode",
                            data:"uidca="+iidca+"&uperiode="+iperiode,
                            success:function(data){
                                alert(data);
                            }
                        });
    ...
    <body>
        <div id="div1">
            <?PHP
                ...
                $ntglperiode=date("Y-m-d", strtotime($row['bulan']));
                $ntglperiode2=date("Y-m", strtotime($row['bulan']));
                ...
                <div id="isikiri">
                    <table class='tjudul' width='100%'>
                        ...
                        <tr><td>PERIODE</td><td>:</td><td> 
                            <?PHP
                            $ntxtper="<input type='month' id='t_per1' name='t_per1' value='$ntglperiode2'>";
                            
                            //echo "$bulanca";
                            echo "$ntxtper";
                            $nsimpanedt="<input type='button' id='tsimpanper' name='tsimpanper' value='Update' onclick=\"SimpanDataPeriode('$idbr', 't_per1')\">";
                            echo "&nbsp; &nbsp; $nsimpanedt";
                            ?>
                            </td></tr>
                        <?php
