<?PHP
    ...
    $aksi="module/mod_fin_proscabiayaotc/aksi_apvca.php";
    $hari_ini = date("Y-m-d");
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_fin_proscabiayaotc/viewdatatable.php?module="+ket,
            data:"eket="+ket+"&uperiode1="+etgl1+"&uperiode2="+etgl2+"&ukaryawan="+ekaryawan+"&udiv="+alldiv,
...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="title_left">
            <h3>
                Proses Cash Advance, Biaya Rutin & Luar Kota OTC
            </h3>
