...
if (empty($puser)) {
    ...
    */
	...
	$custid=$data1['CUSTID'];
        ...
        $pinst_sls_data[] = "('$cabang','$custid','$tgljual','$brgid','$harga','$qbeli','$qbonus','$nojual')";
        $pinsertsave=true;
    ...
    if ($pinsertsave==true) {
        $query_sls_ins = "INSERT INTO $dbname.salesspp(cabangid,custid,tgljual,brgid,harga,qbeli,qbonus,fakturid) VALUES "
