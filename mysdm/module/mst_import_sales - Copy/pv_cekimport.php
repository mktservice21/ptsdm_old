...
if (empty($puser)) {
    ...
    if (!empty($pnamatext_cus)) {    
        ...
        while (!feof($open)) {
            ...
            list($pfile0,$pfile1,$pfile2,$pfile3,$pfile4,$pfile5,$pfile6,$pfile7) = $explodeLine;
    ...
    if (!empty($pnamatext_sls)) {    
        ...
        while (!feof($open)) {
            ...
            list($pfile0,$pfile1,$pfile2,$pfile3,$pfile4,$pfile5,$pfile6,$pfile7,$pfile8,$pfile9,$pfile10,$pfile11,$pfile12,$pfile13,$pfile14) = $explodeLine;
