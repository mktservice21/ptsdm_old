...
if (empty($puser)) {
    ...
    if ($pinsert){
        ...
        for ($ind=1;$ind<=$jum_record;$ind++){
            ...
            $pinst_data_4[] = "('$pfile0', '$pfile1', '$pfile2', '$pfile3', '$pfile4', '$pfile5', '$pfile6', '$pfile7', '$pfile8', '$pfile9')";
            $pinsertsave=true;
    ...
    if ($pinsertsave==true) {
        $query_pros4 = "INSERT INTO $dbname.$pnmtab4 (CUSTID, TGLJUAL, NOJUAL, BRGID, HARGA, QBELI, QBONUS, DPL, XNOJUAL, KET)values "
