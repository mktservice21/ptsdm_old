...
if (empty($puser)) {
    ...
    for ($i=2; $i <= $numRows ; $i++) {
        ...
        $query = "INSERT INTO $dbname.import_bks (jeniskode, slkode, brkode, brnama, "
                . " batchitem, tanggal, jlfkt2, plgkode, nama, alamat, kota, jumlah, satuan, harsat, ttlhna, nodpl)values"
                . " ('$pfile0', '$pfile1', '$pfile2', '$pfile3', "
                . " '$pfile4', '$pfile5', '$pfile6', '$pfile7', '$pfile8', '$pfile9', '$pfile10', '$pfile11', '$pfile12', '$pfile13', '$pfile14', '$pfile20')";
