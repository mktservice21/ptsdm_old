...
if (empty($puser)) {
    ...
    if ($pinsert){
        ...
        for ($ind=1;$ind<=$jum_record;$ind++){
            ...
            $query = "INSERT INTO $dbname.subdist_mscust_ep (CUSTID, CUSTNM, ALAMAT, KOTAID, "
