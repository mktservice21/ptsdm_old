                        ...
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div hidden class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='cb_untuk' name='cb_untuk' onchange="" data-live-search="true">
                                            <?PHP
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                ...
                if (empty($sudahapv)) {
                    if ($pmyact=="editdata") {
                        ...
                        include "module/pch_pr/ttd_pchreq.php";
                        echo "</div>";
                    }
                ?>
                <?PHP
...
<script>
    ...
    function ShowDataCabang() {
        ...
        $.ajax({
            type:"post",
            url:"module/pch_pr/viewdatapr.php?module=caricabang",
            data:"ukry="+ikry,
    ...
    function ShowDataAtasan() {
        ...
        $.ajax({
            type:"post",
            url:"module/pch_pr/dataatasanpr.php?module=caridataatasan",
    ...
    function getDataBarang(data1, data2, data3, data4){
        ...
        $.ajax({
            type:"post",
            url:"module/pch_pr/viewdata_barangpr.php?module=viewdatabarang",
    ...
    function disp_confirm(pText_,ket)  {
        ...
        $.ajax({
            type:"post",
            url:"module/pch_pr/viewdatapr.php?module=cekdatasudahada",
                ...
                if (data=="boleh") {
                    ...
                    if (ok_) {
                        ...
                        if (r==true) {
                            ...
                            document.getElementById("demo-form2").action = "module/pch_pr/aksi_purchasereq.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
