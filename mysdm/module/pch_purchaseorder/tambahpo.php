                        ...
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div id="c_input">
                                    <div class='form-group'>
                                        <div id='loading2'></div>
                                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Pembualatan <span class='required'></span></label>
                                        <div class='col-md-3'>
                                            <input type='text' id='e_jmlbulat' name='e_jmlbulat' autocomplete='off' class='form-control col-md-7 col-xs-12 inputmaskrp2' value='<?PHP echo $ppembulatan_h; ?>' onblur="HitungPembualatan()">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                ...
                if (empty($sudahapv)) {
                    if ($pact=="editdata") {
                        ...
                        include "module/pch_purchaseorder/ttd_po.php";
                        echo "</div>";
                    }
                ?>
                <?PHP
...
<script>
    ...
    function CariData()  {
        ...
        $.ajax({
            type:"post",
            url:"module/pch_purchaseorder/dataprsupp.php?module=viewdataprpo&ket=detail",
    ...
    function disp_confirm(pText_,ket)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/pch_purchaseorder/aksi_purchaseorder.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
