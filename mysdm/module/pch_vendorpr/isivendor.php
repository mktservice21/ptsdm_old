...
<script>
    ...
    function getDataVendor(data1, data2, data3){
        ...
        $.ajax({
            type:"post",
            url:"module/pch_vendorpr/viewdata_vendor.php?module=viewdatavendor",
    ...
    function disp_confirm(pText_,ket)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/pch_vendorpr/aksi_isivendor.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
