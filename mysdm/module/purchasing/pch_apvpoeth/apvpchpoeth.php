<?PHP
    ...
    $aksi="module/purchasing/pch_apvpoeth/aksi_apvpchpoeth.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['APVPCHPOSTS'])) $apvpilih=$_SESSION['APVPCHPOSTS'];
    if (!empty($_SESSION['APVPCHPOBLN1'])) $tgl_pertama=$_SESSION['APVPCHPOBLN1'];
    if (!empty($_SESSION['APVPCHPOBLN2'])) $tgl_akhir=$_SESSION['APVPCHPOBLN2'];
    //if (!empty($_SESSION['APVPCHPOAPVBY'])) $pkaryawanid=$_SESSION['APVPCHPOAPVBY'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/purchasing/pch_apvpoeth/viewdatatableaapvpchpo.php?module="+module+"&idmenu="+idmenu+"&act="+act,
