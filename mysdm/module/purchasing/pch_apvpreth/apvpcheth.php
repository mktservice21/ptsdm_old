<?PHP
    ...
    if (!empty($_SESSION['APVPCHPRSTS'])) $apvpilih=$_SESSION['APVPCHPRSTS'];
    if (!empty($_SESSION['APVPCHPRBLN1'])) $tgl_pertama=$_SESSION['APVPCHPRBLN1'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/purchasing/pch_apvpreth/viewdatatableaapvpch.php?module="+module+"&idmenu="+idmenu+"&act="+act,
