<?PHP
    ...
    $aksi="module/purchasing/pch_prosesprit/aksi_vendorpr.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['PCHPRITSTS'])) $apvpilih=$_SESSION['PCHPRITSTS'];
    if (!empty($_SESSION['PCHPRITTGL1'])) $tgl_pertama=$_SESSION['PCHPRITTGL1'];
    if (!empty($_SESSION['PCHPRITTGL2'])) $tgl_akhir=$_SESSION['PCHPRITTGL2'];
            ...
            default:
                ...
                <script>
                    ...
                    function pilihData(ket){
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/purchasing/pch_prosesprit/viewdatatable.php?module="+module+"&idmenu="+idmenu+"&act="+act,
                    ...
                    <div class='col-md-12 col-sm-12 col-xs-12'>
                        <div class='x_panel'>
                            ...
                            <div class="well" style="overflow: auto; margin-top: -5px; margin-bottom: 5px; padding-top: 10px; padding-bottom: 6px;">
                                <input onclick="pilihData('approve')" class='btn btn-success btn-sm' type='button' name='buttonview1' value='Belum Proses'>
                                <input onclick="pilihData('unapprove')" class='btn btn-dark btn-sm' type='button' name='buttonview2' value='Sudah Proses'>
