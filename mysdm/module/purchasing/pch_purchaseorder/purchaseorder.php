<?PHP
    ...
    if (!empty($_SESSION['PCHSESITGLPO01'])) $tgl_pertama = $_SESSION['PCHSESITGLPO01'];
    if (!empty($_SESSION['PCHSESITGLPO02'])) $tgl_akhir = $_SESSION['PCHSESITGLPO02'];
...
<div class="">
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/purchasing/pch_purchaseorder/.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/purchasing/pch_purchaseorder/viewdatatabelpo.php?module="+module+"&act="+act+"&idmenu="+idmenu+"&nmun="+idmenu,
