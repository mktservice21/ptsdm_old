<?PHP
    ...
    $_SESSION['POTBRGKARYA']=$_POST['ukryid'];
    $_SESSION['POTBRGTGL01']=$_POST['uperiode1'];
    $_SESSION['POTBRGTGL02']=$_POST['uperiode2'];
...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#datatablespd').DataTable( {
            ...
            "ajax":{
                url :"module/purchasing/pch_terimabarangpo/mydata_tpo.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+eaksi+"&ukryid="+ekryid+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
