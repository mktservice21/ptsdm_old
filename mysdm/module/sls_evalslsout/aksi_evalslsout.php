...
$pidcustomerpl=(INT)$rs1['icustid'];
$pidcabpl=(INT)$rs1['icabangid'];
$pidareapl=(INT)$rs1['areaid'];
        ...
        <div id="isikiri">
            <table class='tjudul' width='100%'>
                ...
                if ($ppilihrpt=="excel") {
                    ...
                    echo "<tr><td colspan=5 width='150px'><b>Outlet : $pnamaoutlet</b> ($pidcabpl - $pidareapl - <b>$pidcustomerpl</b>)</td></tr>";
                    ...
                    echo "<tr><td width='150px'><b>Outlet : $pnamaoutlet</b> ($pidcabpl - $pidareapl - <b>$pidcustomerpl</b>)</td></tr>";
