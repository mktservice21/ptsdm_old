<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Laporan Sales Per Sektor By Region</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
            ...
            default:
                ...
                <script>
                    function disp_confirm(pText)  {
                        var eregi = document.getElementById("cb_region").value;
                                    ...
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Region <span class='required'></span></label>
                                            <div class='col-md-9 col-sm-9 col-xs-12'>
                                                <select class='form-control' name='cb_region' id='cb_region' onchange="ShowDataPilihDataReg()">
                                                    <?PHP
                                                        if ($pregpilih=="B" AND (DOUBLE)$noregi==1){
                                                            echo "<option value='B' selected>Barat</option>";
                                                        }elseif ($pregpilih=="T" AND (DOUBLE)$noregi==1) {
                                                            echo "<option value='T' selected>Timur</option>";
                                                        }else{
                                                            echo "<option value='B' selected>Barat</option><option value='T'>Timur</option>";
                ...
                <script>
                    ...
                    function ShowDataCabang() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/sls_lapslspersektorreg/viewdata.php?module=caricabangregion",
