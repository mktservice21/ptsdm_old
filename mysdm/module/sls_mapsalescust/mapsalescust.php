<?PHP
    ...
    if (!empty($_SESSION['SLSMPCUSTTGL01'])) $tgl_pertama = $_SESSION['SLSMPCUSTTGL01'];
    if (!empty($_SESSION['SLSMPCUSTTGL02'])) $tgl_akhir = $_SESSION['SLSMPCUSTTGL02'];
...
<div class="">
    ...
    <div class="page-title"><div class="title_left">
            <h3>
                <?PHP
                $judul="Revisi Mapping Customer By Area";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/sls_mapsalescust/.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/sls_mapsalescust/viewdatatabelmp.php?module="+module+"&act="+act+"&idmenu="+idmenu+"&nmun="+idmenu,
