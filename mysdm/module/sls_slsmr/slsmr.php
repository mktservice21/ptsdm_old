<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Report Sales Per Medical Representative</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
        $aksi="eksekusi3.php";
                                    ...
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <div class='col-md-9 col-sm-9 col-xs-12'>
                                                ...
                                                <select class='form-control' name='mr' id='mr'>
                                                    <?PHP
                                                    include "config/koneksimysqli_it.php";
                                                    $query = "select distinct karyawanId, nama from hrd.karyawan where jabatanId in (15) order by nama";
                                                    $tampil = mysqli_query($cnit, $query);
                                                    echo "<option value=''>--Pilih--</option>";
                                                    while ($ir=  mysqli_fetch_array($tampil)) {
                                                        echo "<option value='$ir[karyawanId]'>$ir[nama] - $ir[karyawanId]</option>";
                                                    }
                                                    ?>
                                                </select>
