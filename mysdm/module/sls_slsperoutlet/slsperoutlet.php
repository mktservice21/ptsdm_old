                                            ...
                                            <div class='col-md-8'>
                                                <div class="form-group">
                                                    ...
                                                    <div class='input-group date' id='tgl02'>
                                                        <input type='text' id='e_bulan02' name='e_bulan02' required='required' class='form-control' placeholder='tgl awal' value='<?PHP echo $tgl_akhir; ?>' placeholder='dd mmm yyyy' Readonly>
                                                        <span class="input-group-addon">
                                                           <span class="glyphicon glyphicon-calendar"></span>
                                                        </span>
                                                    </div>
