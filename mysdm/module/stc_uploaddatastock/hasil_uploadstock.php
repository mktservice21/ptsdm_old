<?php
    ...
    $query = "CREATE TABLE $tmp01 (PERIODE DATE, DIVPRODID VARCHAR(5), KDPROD VARCHAR(10), NMPROD VARCHAR(200), "
            ...
            . " NOBATCH VARCHAR(100), EXPDATE DATE, ITOTAL DECIMAL(20,2), JENIS VARCHAR(200), KDPRODSDM VARCHAR(10), NMPRODSDM VARCHAR(200))";
                    ...
                    <?PHP
                        ...
                        foreach ($objPHPExcel->getWorksheetIterator() as $worksheet){
                            ...
                            for($row=5; $row<=$totalrow; $row++){
                                ...
                                $pfile10 = mysqli_real_escape_string($cnms, $worksheet->getCellByColumnAndRow(5, $row)->getValue());
                                $pfile11 = mysqli_real_escape_string($cnms, $worksheet->getCellByColumnAndRow(6, $row)->getValue());
                                ...
                                if (empty($pfile11)) $pfile11="In House";
                                ...
                                $insert_stock[] = "('$ptglpilihupload','$pfile0','$pfile1','$pfile2','$pfile3','$pthnblntgl', '$pfile10', '$pfile11')";
                                $pbolehsave=true;
                        ...
                        if ($pbolehsave==true) {
                            $query_stcok = "INSERT INTO $tmp01 (PERIODE, KDPROD, NMPROD, PQTY, NOBATCH, EXPDATE, ITOTAL, JENIS) VALUES "
                            ...
                            $query = "INSERT INTO sls.istock (bulan, kdproduk, qty, nobatch, expdate, itotal, jenis)"
                                    . "SELECT '$pblnini' as bulan, KDPROD, PQTY, NOBATCH, EXPDATE, ITOTAL, JENIS FROM $tmp01 ORDER BY EXPDATE, KDPROD";
                            ...
                            <table id='dtablepiluptgt' class='table table-striped table-bordered' width="100%" border="1px solid black">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center" nowrap>Total Produksi</th>
                                ...
                                <tbody>
                                    ...
                                    if ($ketemu1>0) {
                                        while ($row1= mysqli_fetch_array($tampil1)) {
                                            ...
                                            $totalitot=(double)$totalitot+(double)$nfile10;
                                    ...
                                    $totalitot=number_format($totalitot,0,",",",");
                                    echo "<tr>";
                                    echo "<td nowrap></td>";
                                    echo "<td nowrap></td>";
                                    ...
                                    echo "<td nowrap></td>";
                                    echo "<td nowrap></td>";
                                    echo "<td nowrap align='right'>$totalitot</td>";
                                    echo "<td nowrap></td>";
                                    echo "<td nowrap></td>";
                                    echo "<td nowrap></td>";
                                    echo "</tr>";
