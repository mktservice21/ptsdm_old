                                    ...
                                    <div class='col-sm-12'>
                                        ...
                                        <div class="form-group">
                                            <select class='form-control' id="cb_divisi" name="cb_divisi" onchange="">
                                                <?PHP
                                                if ($x_divisi=="OTC") {
                                                    echo "<option value='ETHICAL'>BR ETHICAL</option>";
                                                    echo "<option value='OTC' selected>OTC</option>";
                                                    echo "<option value='KD'>KLAIM DISC.</option>";
                                                }elseif ($x_divisi=="KD") {
                                                    echo "<option value='ETHICAL'>BR ETHICAL</option>";
                                                    echo "<option value='OTC'>OTC</option>";
                                                    echo "<option value='KD' selected>KLAIM DISC.</option>";
                                                }else{
                                                    echo "<option value='ETHICAL' selected>BR ETHICAL</option>";
                                                    echo "<option value='OTC'>OTC</option>";
                                                    echo "<option value='KD'>KLAIM DISC.</option>";
                                                }
                                                ?>
