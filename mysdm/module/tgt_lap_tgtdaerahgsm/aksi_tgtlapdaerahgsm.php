<?php
    ...
    if ($ppilihrpt=="excel") {
        ...
        header("Content-Disposition: attachment; filename=Report Target Per Daerah SM GSM.xls");
    }
    ...
    $tmp01 =" dbtemp.tmplaptgtdrgsm01_".$puserid."_$now ";
    $tmp02 =" dbtemp.tmplaptgtdrgsm02_".$puserid."_$now ";
    
    $query ="select divprodid, iprodid, hna, sum(qty) qty, sum(value) tvalue from tgt.target0 where "
...
<HTML>
<HEAD>
    <title>Report Target Per Daerah (SM /GSM)</title>
...
<div id='n_content'>
    ...
    <center><div class='h1judul'>Report Target Per Daerah (SM / GSM)</div></center>
