<?php
    ...
    $now=date("mdYhis");
    $tmp01 =" dbtemp.DTTMLGTLCUSR_01".$_SESSION['USERID']."_$now ";
    $tmp02 =" dbtemp.DTTMLGTLCUSR_02".$_SESSION['USERID']."_$now ";
    ...
    $query ="select * from tgt.targetcab WHERE DATE_FORMAT(bulan,'%Y%m')='$pperiode_' AND icabangid='$pidcabpil'";
