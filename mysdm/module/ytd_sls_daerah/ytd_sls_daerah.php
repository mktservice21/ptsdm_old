...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Report Sales YTD Per Daerah</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
            ...
            default:
                                            ...
                                            <div class='col-md-9 col-sm-9 col-xs-12'>
                                                <select class='form-control' name='cb_cabang' id='cb_cabang'>
                                                    ...
                                                    if ($pmygroupid=="1" OR $pmygroupid=="24") {
                                                        ...
                                                        if ($pmyidcard=="0000000158" OR $pmygroupid=="27") $query .=" AND region='B' ";
                                                        if ($pmyidcard=="0000000159" OR $pmyidcard=="0000002073") $query .=" AND region='T' ";
                ...
                <script>
                    function ShowDataCabangRegion() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/ytd_sls_daerah/viewdata.php?module=caricabangregion",
