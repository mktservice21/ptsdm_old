<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Report Sales YTD AM / SPV</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
                            ...
                            <div class='col-md-6 col-xs-12'>
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group'>
                                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for='distibutor'>AM / SPV <span class='required'></span></label>
                                            <div class='col-md-9 col-sm-9 col-xs-12'>
                                                <select class='form-control' name='cb_karyawanid' id='cb_karyawanid'>
                                                    ...
                                                    if ($pmyjabatanid=="10" OR $pmyjabatanid=="18") {
                                                        ...
                                                        $query =" select DISTINCT a.karyawanid, b.nama from ms.ispv0 a join ms.karyawan b on a.karyawanid=b.karyawanid "
                                                                . " JOIN ms.idm0 c on a.icabangid=c.icabangid where c.karyawanid='$pmyidcard' ";
                                                    ...
                                                    while ($rx= mysqli_fetch_array($tampil)) {
                                                        $nidkryam=$rx['karyawanid'];
                                                        $nnmkryam=$rx['nama'];
                                                        if ($pmyidcard==$nidkryam)
                                                            echo "<option value='$nidkryam' selected>$nnmkryam</option>";
                                                        else
                                                            echo "<option value='$nidkryam'>$nnmkryam</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
