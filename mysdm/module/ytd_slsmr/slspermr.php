<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left"><h3>Report Sales YTD MR</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
        <?php
                            ...
                            <div class='col-md-6 col-xs-12'>
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        ...
                                        <div class='form-group'>
                                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for='distibutor'>MR <span class='required'></span></label>
                                            <div class='col-md-9 col-sm-9 col-xs-12'>
                                                <select class='form-control' name='cb_karyawanid' id='cb_karyawanid'>
                                                    ...
                                                    if ($pmyjabatanid=="15") {
                                                        ...
                                                        $query =" select DISTINCT a.karyawanid, b.nama from sls.imr0 a join hrd.karyawan b on a.karyawanid=b.karyawanid "
                                                    ...
                                                    while ($rx= mysqli_fetch_array($tampil)) {
                                                        $nidkrymr=$rx['karyawanid'];
                                                        $nnmkrymr=$rx['nama'];
                                                        if ($pmyidcard==$nidkrymr)
