...
<?php
	...
	c1.NAMA4 nama_coa
        ...
        LEFT JOIN dbmaster.coa_level4 c1 ON c1.COA4 = b1.coa WHERE br.kode=2 AND br.stsnonaktif <> 'Y' $fperiode $fdivisi ";
        
    $now=date("mdYhis");
    $tmp01 =" dbtemp.DTBRRTNOTC01_".$_SESSION['IDCARD']."_$now ";
        
?>
    <center><h2><u>LAPORAN DETAIL BIAYA LUAR KOTA <?PHP echo $edivisi; ?></u></h2></center>
