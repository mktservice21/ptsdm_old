...
?>
    <center><h2><u>LAPORAN DETAIL BIAYA RUTIN <?PHP echo $mydiv; ?></u></h2></center>
    ...
    <div id="kotakjudul">
        <div id="isikiri">
            <table class='tjudul' width='100%'>
                ...
                <?PHP
                if (!empty($pkodeperiode))
                    echo "<tr><td><b> </b></td><td></td><td>Periode $pkodeperiode</td></tr>";
                ?>
        ...
        <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
            ...
            <tbody>
                <?PHP
                    ...
                    $total=0;
                    $query = "select * from $tmp01 order by kodeperiode, nama_cabang, nama, idrutin, nobrid";
