<?PHP
    ...
    $_SESSION['FINRUTTIPE']="";
    $_SESSION['FINRUTTGLTIPE']=$_POST['utgltipe'];
    $_SESSION['FINRUTPERENTY1']=$_POST['uperiode1'];
    $_SESSION['FINRUTPERENTY2']=$_POST['uperiode2'];
    $_SESSION['FINRUTDIV']=$_POST['udivisi'];
    $_SESSION['FINRUTCAB']=$_POST['uarea'];
...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#datatablerut').DataTable( {
            ...
            "ajax":{
                url :"module/mod_br_brrutin/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&utgltipe="+etgltipe+"&uperiode1="+etgl1+"&uperiode2="+etgl2+"&udivisi="+edivisi+"&ufilcoa="+efilcoa+"&uidi="+eidi+"&uarea="+earea, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_br_brrutin/aksi_brrutin.php?module="+module+"&act=hapus&idmenu="+idmenu+"&kethapus="+txt+"&ket="+ket+"&id="+noid;
