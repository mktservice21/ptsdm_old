        ...
        <div class='x_content form-horizontal form-label-left'>
            <div class='tbldata'>
                <table id='datatable' class='datatable table nowrap table-striped table-bordered' width="100%">
                    ...
                    <?PHP
                    $no=1;
                    $tampil = mysqli_query($cnit, "SELECT nobrid, nama, jumlah, qty FROM dbmaster.t_brid where kode=3 and aktif='Y' order by nobrid");
                    while ($uc=mysqli_fetch_array($tampil)){
                        ...
                        if ($_GET['act']=="editdata"){
                            $cari = mysqli_query($cnit, "SELECT * FROM dbmaster.v_ca1 where idca='$_GET[id]' and nobrid='$uc[nobrid]'");
