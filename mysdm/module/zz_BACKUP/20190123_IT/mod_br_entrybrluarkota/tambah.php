...
if (isset($_GET['ca'])) {
    ...
    $edit = mysqli_query($cnit, "SELECT * FROM dbmaster.v_ca0 WHERE idca='$_GET[ca]'");
    ...
    $rutin_jumlahrp = getfieldit("select sum(jumlah) as lcfields from dbmaster.t_brrutin0 WHERE idca='$_GET[ca]' AND stsnonaktif <> 'Y'");
    $sewa_jumlahrp = getfieldit("select sum(jumlah) as lcfields from dbmaster.t_sewa WHERE idca='$_GET[ca]' AND stsnonaktif <> 'Y'");
    ...
    $nopol = getfieldit("select nopol as lcfields from dbmaster.t_kendaraan_pemakai where karyawanid='$idajukan' and stsnonaktif <> 'Y'");
    ...
    if ($_GET['act']=="editdata"){
        ...
        $edit = mysqli_query($cnit, "SELECT * FROM dbmaster.v_brrutin0 WHERE kode=2 AND idrutin='$_GET[id]' $filygmengajukan");
        $r    = mysqli_fetch_array($edit);
        $idklaim=$r['idrutin'];
        ...
        if (!empty($idca)) {
            ...
            $rutin_jumlahrp = getfieldit("select sum(jumlah) as lcfields from dbmaster.t_brrutin0 WHERE idrutin <>'$idklaim' AND idca='$idca' AND stsnonaktif <> 'Y'");
                    ...
                    <div class='x_panel'>
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div hidden class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control input-sm' id='e_idca' name='e_idca' onchange="">
                                            <?PHP
                                                $query = "select * from dbmaster.t_ca0 WHERE karyawanid='zz' AND jenis_ca='lk' AND karyawanid='$idajukan' and stsnonaktif<>'Y' ";
                                                ...
                                                if (!empty($idca)) {
                                                    $ca_jumlahrp = getfieldit("select sum(jumlah) as lcfields from dbmaster.t_ca0 WHERE idca='$idca' AND stsnonaktif <> 'Y'");
                                                    $rutin_jumlahrp = getfieldit("select sum(jumlah) as lcfields from dbmaster.t_brrutin0 WHERE idca='$idca' AND stsnonaktif <> 'Y' AND kode=1 AND idrutin <> '$idklaim'");
                                ...
                                <div class='form-group' <?PHP echo $stykry2; ?> id='divkry2'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for='e_idkaryawan'>Yang Membuat <span class='required'></span></label>
                                    <div class='col-xs-9'>
                                        ...
                                        <select class='form-control input-sm' id='e_idkaryawan_ca' name='e_idkaryawan_ca' onchange="refresh_ca()">
                                            ...
                                            if (!empty($idca)) {
                                                $query = "select divisi, tgl, karyawanid karyawanId, nama, idca, jumlah, periode, areaid 
                                                    from dbmaster.v_ca0 where karyawanid='zz' AND  idca='$idca' $filterdivisica ";
                                            }else{
                                                $query = "select divisi, tgl, karyawanid karyawanId, nama, idca, jumlah, periode, areaid 
                                                    from dbmaster.v_ca0 where karyawanid='zz' AND  stsnonaktif <> 'Y' 
                                                    $filterdivisica ";
                                            ...
                                            while($a=mysqli_fetch_array($tampil)){
                                                ...
                                                $rutin_jumlahrp = getfieldit("select sum(jumlah) as lcfields from dbmaster.t_brrutin0 WHERE idca='$gid' AND stsnonaktif <> 'Y' $filrt");
                                                $sewa_jumlahrp = getfieldit("select sum(jumlah) as lcfields from dbmaster.t_sewa WHERE idca='$gid' AND stsnonaktif <> 'Y'");
                                                if (empty($rutin_jumlahrp)) $rutin_jumlahrp = 0;
                                                if (empty($sewa_jumlahrp)) $sewa_jumlahrp = 0;
                                                $saldoca = (double)$ca_jumlahrp-(double)$rutin_jumlahrp-(double)$sewa_jumlahrp;
                                                if ((double)$saldoca>0) {
                                ...
                                <div hidden>
                                    ...
                                    <div class='col-xs-5'>
                                        ...
                                        <?PHP
                                        if (($_GET['act']=="editdata") OR isset($_GET['ca'])){
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_nopol' name='e_nopol'>
                                            <?PHP
                                            if ($_GET['act']=="editdata"){
                                                $query = "select * from dbmaster.t_kendaraan where nopol in (SELECT DISTINCT nopol from dbmaster.t_kendaraan_pemakai WHERE karyawanid='$idajukan')";
                                ...
                                <div class='form-group' <?PHP echo $stykry2; ?> id='divketca'>
