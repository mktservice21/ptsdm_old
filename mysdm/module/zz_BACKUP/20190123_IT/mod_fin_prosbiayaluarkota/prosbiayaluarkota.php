<?PHP
    ...
    $aksi="module/mod_fin_prosbiayaluarkota/aksi_prosbiayaluarkota.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['PROSBLK_TGL1'])) $tgl_pertama = $_SESSION['PROSBLK_TGL1'];
    if (!empty($_SESSION['PROSBLK_TGL2'])) $tgl_akhir = $_SESSION['PROSBLK_TGL2'];
    if (!empty($_SESSION['PROSBLK_STSAPV'])) $stsapv = $_SESSION['PROSBLK_STSAPV'];
    if (!empty($_SESSION['PROSBLK_KET'])) $apvpilih = $_SESSION['PROSBLK_KET'];
    if (!empty($_SESSION['PROSBLK_DIV'])) $pildivisi = $_SESSION['PROSBLK_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_fin_prosbiayaluarkota/viewdatatable.php?module="+module+"&idmenu="+idmenu,
            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <div class="well" style="overflow: auto; margin-top: -5px; margin-bottom: 5px; padding-top: 10px; padding-bottom: 6px;">
                        ...
                        <input onclick="pilihData('belumapvsm')" class='btn btn-default btn-sm' type='button' name='buttonview5' value='Belum Approve SM'>
                    </div>
                    ...
                    <div class='col-sm-2'>
                        ...
                        <div class="form-group">
                            <select class='form-control input-sm' id="cb_tipeisi" name="cb_tipeisi">
                                ...
                                <?PHP
                                $sa=""; $sb=""; $sc="";
                                if ($_SESSION['PROSBLK_TIPE']=="A") $sa=" selected";
                                if ($_SESSION['PROSBLK_TIPE']=="B") $sb=" selected";
                                if ($_SESSION['PROSBLK_TIPE']=="C") $sc=" selected";
                                ?>
