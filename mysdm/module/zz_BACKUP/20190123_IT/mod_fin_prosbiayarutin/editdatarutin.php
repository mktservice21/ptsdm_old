    ...
    <body>
        <div id="div1">
            ...
            <table id='example_2' class='table table-striped table-bordered example_2' width="100%" border="1px">
                ...
                $no=1;
                $nurut=1;
                $tampil = mysqli_query($cnit, "SELECT nobrid, nama, jumlah, qty FROM dbmaster.t_brid where kode=$kodepilih and aktif='Y' order by nobrid");
                while ($uc=mysqli_fetch_array($tampil)){
                    ...
                    if ($_GET["brid"]=="BRT0000036" OR $_GET["brid"]=="BRT0000489")
                        $cari = mysqli_query($cnit, "SELECT * FROM dbmaster.t_brrutin1 where idrutin='$_GET[brid]' and nobrid=$uc[nobrid]");
                    else
                        $cari = mysqli_query($cnit, "SELECT * FROM dbmaster.t_brrutin1 where idrutin='$_GET[brid]' and nobrid='$uc[nobrid]'");
