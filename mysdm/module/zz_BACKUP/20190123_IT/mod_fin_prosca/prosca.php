<?PHP
    ...
    $aksi="module/mod_fin_prosca/aksi_prosca.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['PROSCAISI_TGL1'])) $tgl_pertama = $_SESSION['PROSCAISI_TGL1'];
    if (!empty($_SESSION['PROSCAISI_TGL2'])) $tgl_akhir = $_SESSION['PROSCAISI_TGL2'];
    if (!empty($_SESSION['PROSCAISI_STSAPV'])) $stsapv = $_SESSION['PROSCAISI_STSAPV'];
    if (!empty($_SESSION['PROSCAISI_KET'])) $apvpilih = $_SESSION['PROSCAISI_KET'];
    if (!empty($_SESSION['PROSCAISI_DIV'])) $pildivisi = $_SESSION['PROSCAISI_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_fin_prosca/viewdatatable.php?module="+module+"&idmenu="+idmenu,
                    ...
                    <div class='col-sm-2'>
                        ...
                        <div class="form-group">
                            <select class='form-control input-sm' id="cb_tipeisi" name="cb_tipeisi">
                                ...
                                <?PHP
                                $sa=""; $sb=""; $sc="";
                                if ($_SESSION['PROSCAISI_TIPE']=="A") $sa=" selected";
                                if ($_SESSION['PROSCAISI_TIPE']=="B") $sb=" selected";
                                if ($_SESSION['PROSCAISI_TIPE']=="C") $sc=" selected";
                                ?>
