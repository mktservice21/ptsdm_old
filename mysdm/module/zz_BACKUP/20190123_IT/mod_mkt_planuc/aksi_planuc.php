...
if ($module=='mktplanuc' AND $act=='input') {
    ...
    while (strtotime($tgl1) <= strtotime($tgl2)) {
        ...
        if (isset($_POST[$ketfld])) {
            ...
            mysqli_query($cnit, "delete from $dbname.t_planuc_mkt where karyawanid='$idkaryawan' and tgl='$tgl1'");
            
            if (!empty($keterangan)) {
                mysqli_query($cnit, "insert into $dbname.t_planuc_mkt (karyawanid, tgl, keterangan, userid, atasan1, atasan2, atasan3) values"
