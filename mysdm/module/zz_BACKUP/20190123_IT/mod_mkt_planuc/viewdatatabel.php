<?PHP
    ...
    $pjabatanid = getfieldcnit("select jabatanId as lcfields from hrd.karyawan where karyawanId='$idkar'");
...
<script>
    ...
    function ShowAtasanDM(idkar) {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_mkt_planuc/viewdata.php?module=viewdataatasandm",
            data:"umr="+icar,
    ...
    function ShowAtasanSM(idkar) {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_mkt_planuc/viewdata.php?module=viewdataatasansm",
            data:"umr="+icar,
            success:function(data){
                $("#e_atasan3").html(data);
            }
