<?php
    ...
    $_SESSION['APVCASEWA_KET'] = $cket;
    $_SESSION['APVCASEWA_TGL1'] = $mytgl1;
    $_SESSION['APVCASEWA_TGL2'] = $mytgl2;
    $_SESSION['APVCASEWA_KRY'] = $karyawan;
    $_SESSION['APVCASEWA_LVL'] = $lvlposisi;
    $_SESSION['APVCASEWA_DIV'] = $divisi;
    $_SESSION['APVCASEWA_STSAPV'] = $stsapv;
    ...
    <div class='x_content' style="margin-left:-20px; margin-right:-20px;">
        ...
        <table id='datatableapvcaisi' class='table table-striped table-bordered' width='100%'>
            ...
            <tbody>
                ...
                $sql.=" $filterregion order by idsewa";
                //echo $sql;
                $no=1;
...
<script>
    ...
    function ProsesData(ket, cekbr){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_sewa/aksi_apvsewa.php?module="+module+"&idmenu="+idmenu+"&act="+ket,
