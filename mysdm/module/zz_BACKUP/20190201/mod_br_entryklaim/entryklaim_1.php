...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Isi Klaim Diskon</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
            ...
            default:
                ...
                <script type="text/javascript" language="javascript" >
                    $(document).ready(function() {
                        ...
                        var aksi = "module/mod_br_entryklaim/aksi_entryklaim.php";
                        ...
                        var dataTable = $('#datatable').DataTable( {
                            ...
                            "ajax":{
                                url :"module/mod_br_entryklaim/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi, // json datasource
                            ...
                            <table id='datatable' class='table table-striped table-bordered' width='100%'>
                                <thead>
                                    <tr>
                                        ...
                                        <th width='60px'>Tanggal</th><th>Yg Membuat</th>
                                        <th width='80px'>Distributor</th><th width='50px'>Jumlah</th>
                                        <th width='50px'>Realisasi</th><th width='50px'>No Slip</th><th width='60px'>Tgl. Transfer</th>
