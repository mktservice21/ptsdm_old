<?PHP
    ...
    if (!empty($_SESSION['SWKRENTY1'])) $tgl_pertama = $_SESSION['SWKRENTY1'];
    if (!empty($_SESSION['SWKRENTY2'])) $tgl_akhir = $_SESSION['SWKRENTY2'];
...
<div class="">
    ...
    <div class="page-title"><div class="title_left">
            <h3>
                <?PHP
                $judul="Sewa Kontrakan Rumah";
                if ($_GET['act']=="tambahbaru")
                    echo "Input $judul";
                elseif ($_GET['act']=="editdata")
                    echo "Edit $judul";
                elseif ($_GET['act']=="uploaddok")
                    echo "Upload Dokumen $judul";
                else
                    echo "Data $judul";
                ?>
            </h3>
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_entrysewa/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrysewa/viewdatatabel.php?module="+ket,
                    ...
                    function ProsesData(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("demo-form2").action = "module/mod_br_entrysewa/aksi_entrysewa.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+txt+"&ket="+ket+"&id="+noid;
                                document.getElementById("demo-form2").submit();
                                return 1;
                            }
                        } else {
                            ...
                            <div hidden>
                                ...
                                <div class="form-group">
                                    <select class='form-control input-sm' id="cb_tgltipe" name="cb_tgltipe">
                                        <?PHP
                                        $sa=""; $sb=""; $sc=""; $sd="";
                                        if ($_SESSION['SWKRTGLTIPE']=="1") $sa=" selected";
                                        if ($_SESSION['SWKRTGLTIPE']=="2") $sb=" selected";
                                        if ($_SESSION['SWKRTGLTIPE']=="3") $sc=" selected";
                                        if ($_SESSION['SWKRTGLTIPE']=="4") $sd=" selected";
                                        if (empty($_SESSION['SWKRTGLTIPE'])) $sb="selected"
                                        ?>
                            ...
                            <div hidden><!--class='col-sm-2'-->
                                ...
                                <div class="form-group">
                                    <select class='form-control input-sm' id='e_idarea' name='e_idarea'>
                                      ...
                                      <?PHP
                                        include "config/koneksimysqli.php";
                                        $query = "select cabang.iCabangId, cabang.nama from MKT.icabang as cabang  order by nama"; 
