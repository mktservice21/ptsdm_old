<?PHP
    ...
    $aksi="module/mod_fin_prosbiayarutin/aksi_prosbiayarutin.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['PROSRUT_TGL1'])) $tgl_pertama = $_SESSION['PROSRUT_TGL1'];
    if (!empty($_SESSION['PROSRUT_TGL2'])) $tgl_akhir = $_SESSION['PROSRUT_TGL2'];
    if (!empty($_SESSION['PROSRUT_STSAPV'])) $stsapv = $_SESSION['PROSRUT_STSAPV'];
    if (!empty($_SESSION['PROSRUT_KET'])) $apvpilih = $_SESSION['PROSRUT_KET'];
    if (!empty($_SESSION['PROSRUT_DIV'])) $pildivisi = $_SESSION['PROSRUT_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_fin_prosbiayarutin/viewdatatable.php?module="+module+"&idmenu="+idmenu,
                    ...
                    <div class='col-sm-2'>
                        ...
                        <div class="form-group">
                            <select class='form-control input-sm' id="cb_tipeisi" name="cb_tipeisi">
                                ...
                                <?PHP
                                $sa=""; $sb=""; $sc="";
                                if ($_SESSION['PROSRUT_TIPE']=="A") $sa=" selected";
                                if ($_SESSION['PROSRUT_TIPE']=="B") $sb=" selected";
                                if ($_SESSION['PROSRUT_TIPE']=="C") $sc=" selected";
                                ?>
