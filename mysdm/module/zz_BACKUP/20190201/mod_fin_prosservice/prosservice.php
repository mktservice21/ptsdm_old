<?PHP
    $aksi="module/mod_fin_prosservice/aksi_prosservice.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['PROSCASERVICE_TGL1'])) $tgl_pertama = $_SESSION['PROSCASERVICE_TGL1'];
    if (!empty($_SESSION['PROSCASERVICE_TGL2'])) $tgl_akhir = $_SESSION['PROSCASERVICE_TGL2'];
    if (!empty($_SESSION['PROSCASERVICE_STSAPV'])) $stsapv = $_SESSION['PROSCASERVICE_STSAPV'];
    if (!empty($_SESSION['PROSCASERVICE_KET'])) $apvpilih = $_SESSION['PROSCASERVICE_KET'];
    if (!empty($_SESSION['PROSCASERVICE_DIV'])) $pildivisi = $_SESSION['PROSCASERVICE_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_fin_prosservice/viewdatatable.php?module="+ket,
                    ...
                    <div class='col-sm-2'>
                        ...
                        <div class="form-group">
                            <select class='form-control input-sm' id="cb_tipeisi" name="cb_tipeisi">
                                ...
                                <?PHP
                                $sa=""; $sb=""; $sc="";
                                if ($_SESSION['PROSCASERVICE_TIPE']=="A") $sa=" selected";
                                if ($_SESSION['PROSCASERVICE_TIPE']=="B") $sb=" selected";
                                if ($_SESSION['PROSCASERVICE_TIPE']=="C") $sc=" selected";
                                ?>
