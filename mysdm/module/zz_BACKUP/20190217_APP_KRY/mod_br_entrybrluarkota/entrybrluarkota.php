<?PHP
    ...
    if (!empty($_SESSION['FINLURPERENTY1'])) $tgl_pertama = $_SESSION['FINLURPERENTY1'];
    if (!empty($_SESSION['FINLURPERENTY2'])) $tgl_akhir = $_SESSION['FINLURPERENTY2'];
...
<div class="">
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_entrybrluarkota/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrybrluarkota/viewdatatabel.php?module="+ket,
                    ...
                    function ProsesData(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("demo-form2").action = "module/mod_br_entrybrluarkota/aksi_entrybrluarkota.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+txt+"&ket="+ket+"&id="+noid;
                                document.getElementById("demo-form2").submit();
                                return 1;
                            }
                        } else {
                ...
                <div class='col-md-12 col-sm-12 col-xs-12'>
                    <div class='x_panel'>
                        ...
                        <div class='x_title'>
							...
							<div style="color:red;"><b>*) Bukti harus diupload</b></div>
                        </div>
                            ...
                            <div hidden>
                                ...
                                <div class="form-group">
                                    <select class='form-control input-sm' id="cb_tgltipe" name="cb_tgltipe">
                                        <?PHP
                                        $sa=""; $sb=""; $sc=""; $sd="";
                                        if ($_SESSION['FINLURTGLTIPE']=="1") $sa=" selected";
                                        if ($_SESSION['FINLURTGLTIPE']=="2") $sb=" selected";
                                        if ($_SESSION['FINLURTGLTIPE']=="3") $sc=" selected";
                                        if ($_SESSION['FINLURTGLTIPE']=="4") $sd=" selected";
                                        if (empty($_SESSION['FINLURTGLTIPE'])) $sb="selected"
                                        ?>
