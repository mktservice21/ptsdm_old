<?PHP
    ...
    if (!empty($_SESSION['APVBLK_TGL1'])) $tgl_pertama = $_SESSION['APVBLK_TGL1'];
    if (!empty($_SESSION['APVBLK_TGL2'])) $tgl_akhir = $_SESSION['APVBLK_TGL2'];
    if (!empty($_SESSION['APVBLK_STSAPV'])) $stsapv = $_SESSION['APVBLK_STSAPV'];
    if (!empty($_SESSION['APVBLK_KET'])) $apvpilih = $_SESSION['APVBLK_KET'];
    if (!empty($_SESSION['APVBLK_DIV'])) $pildivisi = $_SESSION['APVBLK_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_biayaluarkota/viewdatatable.php?module="+ket,
