<?PHP
    ...
    if ($ketemucls>0){
        ...
        $query = "select tgltrans from dbmaster.t_brrutin0 where 
            idrutin in (select distinct IFNULL(idrutin,'') from dbmaster.tmp_lk_closing) AND 
    ...
    $query = "select distinct karyawanid, totalrutin, ca1, ca2 from dbmaster.tmp_lk_closing "
    ...
    if ($records) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $query = "select * from dbmaster.tmp_lk_closing where "
    ...
    <div class='x_content'>
        <div class='col-md-12 col-sm-12 col-xs-12'>
            ...
            <div class='form-group'>
                ...
                <div class='col-xs-9'>
                    <div class="checkbox">
                        <button type='button' class='btn btn-success' onclick='disp_confirm("Simpan ?", "<?PHP echo ""; ?>")'>Save</button>
                    </div>
                </div>
            </div>
