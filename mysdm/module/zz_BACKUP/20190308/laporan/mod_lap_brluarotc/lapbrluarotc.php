...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Biaya Luar Kota OTC</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="e_karyawan" name="e_karyawan">
                                            <?PHP
                                            PilihKaryawanAktif("", "(All)", $idajukan, "Y", $_SESSION['STSADMIN'], $fildiv, $_SESSION['LVLPOSISI'], $tampilbawahan, $_SESSION['IDCARD'], $jabatan_, $_SESSION['AKSES_REGION'], $filkaryawncabang, "", $hanyasatukaryawan);
                                            ?>
                                        </select>
                                    </div>
                                </div>
