<?php
    ...
    $_SESSION['APVCASERVICE_KET'] = $cket;
    $_SESSION['APVCASERVICE_TGL1'] = $mytgl1;
    $_SESSION['APVCASERVICE_TGL2'] = $mytgl2;
    $_SESSION['APVCASERVICE_KRY'] = $karyawan;
    $_SESSION['APVCASERVICE_LVL'] = $lvlposisi;
    $_SESSION['APVCASERVICE_DIV'] = $divisi;
    $_SESSION['APVCASERVICE_STSAPV'] = $stsapv;
    ...
    <div class='x_content' style="margin-left:-20px; margin-right:-20px;">
            ...
            <div class="title_left">
                <h4 style="font-size : 12px;">
                    <?PHP
                        ...
                        echo "<b>$text $apvby</b>"
                                . "<br/>*) klik nama untuk melihat detail pengajuan";
                    ?>
                </h4>
        ...
        <table id='datatableapvcaisi' class='table table-striped table-bordered' width='100%'>
            ...
            <tbody>
                ...
                $sql.=" $filterregion order by idservice";
                //echo $sql;
                $no=1;
...
<script>
    ...
    function ProsesData(ket, cekbr){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_service/aksi_apvservice.php?module="+module+"&idmenu="+idmenu+"&act="+ket,
