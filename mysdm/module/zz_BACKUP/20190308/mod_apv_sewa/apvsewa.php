<?PHP
    ...
    $aksi="module/mod_apv_sewa/aksi_apvsewa.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['APVCASEWA_TGL1'])) $tgl_pertama = $_SESSION['APVCASEWA_TGL1'];
    if (!empty($_SESSION['APVCASEWA_TGL2'])) $tgl_akhir = $_SESSION['APVCASEWA_TGL2'];
    if (!empty($_SESSION['APVCASEWA_STSAPV'])) $stsapv = $_SESSION['APVCASEWA_STSAPV'];
    if (!empty($_SESSION['APVCASEWA_KET'])) $apvpilih = $_SESSION['APVCASEWA_KET'];
    if (!empty($_SESSION['APVCASEWA_DIV'])) $pildivisi = $_SESSION['APVCASEWA_DIV'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_sewa/viewdatatable.php?module="+ket,
