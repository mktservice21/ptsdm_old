...
if ($module=='closingbrlkca' AND $act=='input') {
    if (!empty($pnourt)) {
        ...
        //if ($psudahpernah!="SUDAH") {
            ...
            $query = "INSERT INTO dbmaster.t_brrutin_ca_close (tglinput, bulan, karyawanid, divisi, idrutin, idca1, idca2, credit, saldo, ca1, ca2, userid, sts)
                select CURRENT_DATE() tglinput, bulan, karyawanid, divisi, idrutin, idca1, idca2, jumlah, totalrutin, ca1, ca2, '$_SESSION[IDCARD]' userid, sts FROM 
