<?php
    ...
    if ($ketemu==0){
        ...
        $query = "select idca2 from dbmaster.t_brrutin_ca_close WHERE ifnull(idca2,'') <> '' AND DATE_FORMAT(bulan,'%Y-%m')='$periodesebelumnya'";
        ...
        if (isset($_GET['module'])) {
            if ($_GET['module']=="realisasibl") $hapustmp2=false;
        }
        ...
        $query = "select a.divisi, a.idrutin, a.karyawanid, b.nama as nama_karyawan, a.credit, 
            a.saldo, a.idca1, a.idca2, a.ca1, a.ca2, a.nourut, '' keterangan, a.sts, a.tgltrans, a.nobukti 
