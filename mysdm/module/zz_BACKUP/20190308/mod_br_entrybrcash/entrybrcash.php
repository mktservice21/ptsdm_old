<?PHP
    ...
    if (!empty($_SESSION['FINCAAPERENTY1'])) $tgl_pertama = $_SESSION['FINCAAPERENTY1'];
    if (!empty($_SESSION['FINCAAPERENTY2'])) $tgl_akhir = $_SESSION['FINCAAPERENTY2'];
...
<div class="">
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_entrybrcash/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entrybrcash/viewdatatabel.php?module="+ket,
                    ...
                    function ProsesData(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("demo-form2").action = "module/mod_br_entrybrcash/aksi_brrutin.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+txt+"&ket="+ket+"&id="+noid;
                                document.getElementById("demo-form2").submit();
                                return 1;
                            }
                        } else {
                            ...
                            <div hidden>
                                ...
                                <div class="form-group">
                                    <select class='form-control input-sm' id="cb_tgltipe" name="cb_tgltipe">
                                        <?PHP
                                        $sa=""; $sb=""; $sc=""; $sd="";
                                        if ($_SESSION['FINCAATGLTIPE']=="1") $sa=" selected";
                                        if ($_SESSION['FINCAATGLTIPE']=="2") $sb=" selected";
                                        if ($_SESSION['FINCAATGLTIPE']=="3") $sc=" selected";
                                        if ($_SESSION['FINCAATGLTIPE']=="4") $sd=" selected";
                                        if (empty($_SESSION['FINCAATGLTIPE'])) $sb="selected"
                                        ?>
