<?PHP
    ...
    if (!empty($_SESSION['SVCKENTY1'])) $tgl_pertama = $_SESSION['SVCKENTY1'];
    if (!empty($_SESSION['SVCKENTY2'])) $tgl_akhir = $_SESSION['SVCKENTY2'];
...
<div class="">
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_entryservice/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_entryservice/viewdatatabel.php?module="+ket,
                    ...
                    function ProsesData(ket, noid){
                        ...
                        if (ok_) {
                            ...
                            if (r==true) {
                                ...
                                document.getElementById("demo-form2").action = "module/mod_br_entryservice/aksi_entryservice.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+txt+"&ket="+ket+"&id="+noid;
                                document.getElementById("demo-form2").submit();
                                return 1;
                            }
                        } else {
                            ...
                            <div hidden>
                                ...
                                <div class="form-group">
                                    <select class='form-control input-sm' id="cb_tgltipe" name="cb_tgltipe">
                                        <?PHP
                                        $sa=""; $sb=""; $sc=""; $sd="";
                                        if ($_SESSION['SVCKTGLTIPE']=="1") $sa=" selected";
                                        if ($_SESSION['SVCKTGLTIPE']=="2") $sb=" selected";
                                        if ($_SESSION['SVCKTGLTIPE']=="3") $sc=" selected";
                                        if ($_SESSION['SVCKTGLTIPE']=="4") $sd=" selected";
                                        if (empty($_SESSION['SVCKTGLTIPE'])) $sb="selected"
                                        ?>
