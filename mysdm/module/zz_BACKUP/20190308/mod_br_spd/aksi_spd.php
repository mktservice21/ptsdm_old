...
elseif ($module=='saldosuratdana')
{
    ...
    $pcoa="101-02-002";
    if ($act=="input") {
        $query = "INSERT INTO $dbname.t_suratdana_br (idinput, divisi, kodeid, subkode, nomor, tgl, nodivisi, jumlah, userid, coa4, lampiran, tglf, tglt)values"
                . "('$kodenya', '$pdivisi', '$pkode', '$psubkode', '$pnomor', '$periode1', '$pdivno', '$pjumlah', '$_SESSION[IDCARD]', '$pcoa', '$pjenis', '$periodef', '$periodet')";
    }else{
