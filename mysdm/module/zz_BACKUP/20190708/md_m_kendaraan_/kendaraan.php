                            ...
                            <form method='POST' action='' id='d-form2' name='form2'>
                                    ...
                                    <table id='datatablemskenpmk' class='table table-striped table-bordered'>
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT a.*, b.nama from dbmaster.t_kendaraan_pemakai as a LEFT JOIN hrd.karyawan b "
                                                    . " ON a.karyawanid=b.karyawanId WHERE a.nopol='$_GET[id]'";
                                ...
                                ?>
                                    ...
                                    <table id='datatablemsken' class='table table-striped table-bordered'>
                                        <thead>
                                            <tr>
                                                <th width='10px'>No</th><th width='90px'>Aksi</th>
                                                <th width='60px'>PLAT NOMOR</th>
                                                <th width='40px'>JENIS</th><th width='80px'>MERK</th>
                                                <th width='100px'>TIPE</th><th width='50px'>TAHUN</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            while ($r= mysqli_fetch_array($tampil)) {
                                                ...
                                                echo "<tr>";
                                                echo "<td>$no</td>";
                                                echo "<td>$edit $hapus $lihatpemakai</td>";
                                                echo "<td>$nopol</td>";
                                                echo "<td>$nmjenis</td>";
                                                echo "<td>$merk</td>";
                                                echo "<td>$tipe</td>";
