<?php
    $kodepilih="1";
    if ($_GET['module']=="entrybrcash" OR $_GET['module']=="entrybrcashotc") $kodepilih="3";
    ...
    <body>
        <div id="div1">
            <?PHP
                ...
                if ($pdivisi=="OTC" AND $_GET['module']=="entrybrcash") {
                    $gambar="";
                    $gbr1="";
                    $gbr2="";
                    $gbr3="";
                ...
                if ($pdivisi=="OTC" AND $_GET['module']=="entrybrcashotc") {
