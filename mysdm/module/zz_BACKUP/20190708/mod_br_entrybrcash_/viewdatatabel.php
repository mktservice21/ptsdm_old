<?PHP
    ...
    $_SESSION['FINCAATIPE']="";
    $_SESSION['FINCAATGLTIPE']=$_POST['utgltipe'];
    $_SESSION['FINCAAPERENTY1']=$_POST['uperiode1'];
    $_SESSION['FINCAAPERENTY2']=$_POST['uperiode2'];
    $_SESSION['FINCAADIV']=$_POST['udivisi'];
    $_SESSION['FINCAACAB']=$_POST['uarea'];
...
<script>
    $(document).ready(function() {
        var aksi = "module/mod_br_entrybrcash/aksi_entrybrcash.php";
        ...
        //alert(etgl1);
        var dataTable = $('#datatableca').DataTable( {
            "processing": true,
            "serverSide": true,
            "stateSave": true,
            "order": [[ 0, "desc" ]],
            ...
            "ajax":{
                url :"module/mod_br_entrybrcash/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+aksi+"&utgltipe="+etgltipe+"&uperiode1="+etgl1+"&uperiode2="+etgl2+"&udivisi="+edivisi+"&ufilcoa="+efilcoa+"&uidi="+eidi+"&uarea="+earea, // json datasource
...
<form method='POST' action='<?PHP echo "?module='entrybrcash'&act=input&idmenu=122"; ?>' id='d-form2' name='form2' data-parsley-validate class='form-horizontal form-label-left'>
    ...
    <div class='x_content'>
        <table id='datatableca' class='table table-striped table-bordered' width='100%'>
            <thead>
                <tr>
                    <th width='7px'>No</th>
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_br_entrybrcash/aksi_entrybrcash.php?module="+module+"&act=hapus&idmenu="+idmenu+"&kethapus="+txt+"&ket="+ket+"&id="+noid;
