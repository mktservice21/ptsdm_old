...
<?php
    ...
    $kodeit = " and kode in (select kodeid from dbmaster.br_kode where (br <> '') and (br<>'N')) ";
   //FORMAT(realisasi1,2,'de_DE') as  
    $sql = "select divprodid, region, icabangid, nama_cabang, kode, nama_kode, sum(jumlah) as jumlah "
            . " from dbmaster.v_br0_all where "
            . " DATE_FORMAT(tgltrans,'%Y-%m-%d') between '$periode01' and '$periode02' and retur<>'Y' and aktif_area='Y' "
