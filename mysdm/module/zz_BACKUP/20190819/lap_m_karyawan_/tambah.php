...
if ($_GET['act']=="editdata"){
    ...
    $edit = mysqli_query($cnit, "SELECT * FROM dbmaster.t_karyawan_posisi WHERE karyawanId='$_GET[id]'");
    $ketemu = mysqli_num_rows($edit);
    if ($ketemu==0) {
        $darikaryawan = "Y";
        $edit = mysqli_query($cnit, "SELECT * FROM hrd.karyawan WHERE karyawanId='$_GET[id]'");
    }
    $r    = mysqli_fetch_array($edit);
    $idnya = $r['karyawanId'];
    $namakaryawan = getfieldit("select nama as lcfields from hrd.karyawan where karyawanId='$idnya'");
    $divisi = $r['divisiId'];
    ...
    $hanyadmin = trim(getfieldit("select karyawanId as lcfields from dbmaster.t_karyawanadmin where karyawanId='$idnya'"));
                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_jabatan' name='e_jabatan' onchange="showDataKaryawan('tambahbaru', 'e_idkaryawan')">
                                            <?PHP
                                            $sql=mysqli_query($cnit, "SELECT jabatanId, nama FROM hrd.jabatan order by jabatanId");
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_spv' name='e_spv' onchange="">
                                            <?PHP
                                            $query ="select karyawanid, nama from hrd.karyawan where jabatanid in ('10', '18') AND (aktif='Y' OR karyawanid='$atasanidspv') ORDER BY nama";
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_dm' name='e_dm' onchange="">
                                            ...
                                            ?>
                                            <?PHP
                                            $query ="select karyawanid, nama from hrd.karyawan where jabatanid in ('08') AND (aktif='Y' OR karyawanid='$atasaniddm') ORDER BY nama";
                                            $sql=mysqli_query($cnmy, $query);
                                            echo "<option value=''>-- Pilihan --</option>";
                                            while ($Xt=mysqli_fetch_array($sql)){
                                                $xid=$Xt['karyawanid'];
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_sm' name='e_sm' onchange="">
                                            ...
                                            ?>
                                            <?PHP
                                            $query ="select karyawanid, nama from hrd.karyawan where jabatanid in ('20') AND (aktif='Y' OR karyawanid='$atasanidsm') ORDER BY nama";
                                            $sql=mysqli_query($cnmy, $query);
                                            echo "<option value=''>-- Pilihan --</option>";
                                            while ($Xt=mysqli_fetch_array($sql)){
                                                $xid=$Xt['karyawanid'];
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_gsm' name='e_gsm' onchange="">
                                            ...
                                            ?>
                                            <?PHP
                                            $query ="select karyawanid, nama from hrd.karyawan where jabatanid in ('05') AND (aktif='Y' OR karyawanid='$atasanidgsm') ORDER BY nama";
                                            $sql=mysqli_query($cnmy, $query);
                                            echo "<option value=''>-- Pilihan --</option>";
                                            while ($Xt=mysqli_fetch_array($sql)){
                                                $xid=$Xt['karyawanid'];
                                ...
                                <div <?PHP echo $khusushidden; ?> class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        ...
                                        <?PHP
                                        if ($divisi=="OTC") {
                                            $sql=mysqli_query($cnit, "select a.icabangid_o cabangid, a.areaid_o areaid, a.nama nama_area, c.nama nama_cabang from MKT.iarea_o a 
                                                JOIN MKT.icabang_o c on a.icabangid_o=c.icabangid_o
                                                WHERE a.aktif='Y' and c.aktif='Y' order by c.nama, a.nama");
                                        }else{
                                            $sql=mysqli_query($cnit, "SELECT a.iCabangId cabangid, a.areaId areaid, a.Nama nama_area, 
                                ...
                                <div <?PHP echo $khusushiddenadmotc; ?> class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_bank' name='e_bank'>
                                            <?PHP
                                            $sql=mysqli_query($cnit, "SELECT bankid, nama FROM hrd.br_bank order by bankid");
                                            $ketemu= mysqli_num_rows($sql);
                                            echo "<option value=''>-- Pilihan --</option>";
                                            while ($Xt=mysqli_fetch_array($sql)){
                                                if ($Xt['bankid']==$bank)
