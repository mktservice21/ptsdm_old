...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Laporan Biaya Rutin</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                    ...
                    <div class='col-md-6 col-xs-12'>
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='form-control' id="divprodid" name="divprodid">
                                            ...
                                            while ($z= mysqli_fetch_array($tampil)) {
                                                ...
                                                echo "<option value='$z[DivProdId]'>$namadiv</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Periode Pengajuan <span class='required'></span></label>
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <select class='form-control' id="t_kodeperiode" name="t_kodeperiode">
                                            ...
                                            <div hidden class='input-group date' id='cbln02'>
                                ...
                                <div class='form-group'>
                                    <label class='control-label col-md-3 col-sm-3 col-xs-12' for=''>Status Approve <span class='required'></span></label>
                                    <div class='col-xs-9'>
