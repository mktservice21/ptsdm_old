...
if ($_GET['module']=="hitungtotalcekbox") {
    ...
    $query = "UPDATE dbmaster.t_spg_gaji_br0 set insentif_tambahan=0, periode_insentif=NULL, apv1=NULL, apvtgl1=NULL, tglpengajuan=NULL, total=NULL, sts='' WHERE "
    ...
    $query = "UPDATE dbmaster.t_spg_gaji_br0 set periode_insentif='$pperiodeinct', sts='$ptipests', tglpengajuan='$ptglpengajuan' WHERE "
