            ...
            <div class="title_left">
                <h4 style="font-size : 12px;">
                    <?PHP
                        ...
                        echo "<b>$text</b>";
                    ?>
                    <br/><br/><br/><b><span style="color:red;">Jumlah Hari Kerja Bulan <?PHP echo "$mybulan : $jmlkerja"; ?> Hari</span></b>
                </h4>
            </div>
        ...
        <table id='dtabelspgpros' class='table table-striped table-bordered' width='100%'>
            ...
            <tbody>
                ...
                while( $sp=mysqli_fetch_array($query) ) {
                    ...
                    $fininc_booster="<input type='text' size='8px' id='txtincbot[]' name='txtincbot[]' class='input-sm inputmaskrp2' autocomplete='off' value='$pinsentif_tambahan'>";
