<?php
    ...
    if ($ketemu==0){
        ...
        $query = "select DISTINCT idrutin, 'LK1' ket, sts from dbmaster.t_brrutin_ca_close WHERE ifnull(idrutin,'') <> '' AND DATE_FORMAT(bulan,'%Y-%m')='$periode1' $filterstsclose $filterdivisi";
        $query .= " UNION select idca1, 'CA1' ket, sts from dbmaster.t_brrutin_ca_close WHERE ifnull(idca1,'') <> '' AND DATE_FORMAT(bulan,'%Y-%m')='$periode1' $filterstsclose $filterdivisi";
        $query .= " UNION select idca2, 'CA2' ket, sts from dbmaster.t_brrutin_ca_close WHERE ifnull(idca2,'') <> '' AND DATE_FORMAT(bulan,'%Y-%m')='$periode1' $filterstsclose $filterdivisi";
        ...
        if (isset($_GET['module'])) {
            if ($_GET['module']=="realisasibl" OR $_GET['module']=="glrekapbrluarkota") $hapustmp2=false;
        }
        ...
        $query = "select a.divisi, a.idrutin, a.karyawanid, b.nama as nama_karyawan, a.credit, 
            a.saldo, a.idca1, a.idca2, a.ca1, a.ca2, a.nourut, '' keterangan, a.sts, a.tgltrans, a.nobukti, a.idinput  
        ...
        if (isset($_GET['module'])) {
            if ($_GET['module']=="realisasibl" OR $_GET['module']=="glrekapbrluarkota") {
