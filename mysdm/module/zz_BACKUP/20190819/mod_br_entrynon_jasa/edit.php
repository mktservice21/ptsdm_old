                            ...
                            <div class='x_content form-horizontal form-label-left'>
                                ...
                                <div id="n_pajak1">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-6 col-sm-6 col-xs-12'>
                                            <input type="checkbox" value="jasa" id="chk_jasa" name="chk_jasa" onclick="ShowInputJasa()" <?PHP echo $pchkjasa; ?>> DPP Dari Jasa
                                        </div>
                                    </div>
                                    ...
                                    <div id="n_pajakjasa">
                                        ...
                                        <div class='form-group'>
                                            <label class='control-label col-md-3 col-sm-3 col-xs-12' for='' style="color:blue;"><u>Jumlah Jasa (Rp.)</u> <span class='required'></span></label>
                                            <div class='col-md-6 col-sm-6 col-xs-12'>
                                        ...
                                        <div class='col-xs-9'>
                                            <div style="margin-bottom:2px;">
                                                <select class='soflow' name='cb_pph' id='cb_pph' onchange="ShowPPH()">
                                                    <?php
                                                    $ketPPH21="PPH21 (DPP*5%*50%) atau (JASA*5%*50%)";
                                                    $ketPPH23="PPH23 (DPP*2%) atau (JASA*2%)";
