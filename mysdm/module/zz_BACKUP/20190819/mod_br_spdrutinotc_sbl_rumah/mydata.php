<?php
    ...
    $sql .=" AND divisi='OTC'";
    $sql .=" AND CONCAT(kodeid,subkode) in ('103', '221')";
    ...
    while( $row=mysqli_fetch_array($query) ) {  // preparing an array
        ...
        if ($pkode=="1" AND $psubkode=="03") {
            ...
            $plihatview = "<a class='btn btn-info btn-xs' href='eksekusi3.php?module=$_GET[module]&act=viewbrrutinotc&idmenu=$_GET[idmenu]&ket=bukan&ispd=$idno&bln=$ptgl' target='_blank'>View</a>";
            $plihatexcel = "<a class='btn btn-info btn-xs' href='eksekusi3.php?module=$_GET[module]&act=viewbrrutinotc&idmenu=$_GET[idmenu]&ket=excel&ispd=$idno&bln=$ptgl' target='_blank'>Excel</a>";
        }
