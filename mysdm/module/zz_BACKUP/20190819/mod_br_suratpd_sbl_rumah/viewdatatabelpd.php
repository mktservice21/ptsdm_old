...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#datatablespd').DataTable( {
            ...
            "ajax":{
                url :"module/mod_br_suratpd/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="+nmun+"&aksi="+eaksi+"&uperiode1="+etgl1+"&uperiode2="+etgl2, // json datasource
    ...
    function ProsesData(ket, noid){
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form2").action = "module/mod_br_suratpd/aksi_simpanspd.php?module="+module+"&idmenu="+idmenu+"&act=hapus&kethapus="+"&ket="+ket+"&id="+noid;
