        ...
        <table id='dtablecadir' class='table table-striped table-bordered' width='100%'>
            ...
            <?PHP
                ...
                while ($row= mysqli_fetch_array($tampil)) {
                    ...
                    $print=$pnodivisi;
                    if ($pdivisi=="OTC") {
                        if ( ($pkode=="1" AND $pkode="03") ) {
                            
                        }elseif ( ($pkode=="2" AND $pkode="21") ) {
                            $pmymodule="module=spdrutinotc&act=viewbrrutinotc&idmenu=245&ket=bukan&ispd=$idno";
                        }else{
                        ...
                        if ($pmystsyginput==1) {
                            ...
                            $pmymodule="module=saldosuratdana&act=input&idmenu=187&ket=bukan&ispd=$idno&iid=$pmystsyginput";
