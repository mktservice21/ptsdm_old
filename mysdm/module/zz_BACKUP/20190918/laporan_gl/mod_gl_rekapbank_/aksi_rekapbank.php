<?PHP
    ...
    $query = "select a.stsinput, a.idinputbank, a.tanggal, a.nobukti, a.coa4, c.NAMA4, 
        a.kodeid, a.subkode, a.idinput, a.nomor, a.divisi, a.keterangan, a.nodivisi, a.jumlah, a.sts, a.userid, a.brid, a.noslip, CAST('' as CHAR(1)) as nket   
    ...
    $query = "SELECT  b.idrutin, a.idots, a.tgl_kembali, a.kembali_rp, a.divisi, a.karyawanid, a.bulan, '000-0' as coa, c.NAMA4, b.nobukti, a.keterangan, cast('' as char(150)) as nmkaryawan 
            ...
            //while ($row1= mysqli_fetch_array($tampil1)) {
                ...
                while ($row= mysqli_fetch_array($tampil)) {
                    ...
                    */
                    ...
                    if ($ppilihrpt!="excel" AND $pstsinput=="K" AND $psubkode!="29" AND $psudahtransfer!="Y") {
                        if (!empty($pnodivisi)) {
