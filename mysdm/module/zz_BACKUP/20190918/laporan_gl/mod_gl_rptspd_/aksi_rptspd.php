...
<body>
    ...
    <?PHP
        ...
        $query = "select a.idinput, a.tgl, a.tglspd, a.kodeid, b.nama, a.subkode, b.subnama, a.divisi, 
            IFNULL(a.nomor,'') nomor, a.nodivisi, a.jumlah, a.jumlah2  
        ...
        //echo "$query";exit;
        if ($pses_grpuser!="1" AND $pses_grpuser!="22" AND $pses_grpuser!="24" AND $pses_grpuser!="34" AND $pses_grpuser!="25") {//AND $pses_grpuser!="25" (anne)
            ...
            if ($pses_grpuser=="25") {//34=surabaya
                $query.=" AND ( ( (DATE_FORMAT(tglspd,'%Y%m') between '$periode1' AND '$periode2') AND a.pilih='Y' ) "
                        . " OR ( (DATE_FORMAT(tgl,'%Y%m') between '$periode1' AND '$periode2') AND a.pilih<>'Y' ) "
                        . ")";
            }else{
