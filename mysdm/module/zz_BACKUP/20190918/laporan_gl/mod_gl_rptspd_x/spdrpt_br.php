    ...
    if ($_GET['ket']=="bukan") {
        ...
        if ($pnjenisrpt=="D") {
            $query = "select '' lampiran, '' as kode, '' as ca, '' as via,
                ...
                CAST(0 as DECIMAL(20,2)) as jasa_rp, CAST(0 as DECIMAL(20,2)) as materai_rp, CAST(0 as DECIMAL(20,2)) as jenis_dpp 
        ...
        $query = "INSERT INTO $tmp04 (jns_pajak, divprodid, brId, noslip, karyawanId, nama_karyawan, "
                . " dokterId, dokter, nama_dokter, aktivitas1, aktivitas2, tgl, tgltrans, realisasi1, jumlah, COA4)"
                . " SELECT 'DPP' jns_pajak, divprodid, brId, noslip, karyawanId, nama_karyawan, "
                . " dokterId, dokter, nama_dokter, aktivitas1, aktivitas2, tgl, tgltrans, realisasi1, dpp, COA4 "
        ...
        $query = "INSERT INTO $tmp04 (jns_pajak, divprodid, brId, noslip, karyawanId, nama_karyawan, "
                ...
                . " dokterId, dokter, nama_dokter, aktivitas1, aktivitas2, tgl, tgltrans, realisasi1, ppn_rp, '106-04' COA4 "
        ...
        $query = "INSERT INTO $tmp04 (jns_pajak, divprodid, brId, noslip, karyawanId, nama_karyawan, "
                ...
                . " dokterId, dokter, nama_dokter, aktivitas1, aktivitas2, tgl, tgltrans, realisasi1, pph_rp, '205-08' COA4 "
        ...
        $query = "INSERT INTO $tmp04 (jns_pajak, divprodid, brId, noslip, karyawanId, nama_karyawan, "
                ...
                . " dokterId, dokter, nama_dokter, aktivitas1, aktivitas2, tgl, tgltrans, realisasi1, pph_rp, '205-02' COA4 "
        ...
        $query = "INSERT INTO $tmp04 (jns_pajak, divprodid, brId, noslip, karyawanId, nama_karyawan, "
                ...
                . " dokterId, dokter, nama_dokter, aktivitas1, aktivitas2, tgl, tgltrans, realisasi1, pembulatan, '905-02' COA4 "
        ...
        $query = "INSERT INTO $tmp04 (jns_pajak, divprodid, brId, noslip, karyawanId, nama_karyawan, "
                ...
                . " dokterId, dokter, nama_dokter, aktivitas1, aktivitas2, tgl, tgltrans, realisasi1, materai_rp, '' COA4 "
    ...
    ?>
        ...
        <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
            ...
            <?PHP
                ...
                $query = "select * FROM $tmp03 order by nodivisi, COA4 LIMIT $pjmlsudah, $plimit";
