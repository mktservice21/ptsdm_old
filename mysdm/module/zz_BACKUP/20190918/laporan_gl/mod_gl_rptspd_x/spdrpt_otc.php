<?php
    ...
    $query = "select a.brOtcId, a.tgltrans, a.COA4, b.NAMA4, a.icabangid_o, c.nama nama_cabang, a.noslip, a.kodeid, a.subpost,
       ...
       a.lampiran, a.ca, a.via, a.tglbr, a.tglrpsby, a.tglreal, materai_rp, jasa_rp, jenis_dpp  
       from hrd.br_otc a 
    ...
    $query = "INSERT INTO $tmp04 (jns_pajak, brOtcId, tgltrans, tglbr, tglrpsby, tglreal, icabangid_o, nama_cabang, "
            ...
            . " noslip, kodeid, subpost, keterangan1, real1, realisasi, ppn_rp, '106-04' COA4 "
    ...
    $query = "INSERT INTO $tmp04 (jns_pajak, brOtcId, tgltrans, tglbr, tglrpsby, tglreal, icabangid_o, nama_cabang, "
            ...
            . " noslip, kodeid, subpost, keterangan1, real1, realisasi, pph_rp, '205-08' COA4 "
    ...
    $query = "INSERT INTO $tmp04 (jns_pajak, brOtcId, tgltrans, tglbr, tglrpsby, tglreal, icabangid_o, nama_cabang, "
            ...
            . " noslip, kodeid, subpost, keterangan1, real1, realisasi, pph_rp, '205-02' COA4 "
    ...
    $query = "INSERT INTO $tmp04 (jns_pajak, brOtcId, tgltrans, tglbr, tglrpsby, tglreal, icabangid_o, nama_cabang, "
            ...
            . " noslip, kodeid, subpost, keterangan1, real1, realisasi, pembulatan, '905-02' COA4 "
    ...
    $query = "INSERT INTO $tmp04 (jns_pajak, brOtcId, tgltrans, tglbr, tglrpsby, tglreal, icabangid_o, nama_cabang, "
            ...
            . " noslip, kodeid, subpost, keterangan1, real1, realisasi, materai_rp, '' COA4 "
...
?>
        <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
            ...
            <?PHP    
                ...
                $query = "select * FROM $tmp03 WHERE nodivisi='$pnodivisi' order by nodivisi, COA4 LIMIT $pjmlsudah, $plimit";
