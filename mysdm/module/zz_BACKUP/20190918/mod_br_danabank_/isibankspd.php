    ...
    if ($pket_input==2) {
        $fil_keluar_ = "(
                    (DATE_FORMAT(tglspd,'%Y%m') between '$periode1' AND '$periode2')
                        OR
                        (
                        (DATE_FORMAT(tgl,'%Y%m') between '$periode1' AND '$periode2') AND ( a.subkode IN ('22', '23') OR a.pilih='N')
                        )
                    )";
    }
    //and a.pilih='Y' 
    $query = "select CAST('' as char(1)) as sdh, a.idinput, a.tgl, a.tglspd, a.kodeid, b.nama, a.subkode, b.subnama, a.divisi, 
        IFNULL(a.nomor,'') nomor, a.nodivisi, a.nodivisi2, a.jumlah, CAST(NULL as DECIMAL(20,2)) as jml_adj  
