            ...
            default:
                ...
                <div class='col-md-12 col-sm-12 col-xs-12'>
                    <div class='x_panel'>
                        ...
                        <div class='x_title'>
                            <h2><input class='btn btn-default' type=button value='Tambah Baru (Debit)'
                                ...
                                <?PHP if ($pses_grpuser=="1" OR $pses_grpuser=="24" OR $pses_grpuser=="25") { ?>
                                    &nbsp;<input type='button' class='btn btn-primary' id="s-submit" value="Bank Masuk dari SPD (Debit)" onclick="IsiBankSPD('1')">
                                    &nbsp;<input type='button' class='btn btn-info' id="s-submit" value="Bank Keluar dari SPD (Kredit)" onclick="IsiBankSPD('2')">
