                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div id="div_spd">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-3'>
                                            <input type="checkbox" id="chk_pilihbln" name="chk_pilihbln" value="" onclick="HapusBulanSPD()" checked>
                                            ...
                                            <select class='form-control input-sm' id='cb_nodivisi' name='cb_nodivisi' onchange="ShowDataNoBRSlip()">
                                                ...
                                                if ($_GET['act']=="editdata" AND $pd_spd=="Y"){
                                                    ...
                                                    while ($zs= mysqli_fetch_array($tampil)) {
                                                        ...
                                                        $pajsketjml = "$pdivisi - $pnobrdiv   &nbsp;&nbsp;&nbsp;&nbsp;    (Rp. $pjumlah)";
...
<script type="text/javascript">
    ...
    function disp_confirm(pText_,ket)  {
        ...
        if (etgl_cls!=""){
            alert("Periode (Tgl. Masuk) yang diisi sudah proses closing...\n\
                Tidak bisa tambah dan edit data.\n\
                Silakan isi Tgl. Masuk lain...!!!");
            return false;
        }
