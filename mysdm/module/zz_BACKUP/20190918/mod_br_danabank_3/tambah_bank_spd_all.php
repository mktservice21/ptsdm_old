    ...
    $pnobukti="";
        ...
        if (empty($pnobukti)) {
            ...
            $query = "SELECT LTRIM(REPLACE(MAX(SUBSTRING_INDEX(nobbm, '/', 1)),'BBM','')) as nobbm FROM dbmaster.t_suratdana_br 
                WHERE IFNULL(stsnonaktif,'') <> 'Y' AND DATE_FORMAT(tglspd,'%Y%m')='$pthnini_bln'";
                            ...
                            <div class='x_panel'>
                                <div class='x_content'>
                                    <div class='col-md-12 col-sm-12 col-xs-12'>
                                        ...
                                        <div id="d_isibank" style="display: none;">
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                $.ajax({
                    ...
                    data:"unospd="+enospd+"&ubukti="+ebukti+"&utglmasuk="+etglmasuk+"&usimpanspd="+esimpanbank+"&uketerangan="+eketerangan,
                    success:function(data){
                        if (data.length > 2) {
                            alert(data);
                        }
