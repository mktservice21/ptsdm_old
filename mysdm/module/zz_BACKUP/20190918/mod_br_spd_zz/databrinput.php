...
if ($_GET['module']=="viewdatabrinput"){
    ...
    */
    ...
    if ($pact=="editdata") {
        ...
        $query = "select a.*, b.urutan, b.bridinput, b.trans_ke, b.jml_adj from $tmp03 a LEFT JOIN $tmp04 b on a.brId=b.bridinput";
        ...
        $query = "select *, CAST(null as DECIMAL(10,0)) as urutan, CAST('' as CHAR(20)) as bridinput, CAST('' as CHAR(2)) as trans_ke, CAST(null as DECIMAL(20,2)) jml_adj from $tmp03";
        $query = "create TEMPORARY table $tmp05 ($query)"; 
        mysqli_query($cnmy, $query);
        $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
        ...
        <table id='datatable' class='datatable table nowrap table-striped table-bordered' width="100%">
            ...
            <?PHP
                ...
                while ($row= mysqli_fetch_array($tampil)) {
                    ...
                    $pnmselecturut="<select id='cb_urut[$pbrid]' name='cb_urut[$pbrid]' onChange=\"cekBoxDataBR('$pbrid', 'cb_urut[$pbrid]', 'chk_jml1[$pbrid]', 'chk_adj[$pbrid]', 'txt_adj[$pbrid]', 'chk_transke[$pbrid]')\">$purut_opt</select>";
                    
                    $chkbox_bca = "<input type='checkbox' id='chk_transke[$pbrid]' name='chk_transke[$pbrid]' onclick=\"CentangCekBoxDataBR('$pbrid', 'cb_urut[$pbrid]', 'chk_jml1[$pbrid]', 'chk_adj[$pbrid]', 'txt_adj[$pbrid]', 'chk_transke[$pbrid]')\" value='NB' $ncheck_trans>";//NB = NON BCA
                    
                    $chkbox = "<input type='checkbox' id='chk_jml1[$pbrid]' name='chk_jml1[]' value='$pbrid' onclick=\"CentangCekBoxDataBR('$pbrid', 'cb_urut[$pbrid]', 'chk_jml1[$pbrid]', 'chk_adj[$pbrid]', 'txt_adj[$pbrid]', 'chk_transke[$pbrid]')\" $ncheck_sudah>";
                    ...
                    $chkbox_adj = "<input type='checkbox' id='chk_adj[$pbrid]' name='chk_adj[$pbrid]' value='$pbrid' onclick=\"ShowHideTextBoxAdj('$pbrid', 'cb_urut[$pbrid]', 'chk_jml1[$pbrid]', 'chk_adj[$pbrid]', 'txt_adj[$pbrid]', 'chk_transke[$pbrid]')\" $ncheck_sudah_adj>";
                    $txtbox_adj = "<input type='text' style='$nvisible_txtadj' id='txt_adj[$pbrid]' name='txt_adj[$pbrid]' value='$jml_adj' onblur=\"CentangCekBoxDataBR('$pbrid', 'cb_urut[$pbrid]', 'chk_jml1[$pbrid]', 'chk_adj[$pbrid]', 'txt_adj[$pbrid]')\" size='7px' class='input-sm inputmaskrp2'>";
                    ...
                    echo "<td nowrap>$chkbox_adj $txtbox_adj</td>";
    ...
    <script type="text/javascript">
        function cekBoxDataBR(nidbr, nmcb, nmchk, nchkadj, ntxtadj, ntranske) {
            ...
            BukaTutupTabelInput(nidbr, nmchk, ecb_br, nchkadj, ntxtadj, ntranske);
            //alert(nmcb+", ada, "+nmchk);
        }
        
        function CentangCekBoxDataBR(nidbr, nmcb, nmchk, nchkadj, ntxtadj, ntranske) {
            HitungTotalDariCekBox();
        ...
        function BukaTutupTabelInput(nidbr, nmchk, nurutan, nchkadj, ntxtadj, ntranske) {
            var nm_r = "tb_"+nidbr;
        ...
        function ShowHideTextBoxAdj(nidbr, nmcb, nmchk, nchkajd, ntxtadj, ntranske){
            ...
            CentangCekBoxDataBR(nidbr, nmcb, nmchk, nchkajd, ntxtadj, ntranske);
        }
