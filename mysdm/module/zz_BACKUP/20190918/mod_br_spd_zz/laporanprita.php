...
<?php
    ...
    $query = "select a.idinput, a.tgl, a.tglspd, a.divisi, a.nodivisi, a.nomor, a.kodeid, a.subkode, a.jenis_rpt, 
        ...
        c.bridinput, c.amount, c.jml_adj, a.keterangan ket_adj, c.urutan, c.trans_ke 
        from dbmaster.t_suratdana_br a 
            LEFT JOIN 
        (select DISTINCT idinput, IFNULL(bridinput,'') as bridinput, amount, jml_adj, urutan, trans_ke from dbmaster.t_suratdana_br1 WHERE idinput='$idinputspd') as c 
    ...
    $query = "select a.*, b.amount, b.jml_adj, b.ket_adj, b.urutan, b.trans_ke from $tmp02 a JOIN $tmp01 b on a.brId=b.bridinput";
    ...
    mysqli_query($cnmy, "UPDATE $tmp07 SET amount=jml_adj, jumlah=jml_adj, jumlah1=jml_adj, aktivitas1=ket_adj, aktivitas2=ket_adj");
