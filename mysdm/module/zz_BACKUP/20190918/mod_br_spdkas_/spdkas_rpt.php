    ...
    <?PHP
        ...
        mysqli_query($cnit, $query);
            ...
            $query = "SELECT a.*, b.tglf, b.tglt, b.divisipd, b.kodenama, b.tglpd, b.nomor, b.nodivisi, 
                ...
                b.jenis_rpt, b.kodeid, b.subkode  
        ...
        $query = "select distinct kodeid, subkode, tglf, tglt, tglpd, divisipd divisi, kodenama, nomor, nodivisi, coa, coa_nama, jumlahpd, jenis_rpt FROM $tmp03 order by tglpd, divisipd, nodivisi";
