                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div id="c_input">
                                    <div class='form-group'>
                                        ...
                                        <button type='button' class='btn btn-info btn-xs' onclick='CariData()'>Hitung Jumlah</button> <span class='required'></span>
                                        </label>
                                        <div class='col-md-3'>
...
<script type="text/javascript">
    ...
    function CariData()  {
        ...
        $.ajax({
            ...
            data:"uper1="+eper1+"&uper2="+eper2+"&eidinput="+eidinput+"&uact="+iact,
            success:function(data){
                $("#s_div").html(data);
                $("#loading3").html("");
