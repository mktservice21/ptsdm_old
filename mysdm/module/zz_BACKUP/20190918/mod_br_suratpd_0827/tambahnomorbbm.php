            ...
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div class='x_panel'>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-4'>
                            <input type='text' id='e_noakhir' name='e_noakhir' class='form-control col-md-7 col-xs-12' value='<?PHP echo $noterakhir; ?>' onblur="TampilkanDataSPDDIVBBM('e_noakhir')">
                            <br/>
                            <input type="checkbox" id="chksama" value="deselect" 
                                   onClick="ShowDataTampilkanBBM('')"/> Samakan No. BBM
                        </div>
                    </div>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-4'>
                            <button type='button' class='btn btn-info btn-xs' onclick="ShowDataTampilkanBBM('')">Tampilkan Data</button> <span class='required'></span>
                        </div>
                    </div>
...
<script>
    ...
    function ShowNoUrutBBM(){
        var itgl = document.getElementById('e_tglberlaku').value;
        $.ajax({
            type:"post",
            url:"module/mod_br_suratpd/viewdata.php?module=viewnourutbbm",
            data:"utgl="+itgl,
    ...
    function SelAllCheckBox(nmbuton, data){
        ...
        ShowDataTampilkanBBM();
        

            
    }
    
    function ShowDataTampilkanBBM(){
        TampilkanDataSPDDIVBBM('');
        ShowNoUrutBBM();
    }
    function TampilkanDataSPDDIVBBM(noterakhir){
        if (noterakhir=="") {
            var inoakhir = "";
        }else{
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_suratpd/viewdata.php?module=showdatanospdnodiv&pilih=nobbm",
    ...
    function SimpanHapusDataNOBBM(eact, eidinput, eurutan, enomor) {
        ...
        var pText_="Simpan";
        var pmodule="simpandatanobbm";
        if (eact=="hapus") {
            var pText_="Hapus";
            var pmodule="hapusdatanobbm";
