...
<?php
    ...
    $query = "select a.idinput, a.tgl, a.tglspd, a.divisi, a.nodivisi, a.nomor, a.kodeid, a.subkode, a.jenis_rpt, 
        ...
        c.bridinput, c.amount, c.jml_adj, c.ketadj1, c.ketadj2, a.keterangan, c.urutan, c.trans_ke 
    ...
    $query = "select a.*, b.amount, b.jml_adj, b.ketadj1, b.ketadj2, b.urutan, b.trans_ke from $tmp02 a JOIN $tmp01 b on a.brId=b.bridinput";
        ...
        <tbody>
            <?PHP
                ...
                while ($row1= mysqli_fetch_array($tampil1)) {
                    ...
                    if ((double)$njml>1 AND $padvance!="Bx") {
