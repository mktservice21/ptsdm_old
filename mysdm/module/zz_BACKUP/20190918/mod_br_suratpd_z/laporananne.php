<?PHP
    ...
    if ($_GET['ket']=="excel") {
        ...
        if ($mact=="viewbrklaim")
            header("Content-Disposition: attachment; filename=KLAIM_DISCOUNT_BR_HO_$now_.xls");
        else
            header("Content-Disposition: attachment; filename=CASH ADVANCE_BR_HO_$now_.xls");
    }
...
<?php
    ...
    $query = "select a.idinput, a.tgl, a.tglspd, a.divisi, a.nodivisi, a.nomor, a.kodeid, a.subkode, a.jenis_rpt, 
        ...
        c.bridinput, c.amount, c.urutan, c.trans_ke 
        from dbmaster.t_suratdana_br a 
            LEFT JOIN 
        (select DISTINCT idinput, IFNULL(bridinput,'') as bridinput, amount, urutan, trans_ke from dbmaster.t_suratdana_br1 WHERE idinput='$idinputspd') as c 
    ...
    if ($mact=="viewbrklaim") {
        $query = "select a.DIVISI divprodid, a.klaimId brId, a.karyawanid karyawanId, c.nama nama_karyawan,
            ...
            a.realisasi1, a.noslip, a.COA4, d.NAMA4, 0 jumlah1, 0 realisasi2, '' iCabangId, '' nama_cabang, CAST('' as CHAR(1)) batal  
        ...
        $query = "select a.divprodid, a.brId, a.tgl, a.noslip, a.tgltrans, a.tglrpsby, a.karyawanId, a.dokterId, a.dokter, 
            a.aktivitas1, a.aktivitas2, a.realisasi1, a.jumlah, a.jumlah1, a.realisasi2, a.iCabangId, a.COA4, a.batal from hrd.br0 a 
        ...
        $query = "INSERT INTO $tmp04 (divprodid, brId, tgl, noslip, tgltrans, tglrpsby, karyawanId, dokterId, dokter, 
            aktivitas1, aktivitas2, realisasi1, jumlah, jumlah1, realisasi2, iCabangId, COA4, batal)
            select a.divprodid, a.brId, a.tgl, a.noslip, a.tgltrans, a.tglrpsby, a.karyawanId, a.dokterId, a.dokter, 
            a.aktivitas1, a.aktivitas2, a.realisasi1, a.jumlah, a.jumlah1, a.realisasi2, a.iCabangId, a.COA4, 'Y' as batal from dbmaster.backup_br0 a 
            WHERE a.brId IN (select DISTINCT IFNULL(bridinput,'') bridinput FROM $tmp01)";
        mysqli_query($cnmy, $query);
        $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
        ...
        $query = "select a.divprodid, a.brId, a.tgl, a.noslip, a.tgltrans, a.tglrpsby, a.karyawanId, c.nama nama_karyawan, a.dokterId, a.dokter, b.nama nama_dokter,
            a.aktivitas1, a.aktivitas2, a.realisasi1, a.jumlah, a.jumlah1, a.realisasi2, a.iCabangId, d.nama nama_cabang, a.COA4, e.NAMA4, a.batal from $tmp04 a 
    ...
    $query = "select a.*, b.amount, b.urutan, b.trans_ke from $tmp02 a JOIN $tmp01 b on a.brId=b.bridinput";
    ...
    $query = "select a.idinput, a.tgl, a.tglspd, a.divisi, a.nodivisi, a.nomor, "
            . " a.kodeid, a.subkode, a.jenis_rpt, a.gbr_apv1, a.gbr_apv2, a.gbr_dir, a.gbr_dir2, a.tglkeluar, a.nobukti FROM $tmp01 a LIMIT 1";
...
?>    
        ...
        <div id="isikiri">
            <table class='tjudul' width='100%'>
                <?PHP
                    ...
                    echo "<tr><td width='150px'><b>Budget Request Team $pdivisi : </b></td><td>$nodivisi</td></tr>";
                    ...
                    echo "<tr><td width='150px'><b>$nket_status : </b></td><td><b>$periode1</b></td></tr>";
                    
                    if (!empty($ntgl_rptsby)) {
                        echo "<tr><td width='150px'><b>Tgl. Transfer Surabaya : </b></td><td><b>$ntgl_rptsby</b></td></tr>";
                    }else{
    ...
    <div class="clearfix"></div>
    <div><table style='color:blue; border:0px' width='90%'><tr><td align='right'><?PHP echo $nmadvance; ?></td></tr></table></div>
        ...
        <tbody>
            <?PHP
                ...
                while ($row1= mysqli_fetch_array($tampil1)) {
                    ...
                    if ((double)$njml>1 AND $padvance!="B") {
    ...
    <br/>&nbsp;<br/>&nbsp;
        ...
        echo "<tr align='center'>";
        //echo "<td>Marianne</td> <td></td> <td>(Marianne Prasanti)</td> <td></td> <td>(dr. Farida Soewanto)</td>";
        echo "<td>Marianne</td> <td></td> <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> <td></td> <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
        echo "</tr>";
