            ...
            <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
                ...
                <tbody>
                    <?PHP
                        ...
                        $query = "select distinct urutan from $tmp03 order by CAST(urutan AS decimal(20)) ASC";
                        ...
                        while ($row1= mysqli_fetch_array($tampil1)) {
                            ...
                            $nmyno=$no;
                            $query = "select * from $tmp03 WHERE urutan='$pnourut_' order by CAST(urutan AS decimal(20)) ASC, noslip, realisasi1, nama_karyawan, brId";
                            $tampil=mysqli_query($cnmy, $query);
