        ...
        if ($act=="simpan_ttdallam") {
            ...
            if ($pses_grpuser=="3" OR $pses_grpuser=="23" OR $pses_grpuser=="28") {
                ...
                mysqli_query($cnmy, "update $dbname.t_suratdana_br set apv1='$karyawanapv', tgl_apv1=NOW(), gbr_apv1='$gbrapv' WHERE karyawanid='$pses_idcard' AND idinput in $noidbr AND "
                        . " IFNULL(tgl_apv2,'')='' AND CONCAT(kodeid, subkode) IN ('103', '221')");
                ...
                mysqli_query($cnmy, "update $dbname.t_suratdana_br set apv2='$karyawanapv', tgl_apv2=NOW(), gbr_apv2='$gbrapv' WHERE "
                        ...
                        . " CONCAT(kodeid, subkode) NOT IN ('103', '221')");
            }
            ...
            if ($pses_grpuser=="3" OR $pses_grpuser=="23" OR $pses_grpuser=="28") {
                ...
                mysqli_query($cnmy, "update $dbname.t_suratdana_br set apv2=NULL, tgl_apv2=NULL, gbr_apv2=NULL WHERE idinput in $noidbr AND IFNULL(tgl_apv1,'')<>'' AND IFNULL(tgl_dir,'')='' AND CONCAT(kodeid, subkode) NOT IN ('103', '221')");
                mysqli_query($cnmy, "update $dbname.t_suratdana_br set apv1=NULL, tgl_apv1=NULL, gbr_apv1=NULL WHERE karyawanid='$pses_idcard' AND idinput in $noidbr AND IFNULL(tgl_apv2,'')='' AND CONCAT(kodeid, subkode) IN ('103', '221')");
