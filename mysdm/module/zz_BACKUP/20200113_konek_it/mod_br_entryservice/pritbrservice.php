    ...
    <body>
        <div id="div1">
            <?PHP
                ...
                $query = "select * from dbmaster.v_service_kendaraan where idservice='$_GET[brid]' order by nama, tglservice, nama_area";
                ...
                $phari1=date("w", strtotime($row['tglservice']));
                $pdate1=date("d", strtotime($row['tglservice']));
                $pbln1=(int)date("m", strtotime($row['tglservice']));
                $pthn1=date("Y", strtotime($row['tglservice']));
                ...
                if (!empty($gambar)) {
                    ...
                    $namapengaju="img_".$idbr."PENGAJUSVC_.png";
            ...
            <div id="kotakjudul">
                <div id="isikiri">
                    <table class='tjudul' width='100%'>
                        ...
                        <tr><td>TGL. SERVICE</td><td>:</td><td><?PHP echo "$pp01"; ?></td></tr>
                        <tr><td>MERK / TIPE</td><td>:</td><td><?PHP echo "$kendaraan"; ?></td></tr>
                        <tr><td>NO. POLISI</td><td>:</td><td><?PHP echo "$nopol"; ?></td></tr>
