                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='e_idkaryawan' name='e_idkaryawan' onchange="showDataKaryawan('tambahbaru', 'e_idkaryawan')">
                                            ...
                                            //PilihKaryawanAktif($konek, $adapilihan, $ygdipilih, $hanyaygaktif, $stsadim, $pdivisi, $lvlposisi, $tampilkanlevelbawahan, $karyawan, $jabatan, $region, $cabang, $area, $hanyasatu)
                        ...
                        <div id='div_karyawan'>
                                ...
                                <div <?PHP echo $txtkrynone; ?>>
                                    ...
                                    <div class='col-xs-9'>
                                        ...
                                        <?PHP
                                        if ($_GET['act']=="editdata"){
                                            PilihAreaCabangAll("", "", $idcabang.$idarea, "Y", $idajukan, $lvlpengajuan, $pdivisi, $idcabang, $idarea);
                                        }
                                        ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class='col-xs-5'>
                                        ...
                                        if ($_GET['act']=="editdata"){
                                            ...
                                            while ($Xt=mysqli_fetch_array($sql)){
                                                ...
                                                if (($ketemu==1) OR ($Xt['divisiid']==$pdivisi))
