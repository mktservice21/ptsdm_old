...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><div class="title_left">
            <h2>
                <?PHP
                $judul="Outstanding Biaya Luar Kota dan CA Per Bulan";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_otsdlkca_eth/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_otsdlkca_eth/viewdatatabel.php?module="+ket,
