...
if ($_GET['module']=="viewdatakd"){
    ...
    $query = "select distinct a.bridinput from dbmaster.t_suratdana_br1 a JOIN dbmaster.t_suratdana_br b "
            . " on a.idinput=b.idinput WHERE b.stsnonaktif<>'Y' AND a.kodeinput='E' $nfilterid_sudah";
    $query = "create TEMPORARY table $tmp00 ($query)"; 
    mysqli_query($cnmy, $query);
    $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
    
    //tutup dulu, keterangan diatas
    //$nfilter_sudahada=" AND klaimId NOT IN (select distinct IFNULL(bridinput,'') bridinput FROM $tmp00)";
    ...
    $query = "select distinct IFNULL(bridinput,'') bridinput FROM dbmaster.t_suratdana_br1 WHERE idinput in "
            ...
            . "tgl='$ntglpilih' AND jenis_rpt IN ('D','C'))";
    ...
    if ($pact=="editdata") {
        ...
        $query = "select a.*, b.urutan, b.bridinput, b.trans_ke from $tmp01 a LEFT JOIN $tmp04 b on a.klaimId=b.bridinput";
