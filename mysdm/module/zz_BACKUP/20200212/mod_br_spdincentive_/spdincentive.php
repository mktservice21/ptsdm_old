<?PHP
    ...
    if (!empty($_SESSION['STPDPERENTYINC1'])) $tgl_pertama = $_SESSION['STPDPERENTYINC1'];
    if (!empty($_SESSION['STPDPERENTYINC2'])) $tgl_akhir = $_SESSION['STPDPERENTYINC2'];
...
<div class="">
    ...
    <div class="page-title"><div class="title_left">
            <h3>
                <?PHP
                $judul="Permintaan Dana Incentive";
    ...
    <div class="row">
        ...
        <?php
        //$aksi="module/mod_br_spdincentive/laporanbrbulan.php";
        $aksi="eksekusi3.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    ...
                    function KlikDataTabel() {
                        var eaksi = "module/mod_br_spdincentive/aksi_spdincentive.php";
                        ...
                        $.ajax({
                            type:"post",
                            url:"module/mod_br_spdincentive/viewdatatabel.php?module=viewdata",
