...
if ($_GET['module']=="viewdataotc"){
    ...
    $tmp03 =" dbtemp.DSETH03_".$userid."_$now ";
        ...
        $query = "select distinct a.idinput, IFNULL(a.bridinput,'') bridinput, a.amount, CAST('' as CHAR(1)) as sinput FROM dbmaster.t_suratdana_br1 a JOIN "
        ...
        if ($pact=="editdata") {
            $query = "UPDATE $tmp01 a JOIN $tmp02 b on a.brOtcId=b.bridinput SET a.sinput=b.sinput, a.amount=b.amount";
            mysqli_query($cnmy, $query);
            $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; exit; }
        }
