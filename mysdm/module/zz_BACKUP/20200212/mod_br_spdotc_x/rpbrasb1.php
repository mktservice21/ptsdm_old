...
<?php
	...
	$query = "select * from hrd.br_otc where brOtcId IN (select distinct ifnull(bridinput, '') bridinput FROM "
                . " dbmaster.t_suratdana_br1 WHERE idinput='$pidspd') order by tglrpsby,noslip";//echo"$query";
        //echo $query;
	...
	echo "<th>No</th>";
	echo '<th align="center">'.$header_."</th>";
