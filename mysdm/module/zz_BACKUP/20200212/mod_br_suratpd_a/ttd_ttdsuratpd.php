...
<style>
    ...
    .btn-warning {background-color: #ff9933;} /* Green */
    .btn-default {background-color: #e7e7e7; color: black;} /* Blue */
    .btn-danger {background-color: #f44336;} /* Red */
    .btn-breload {background-color: #008CBA;} /* Gray */
...
function ReloadTandaTangan(){
        ...
        $('<input type="button" value="Kirim Email" class="btn btn-warning">').bind('click', function(){
                Tampilkan("image");
        }).appendTo($tools)
        ...
        */
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            var cmt = confirm('pastikan tanda tangan terisi....!!!\n\
                Jika sudah terisi klik OK');
            if (cmt == false) {
                return false;
            }            
            
            
            var allnobr=document.getElementById('e_nospd').value;
            ...
            var nbrid = urlku.searchParams.get("brid");
            var nprint = urlku.searchParams.get("iprint");
            
            
            $.ajax({
                type:"post",
                url:"module/mod_br_suratpd/aksi_ttdsuratpd.php?module="+module+"&brid="+nbrid+"&iprint="+nprint+"&act=simpan_ttdallam",
...
<br/>&nbsp;
<input class='btn btn-breload' type='button' name='buttonreload' value='Reload Tanda Tangan' onClick="ReloadTandaTangan()">
