...
if ($_GET['module']=="gantitombol") {
    ...
    ?>
        ...
        <div class='form-group'>
            ...
            <div class='col-xs-3'>
                <input type='text' id='e_ajsnobr2' name='e_ajsnobr2' class='form-control col-md-7 col-xs-12' value='<?PHP echo $ajsnobr; ?>'>
                <br/>*)diisi jika pilihan no br/divisi tidak ada.
            </div>
        </div>
