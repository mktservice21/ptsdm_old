            ...
            <table id='datatable' class='datatable table nowrap table-striped table-bordered' width="100%">
                ...
                <tbody>
                    ...
                    <?PHP
                        ...
                        $pnmselecturut="<select id='cb_urut[]' name='cb_urut[]'>$purut_opt</select>";
                        ...
                        while ($row= mysqli_fetch_array($tampil)) {
                            ...
                            $chkbox = "<input type='checkbox' id='chk_jml1[]' name='chk_jml1[]' value='$pbrid' onclick='HitungTotalDariCekBox()'> ";
                    ...
                    if (!empty($fdivisi2)) {
                        ...
                        if (!empty($pdivnomor)){
                            echo "<tr><th><input type='checkbox' id='chkall2[]' name='chkall2[]' onclick=\"SelAllCheckBox('chkall2[]', 'chk_jml2[]')\" value='deselect' checked></th><th colspan='11'></th></tr>";
                        }else{
                            echo "<tr><th><input type='checkbox' id='chkall2[]' name='chkall2[]' onclick=\"SelAllCheckBox('chkall2[]', 'chk_jml2[]')\" value='select'></th><th colspan='11'></th></tr>";
                        }
