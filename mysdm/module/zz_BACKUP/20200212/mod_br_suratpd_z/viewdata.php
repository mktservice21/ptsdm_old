...
if ($_GET['module']=="gantitombol") {
    ...
    $ndisabled="disabled";
    $nchecked_="";
    if ( $pkode=="3" OR $pkode=="7" OR ($pkode=="2" AND $psubkode=="29") ) $tgl1 = date('F Y', strtotime($hari_ini));
    if (!empty($pidinput)) {
        ...
        if (!empty($r['bulan2'] AND $r['bulan2']<>"0000-00-00")) {
            ...
            if ( $pkode=="3" OR $pkode=="7" OR ($pkode=="2" AND $psubkode=="29") ) $ptgl=$r['bulan2'];
            //$ndisabled="";
            //$nchecked_="checked";
        }
    }
    ...
    if ( ($pkode=="3" OR $pkode=="7") OR ($pkode=="2" AND $psubkode=="29") ) {
