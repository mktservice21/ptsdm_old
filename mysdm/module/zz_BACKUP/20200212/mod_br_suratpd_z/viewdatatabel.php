    ...
    <div class='x_content' style="margin-left:-20px; margin-right:-20px;">
        ...
        <table id='datatableapvcaisi' class='table table-striped table-bordered' width='100%'>
            ...
            <tbody>
                ...
                $no=1;
                $sql = "SELECT a.tgl_apv1, a.tgl_apv2, a.tgl_dir, a.tgl_dir2, a.idinput, a.tglinput, DATE_FORMAT(a.tgl,'%d/%m/%Y') as tgl, "
                ...
                while( $row=mysqli_fetch_array($query) ) {
                    ...
                    if ($cket=="2"){
                        ...
                        //lk dan kas
                        if ( ($pkode=="2" AND $psubkode=="21") OR ($pkode=="2" AND $psubkode=="22") OR ($pkode=="2" AND $psubkode=="23") ) {
                            if (empty($papv_dir1)) $cekbox="";
                        }
                        //rutin
                        if ( ($pkode=="1" AND $psubkode=="03") OR ($pkode=="1" AND $psubkode=="04") OR ($pkode=="1" AND $psubkode=="05") ) {
                            if (empty($papv_dir1)) $cekbox="";
                        }
                        //BR
