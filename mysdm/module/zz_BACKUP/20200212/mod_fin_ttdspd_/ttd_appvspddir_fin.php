...
function ReloadTandaTangan(){
        ...
        $('<input type="button" value="Buat Link" class="btn btn-primary" data-toggle="modal" data-target="#myModal">').bind('click', function(e){
                BuatLinkApprove('buatlink', 'chkbox_br[]')
        }).appendTo($tools)
        ...
        */
        ...
        $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
            ...
            $.ajax({
                type:"post",
                url:"module/mod_fin_ttdspd/aksi_apvspddir_fin.php?module="+module+"&idmenu="+idmenu+"&act=simpan_ttdallam",
