<?php
    $aksi="module/mod_fin_ttdspd/aksi_apvspddir.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['FINSPDAPVTGL1'])) $tgl_pertama = $_SESSION['FINSPDAPVTGL1'];
    if (!empty($_SESSION['FINSPDAPVTGL2'])) $tgl_akhir = $_SESSION['FINSPDAPVTGL2'];
    if (!empty($_SESSION['FINSPDAPVKET'])) $apvpilih = $_SESSION['FINSPDAPVKET'];
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_fin_ttdspd/viewdatatable.php?module="+ket,
