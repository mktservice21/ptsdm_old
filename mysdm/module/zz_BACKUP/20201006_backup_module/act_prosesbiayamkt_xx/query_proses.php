<?php
    ...
    if (!empty($pklaim)) {
        ...
        $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
            ...
            $query ="UPDATE $tmp03 SET COA4='751-31' WHERE IFNULL(divprodid,'')='EAGLE'";
            mysqli_query($cnmy, $query); $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
            $query ="UPDATE $tmp03 SET COA4='752-31' WHERE IFNULL(divprodid,'')='PIGEO'";
            mysqli_query($cnmy, $query); $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
            $query ="UPDATE $tmp03 SET COA4='753-31' WHERE IFNULL(divprodid,'')='PEACO'";
            mysqli_query($cnmy, $query); $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
            $query ="UPDATE $tmp03 SET COA4='754-31' WHERE IFNULL(divprodid,'')='OTC'";
            mysqli_query($cnmy, $query); $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
            $query ="UPDATE $tmp03 SET COA4='755-31' WHERE IFNULL(divprodid,'')='CAN'";
            mysqli_query($cnmy, $query); $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
    ...
    $query = "UPDATE $tmp01 a JOIN $tmp11 b on a.idinput_pd=b.idinput SET a.nobukti=b.nobukti, a.tgl_trans_bank=b.tanggal WHERE "
            . " a.kodeinput NOT IN ('I', 'J', 'L', 'M', 'N', 'P', 'A')";
    mysqli_query($cnmy, $query); $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
