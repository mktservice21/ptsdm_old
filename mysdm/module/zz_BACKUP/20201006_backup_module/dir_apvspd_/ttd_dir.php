...
<head>
    <title>Tanda Tangan BR Direktur</title>
    ...
    <script src="tanda_tangan_baru/libs/jquery.js"></script>
    <!--
    ...
    <div>
        <div id="content"  class="main">
            ...
            <div id="kiri">
                ...
                <div id='n_ttd_2' style="display:none;">
                    <?PHP
                    if ($_SESSION['IDCARD']=="0000001372" OR $_SESSION['IDCARD']=="0000000367") {
                    ?>
                        <input class='btn btn-success' type='button' name='buttonapv' value='UnApprove' onClick="ProsesData('unapprove', 'chkbox_br[]')">
                    <?PHP
                    }
                    ?>
                </div>
            ...
            <div id="kanan">
                <?PHP
                include "module/dir_apvspd/tampilkandata.php";
                ?>
            </div>
    ...
    */
    ...
    function ReloadTandaTangan(){
            ...
            $.subscribe(pubsubprefix + 'image/png;base64', function(data) {
                ...
                $.ajax({
                    type:"post",
                    url:"module/dir_apvspd/aksi_apvspddir.php?module="+module+"&idmenu="+idmenu+"&act=simpan_ttdallam",
