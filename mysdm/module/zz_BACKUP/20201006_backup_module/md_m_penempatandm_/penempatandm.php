...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Penempatan Karyawan (DM)</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">

        <?php
        $aksi="module/md_m_penempatandm/aksi_penempatandm.php";
        switch($_GET['act']){
            default:
                ?>
                ...
                <script type="text/javascript" language="javascript" >
                    $(document).ready(function() {
                        ...
                        var aksi = "module/md_m_penempatandm/aksi_penempatandm.php";
                        ...
                        var dataTable = $('#datatable').DataTable( {
                            ...
                            "ajax":{
                                url :"module/md_m_penempatandm/mydata.php?module="+module+"&idmenu="+idmenu+"&nmun="
