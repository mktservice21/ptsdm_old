...
$sql.=" FROM dbmaster.v_penempatanspv WHERE 1=1 ";
if (!empty($idkarawandm))
    $sql.="  and CONCAT(icabangid,areaid) in (select distinct CONCAT(icabangid,areaid) from dbmaster.v_penempatandm where karyawanid='$idkarawandm')";

if (!empty($idkarawanspv))
    $sql.="  and karyawanid='$idkarawanspv' ";
