<?PHP
    ...
    $aksi="module/mod_apv_klaimdiscmkt/aksi_aprovekkcab.php";
    $hari_ini = date("Y-m-d");
    ...
    if (!empty($_SESSION['MAPVKDSTS'])) $apvpilih=$_SESSION['MAPVKDSTS'];
    if (!empty($_SESSION['MAPVKDBLN1'])) $tgl_pertama=$_SESSION['MAPVKDBLN1'];
    if (!empty($_SESSION['MAPVKDBLN2'])) $tgl_akhir=$_SESSION['MAPVKDBLN2'];
    //if (!empty($_SESSION['MAPVKDAPVBY'])) $pkaryawanid=$_SESSION['MAPVKDAPVBY'];
    
    if ($pmodule=="approvedirekturklaimadm") {
        if ($pgroupid=="1" OR $pgroupid=="40" OR $pgroupid=="43" OR $pgroupid=="24") {
        }else{
            echo "tidak berhak...";
            exit;
        }
...
<script>
    ...
    function pilihData(ket){
        ...
        $.ajax({
            type:"post",
            url:"module/mod_apv_klaimdiscmkt/viewdatatable.php?module="+module+"&idmenu="+idmenu+"&act="+act,
...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="title_left">
            <h3>
                Approve Klaim Discount By Marketing
            </h3>
                     ...
                     <div class='col-sm-3'>
                        ...
                        <div class="form-group">
                            <select class='form-control input-sm' id='cb_karyawan' name='cb_karyawan' onchange="KosongkanData()" data-live-search="true">
                                ...
                                if ($pmodule=="approvedirekturklaimadm") {
                                    $query .= " AND karyawanId ='0000002403' ";
                                }else{
                                    if ($pgroupid=="1" OR $pgroupid=="24") {
                                        ...
                                        $query .= " AND jabatanId IN ('36', '04', '05', '01', '02')";
                                    }else{
