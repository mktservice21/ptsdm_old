                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-6 col-sm-6 col-xs-12'>
                                        <input type='text' id='e_jmlkuranglebih' name='e_jmlkuranglebih' autocomplete='off' class='form-control col-md-7 col-xs-12 inputmaskrp2' placeholder="jumlah rp kekurangan / kelebihan" value='<?PHP echo $pjmlkuranglebih; ?>' onblur="HitungTotalJumlahRp()">
