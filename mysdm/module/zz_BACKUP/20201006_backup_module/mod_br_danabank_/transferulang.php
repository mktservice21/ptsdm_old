    ...
    function ProsesDataHapus(pText_, nid)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("d-form7").action = "module/mod_br_danabank/simpanlap_tu.php?module="+module+"&act=hapus"+"&idmenu="+idmenu+"&id="+nid;
    ...
    function disp_confirm_pros_tu(pText_, eact)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                var idmenu = urlku.searchParams.get("idmenu");
                //document.write("You pressed OK!")
                document.getElementById("d-form7").action = "module/mod_br_danabank/simpanlap_tu.php?module="+module+"&act="+eact+"&idmenu="+idmenu;
                document.getElementById("d-form7").submit();
                return 1;
            }
        } else {
