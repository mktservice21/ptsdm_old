<?PHP
    ...
    $sql.=" IFNULL(stsnonaktif,'')<>'Y' AND ( IFNULL(stsinput,'')='K'  ) "
            . " AND idinput='$pidinput_spd' AND subkode NOT IN ('29')";//OR (IFNULL(stsinput,'')='N' AND IFNULL(parentidbank,'')<>'')
                            ...
                            <table id='datatableindb' class='table table-striped table-bordered' width='100%'>
                                ...
                                <body>
                                    <?PHP
                                        ...
                                        $query=mysqli_query($cnmy, $sql) or die("mydata.php: get data");//OR (IFNULL(stsinput,'')='N' AND IFNULL(parentidbank,'')<>'')
                                        $no=1;
