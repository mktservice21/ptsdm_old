...
function seleksi_query_bank($nkodeneksi, $pperiode){
    ...
    $query = "select idots, tgl_kembali, kembali_rp, jumlah_kembali, divisi, 
        ...
        CAST('' as CHAR(10)) as idrutin, CAST('' as CHAR(50)) as nobukti  
    ...
    $query = "select DISTINCT tgl_kembali, bulan, coa, igroup, ikaryawanid, inama_karyawan, rp_total, rp_total2, "
    ...
    $query = "INSERT INTO $tmp02 (idots, karyawanid, nama_karyawan, bulan, tgl_kembali, "
            . " kembali_rp, jumlah_kembali, divisi, coa, stsinput)"
            . " SELECT igroup, ikaryawanid, inama_karyawan, bulan, tgl_kembali, "
            . " rp_total, rp_total2, divisi, coa, stsinput FROM $tmp03";
    mysqli_query($cnmy, $query);
    $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
