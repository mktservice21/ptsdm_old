...
<div class="">
    ...
    <div class="row">
        <?PHP
            ...
            $edit = mysqli_query($cnmy, "SELECT * FROM hrd.br0 WHERE brId='$_GET[id]'");
                                      ...
                                      <div class='col-xs-9'>
                                          <select class='soflow' id='e_idkaryawan' name='e_idkaryawan' onchange="showMR('e_idcabang', 'e_idkaryawan')">
                                                ...
                                                if (($icabangid=='30') or ($icabangid=='31') or ($icabangid=='0000000032')) {
                                                    $query = "select karyawanId,nama,jabatanid,icabangid from hrd.karyawan where ((karyawanId='0000000154' or karyawanId='0000000159') AND aktif = 'Y')  OR karyawanId='$r[karyawanId]' order by nama"; 
                                                } else {
                                                    $query = "select karyawanId,nama,jabatanid,icabangid from hrd.karyawan where (icabangid='$icabangid' AND aktif = 'Y') OR karyawanId='$r[karyawanId]' order by nama"; 
                                                }
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='soflow' id='cb_kode' name='cb_kode'>
                                            ...
                                            <?PHP
                                                $tampil = mysqli_query($cnmy, "select kodeid,nama,divprodid from hrd.br_kode where "
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-9'>
                                        <select class='soflow' id='cb_level4' name='cb_level4'><!-- onchange="showLevel5('cb_level4', 'cb_level5')"
                                            <option value='' selected>-- Pilihan --</option>
                                            <?PHP
                                            $tampil=mysqli_query($cnmy, "SELECT COA4, NAMA4 FROM dbmaster.coa_level4 where COA3='$r[COA3]' order by COA4");
                                            while($a=mysqli_fetch_array($tampil)){
                                                if ($a['COA4']==$r['COA4']) 
                                                    echo "<option value='$a[COA4]' selected>$a[NAMA4]</option>";
                                                else
