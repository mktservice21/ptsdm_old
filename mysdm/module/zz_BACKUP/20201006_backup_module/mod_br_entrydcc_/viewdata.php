...
if ($_GET['module']=="viewdatacomboposting"){
    ...
    $tampil = mysqli_query($cnmy, "SELECT distinct kodeid, nama from hrd.brkd_otc where ifnull(subpost,'') = '$_POST[ukodesub]'");
    ...
    include "../../config/koneksimysqli.php";
    echo "<option value='' selected>-- Pilihan --</option>";
    $tampil=mysqli_query($cnmy, "SELECT COA4, NAMA4 FROM dbmaster.coa_level4 where COA3='$_POST[ulevel3]' order by COA4");
    while($a=mysqli_fetch_array($tampil)){
    ...
    include "../../config/koneksimysqli.php";
    echo "<option value='' selected>-- Pilihan --</option>";
    $tampil=mysqli_query($cnmy, "SELECT COA_KODE, COA_NAMA FROM dbmaster.coa where COA4='$_POST[ulevel4]' order by COA_KODE");
    while($a=mysqli_fetch_array($tampil)){
