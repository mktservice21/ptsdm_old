    ...
    <div class='modal-content'>
        ...
        <div class="">
            ...
            <div class="row">
                ...
                <form method='POST' action='<?PHP echo "$aksi?module=entrybrklaimpajak&act=input&idmenu=87"; ?>' id='demo-form4' name='form4' data-parsley-validate class='form-horizontal form-label-left'>
...
<script>
    ...
    function disp_edit_data(pText_,nid)  {
        $.ajax({
            type:"post",
            url:"module/mod_br_entryklaim/viewdata.php?module=caridatapajak",
            data:"uid="+nid,
            success:function(data){
