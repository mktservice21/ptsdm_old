...
elseif ($module=='entrybrkasbon')
{
    ...
    if ($act=="input") {
        $query = "INSERT INTO $dbname.t_kasbon (idkasbon, tgl, divisi, karyawanid, nama, jumlah, keterangan, userid)values"
                . "('$kodenya', '$periode1', '$pdivisi', '$pkaryawanid', '$pnamauntuk', '$pjumlah', '$pket', '$_SESSION[IDCARD]')";
    }else{
        $query = "UPDATE $dbname.t_kasbon SET divisi='$pdivisi', tgl='$periode1', "
                . " karyawanid='$pkaryawanid', nama='$pnamauntuk', keterangan='$pket', jumlah='$pjumlah', userid='$_SESSION[IDCARD]' WHERE "
                . " idkasbon='$kodenya'";
    }
