                        ...
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='cb_divisi' name='cb_divisi' onchange="ShowCOA('cb_divisi', 'cb_coa');">
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                          <select class='form-control input-sm' id='cb_kdoepil' name='cb_kdoepil' data-live-search="true">
                                              <option value='' selected>-- Pilihan --</option>
                                              <?PHP 
