...
$sql = "SELECT idkascab, DATE_FORMAT(tanggal,'%d/%m/%Y') as tanggal, DATE_FORMAT(bulan,'%M %Y') as bulan, "
        . " divisi, FORMAT(jumlah,0,'de_DE') as jumlah, "
        . " nama_karyawan, nama_cabang, coa4, NAMA4, keterangan, atasan1, tgl_atasan1, atasan2, tgl_atasan2,"
        . " atasan3, tgl_atasan3, atasan4, tgl_atasan4, fin, tgl_fin ";
$sql.=" FROM dbmaster.v_kaskecilcabang ";
$sql.=" WHERE IFNULL(stsnonaktif,'') <> 'Y' AND IFNULL(pengajuan,'') NOT IN ('OTC', 'CHC') ";
