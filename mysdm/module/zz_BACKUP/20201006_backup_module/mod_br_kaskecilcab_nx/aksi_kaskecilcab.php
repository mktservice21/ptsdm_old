...
elseif ($module=='bgtkaskecilcabang')
{
    ...
    $query = "UPDATE $dbname.t_kaskecilcabang_rpdetail SET oustanding='$prpots', saldoawal='$psldawal', pcm='$ppcmrp', jmltambahan='$pjmltambah', jumlah='$ppcrptot' WHERE idkascab='$kodenya' LIMIT 1";
