...
<BODY>
    ...
    <table id='example_2' class='table table-striped table-bordered example_2' width="100%" border="1px">
        ...
        <tbody class='inputdatauc'>
            ...
            //+(DOUBLE)$prptambah
            $psldakhir=(DOUBLE)$prppc-(DOUBLE)$ptotal+(DOUBLE)$prpsldawal;
            
            $ptotal=(DOUBLE)$ptotal-(DOUBLE)$prpsldawal;
            
            $ptotal=number_format($ptotal,0,",",",");
            $prppc=number_format($prppc,0,",",",");
            $psldakhir=number_format($psldakhir,0,",",",");
            
            if ((DOUBLE)$prpsldawal<>0) {
            ...
            if ((DOUBLE)$prptambah<>0) {
                ...
                //echo "<tr>";
                //echo "<td nowrap></td>";
                //echo "<td nowrap><b>Petty Cash Tambahan</b></td>";
    ...
    <?PHP
        ...
        echo "<br/>&nbsp;<br/>&nbsp;$pnamacabang, $ptglajukan";
