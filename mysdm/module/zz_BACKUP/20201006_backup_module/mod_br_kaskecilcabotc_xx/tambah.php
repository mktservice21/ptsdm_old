...
function HitungSaldoAkhir() {
    ...
    var isaldo="0";
    isaldo =parseFloat(ipc)-parseFloat(ijmlots)-parseFloat(ijml);
...
function disp_confirm(pText_,ket)  {
    ...
    $.ajax({
        ...
        data:"utgl="+itgl+"&uid="+iid+"&ukry="+ikry+"&ucabid="+icabid+"&ucoap="+icoap,
        success:function(data){
...
if ($pact=="editdata"){
    ...
    $prpsaldo=(DOUBLE)$prppc-(DOUBLE)$pjumlah;
                        ...
                        <div class='x_content'>
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                    ...
                                    <div class='col-xs-5'>
                                        <select class='form-control input-sm' id='cb_cabang' name='cb_cabang' onchange="ShowDataPengajuan()">
                                            ...
                                            //if ($pact=="editdata"){
                                                ...
                                                $query = "select distinct icabangid_o as iCabangId, nama as nama from MKT.icabang_o WHERE icabangid_o='$pidcabang' order by nama";
                                                $tampil = mysqli_query($cnmy, $query);
                                                while ($z= mysqli_fetch_array($tampil)) {
                                                    $pidcab=$z['iCabangId'];
                                                    $pnmcab=$z['nama'];
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-3'>
                                        <input type='text' id='e_pcrp' name='e_pcrp' autocomplete='off' class='form-control col-md-7 col-xs-12 inputmaskrp2' value='<?PHP echo $prppc; ?>' Readonly>
                                    </div>
                                </div>
