...
if ($pmodule=="caricabang") {
    ...
    $query = "select idkascab from dbmaster.t_kaskecilcabang WHERE karyawanid='$pidkar' AND tanggal='$periode1' AND "
            . " icabangid='$pidcab' AND coa4='$pcoa' AND IFNULL(stsnonaktif,'')<>'Y' AND idkascab<>'$pid'";
