                            ...
                            <div class='col-md-12 col-sm-12 col-xs-12'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-xs-5'>
                                          <select class='form-control input-sm' id='cb_kodesub' name='cb_kodesub' data-live-search="true" onchange="ShowNoBukti()">
                                              <?PHP
                                                $query = "select distinct kodeid, subkode, subnama from dbmaster.t_kode_spd where kodeid='$pkode' and subkode IN ('22', '23') order by subkode";
                                ...
                                <div id="c_input">
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-3'>
                                            <input type='text' id='e_jmlusulan_kb' name='e_jmlusulan_kb' autocomplete='off' class='form-control col-md-7 col-xs-12 inputmaskrp2' value='<?PHP echo $jumlah_kb; ?>' Readonly>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function ShowNoBukti() {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_spdkas/viewdata.php?module=viewnomorbukti",
    ...
    function CariData()  {
        ...
        $.ajax({
            type:"post",
            url:"module/mod_br_spdkas/datakas.php?module=viewdatakas&ket=detail",
            data:"uper1="+eper1+"&uper2="+eper2+"&eidinput="+eidinput+"&uact="+iact+"&usubkode="+esubkode,
            success:function(data){
                $("#s_div").html(data);
                $("#loading3").html("");
    ...
    function disp_confirm(pText_,ket)  {
        ...
        if (ok_) {
            ...
            if (r==true) {
                ...
                document.getElementById("demo-form2").action = "module/mod_br_spdkas/aksi_spdkas.php?module="+module+"&act="+ket+"&idmenu="+idmenu;
