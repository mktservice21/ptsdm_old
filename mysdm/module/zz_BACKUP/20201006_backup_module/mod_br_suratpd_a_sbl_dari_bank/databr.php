...
if ($_GET['module']=="viewdataanne"){
    ...
    */
    ...
    if ($pact=="editdata") {
        ...
        $query = "select *, CAST(null as DECIMAL(10,0)) as urutan, CAST('' as CHAR(20)) as bridinput, CAST('' as CHAR(50)) as ketadj1, CAST(null as DECIMAL(20,2)) as jml_adj from $tmp03";
        $query = "create TEMPORARY table $tmp05 ($query)"; 
        mysqli_query($cnmy, $query);
        $erropesan = mysqli_error($cnmy); if (!empty($erropesan)) { echo $erropesan; goto hapusdata; }
