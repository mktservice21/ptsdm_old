<?PHP
    ...
    if ($_GET['ket']=="excel") {
        ...
        if ($mact=="viewbrklaim")
            ...
            header("Content-Disposition: attachment; filename=ADVANCE_BR_HO_$now_.xls");
    }
...
<head>
     <?PHP if ($mact=="viewbrklaim") { 
         ...
         echo "<title>ADVANCE - BR HO</title>";
     }
    ?>  
...
<?php
    ...
    $now=date("mdYhis");
    $tmp01 =" dbtemp.DSETHXZ01_".$userid."_$now ";
    $tmp02 =" dbtemp.DSETHXZ02_".$userid."_$now ";
    $tmp03 =" dbtemp.DSETHXZ03_".$userid."_$now ";
...
?>
    ...
    <div id="kotakjudul" style="margin-bottom: -30px;">
        <div id="isikiri">
            <table class='tjudul' width='100%'>                
                ...
                <?PHP }else{ ?>
                    <tr><td width="150px"><b>**Advance : </b></td><td><b><?PHP echo $periode1; ?></b></td></tr>
                <?PHP } ?>
    ...
    <table id='datatable2' class='table table-striped table-bordered example_2' border="1px solid black">
            ...
            <?PHP
                ...
                while ($row= mysqli_fetch_array($tampil)) {
                    ...
                    if ($padvance=="K") {
                        ...
                        if ($mact=="viewbrho") echo "<td nowrap>$pdaerah</td>";
                        echo "<td>$paktivitas1</td>";
                        if ($mact=="viewbrho") echo "<td>$prealisasi1</td>";

                        echo "<td nowrap align='right'>$pjumlah</td>";
                        //if ( (INT)$nmyno==0) $nmyno=1;
                        echo "<td nowrap align='center'>$nmyno</td>";
                    }
                    echo "</tr>";
        ...
        echo "<td>YANG MEMBUAT,</td> <td></td> <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> <td></td> <td>MENYETUJUI,</td>";
        echo "</tr>";
        ...
        echo "<td>MARIANNE PRASANTI</td> <td></td> <td>&nbsp;</td> <td></td> <td>IRA BUDI SUSETYO</td>";
        echo "</tr>";
