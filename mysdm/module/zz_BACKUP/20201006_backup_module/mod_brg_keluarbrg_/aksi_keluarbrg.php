...
if ($module=='gimickeluarbarang')
{
    ...
    if ($act=="hapus") {
        ...
        if ($act=="input") {
            $sql=  mysqli_query($cnmy, "select max(IDKELUAR) as NOURUT from dbmaster.t_setup_barang WHERE TAHUN='$ptahun'");
        ...
        if ($psimpandata == true) {
            ...
            if ($act=="input") {
                ...
                $query_mst="INSERT INTO dbmaster.t_barang_keluar (IDKELUAR, TANGGAL, KARYAWANID, DIVISIID, ICABANGID, ICABANGID_O, NOTES, USERID)VALUES"
                        . "('$pkodeid', '$ptglminta', '$pkaryawanid', '$pgrpprod', '$pcabangid', '$pcabangid', '$pnotes', '$puserinput')";
                ...
                $query_mst="UPDATE dbmaster.t_barang_keluar SET TANGGAL='$ptglminta', KARYAWANID='$pkaryawanid', "
                        ...
                        . " USERID='$puserinput' WHERE IDKELUAR='$pkodeid'";
            }
