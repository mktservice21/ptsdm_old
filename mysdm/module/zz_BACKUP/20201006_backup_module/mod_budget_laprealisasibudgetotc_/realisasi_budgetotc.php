...
<div class="">
    ...
    <div class="page-title"><div class="title_left"><h3>Realisasi Biaya Marketing vs Budget OTC</h3></div></div><div class="clearfix"></div>
    <!--row-->
    <div class="row">
                        ...
                        <div class='x_panel'>
                            <div class='x_content form-horizontal form-label-left'><br />
                                ...
                                <div hidden class='form-group'>
                                    ...
                                    <div class='col-md-6'>
                                        <input type="radio" id="radio1" name="radio1" value="S"> Input
                                        <input type="radio" id="radio1" name="radio1" value="A" checked> Transfer
                                    </div>
                                </div>
