        ...
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                <?PHP
                    ...
                    $query = "select idinput, trans_ke, sum(IFNULL(amount,0)+IFNULL(jml_adj,0)) as amount, sum(amount) as pakairp, sum(amount) as sisarp from dbmaster.t_suratdana_br1 WHERE idinput IN "
                            . " (select IFNULL(idinput,'') from $tmp00) GROUP BY 1,2";
