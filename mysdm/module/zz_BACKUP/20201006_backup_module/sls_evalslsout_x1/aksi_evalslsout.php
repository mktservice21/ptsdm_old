...
$query = "select divprodid, iprodid, DATE_FORMAT(tgljual,'%m') bulan, sum(qty) as qty, sum(hna*qty) as tvalue 
    ...
    and CONCAT(IFNULL(icabangid,''),IFNULL(areaid,''),IFNULL(icustid,''))='$pcboutlet' 
      AND CONCAT(IFNULL(icabangid,''),IFNULL(areaid,''),IFNULL(divprodid,'')) IN 
        ...
        <tbody>
            ...
            while ($row1= mysqli_fetch_array($tampil1)) {
                ...
                */
                ...
                echo "<tr>";
                echo "<td nowrap><b> Total Qty : </b></td>";//$pdivprodid
                ...
                echo "<tr>";
                echo "<td nowrap><b> Total Nilai : </b></td>";//$pdivprodid
                ...
                echo "<tr>";
                echo "<td nowrap><b> Average Qty : </b></td>";//$pdivprodid
