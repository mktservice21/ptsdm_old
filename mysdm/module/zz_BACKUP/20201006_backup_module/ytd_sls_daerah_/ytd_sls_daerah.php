                                ...
                                <div class='x_panel'>
                                    <div class='x_content form-horizontal form-label-left'><br />
                                        <?PHP
                                            ...
                                            echo "<div class='form-group'>";
                                                 echo "<label class='control-label col-md-3 col-sm-3 col-xs-12'>Nama Daerah <span class='required'></span></label>";
                                                 echo "<div class='col-md-9 col-sm-9 col-xs-12'>";
                                                 
                                                    echo "<select class='form-control' name='e_daerah' id='e_daerah'>";
                                                    $ssqcombo="SELECT distinct idcabang, nama from MKT.cbgytd order by nama";
                                                    $tampilcombo=mysqli_query($cnit, $ssqcombo);
                                                    echo "<option value='0' selected>- Pilih -</option>";
                                                    while($comb=mysqli_fetch_array($tampilcombo)){
                                                        echo "<option value='$comb[idcabang]'>$comb[nama]</option>";
                                                    }
                                                    echo "</select>";
