...
<?php
    ...
    echo "<table width='90%' align='center' border='0' class='table table-striped table-bordered'>";
        echo "<tr>";
            echo "<td valign='top'>";
                ...
                echo "<tr><td><b>SALES PRODUK & DIVISI BY UNIT</b></td></tr>";
    ...
    $query = "select date_format(s.bulan,'%Y%m') thnbln, s.divprodid, s.iprodid, s.hna_sales, 
        ...
        and s.region='$region'
        GROUP BY date_format(s.bulan,'%Y%m'), s.divprodid, s.iprodid, s.hna_sales";
...
<table id="datatable1" class="display  table table-striped table-bordered" style="width:100%" border='0px'>
    <thead>
        <tr style="background-color: #cccfff;">
            ...
            <th>Produk</th>
            <th>HNA</th>
            <th>Sales <?PHP echo $thnbln; ?></th>
            <th>Target <?PHP echo $thnbln; ?></th>
            <th>Ach %</th>
            <th>Sales <?PHP echo $thnbln2; ?></th>
            <th>Growth %</th>
        </tr>
    </thead>
    <tbody>
