...
<html lang="en">
  <head>
    ...
    <title>Sales YTD <?PHP echo $nminitialdist; ?> Produk dan Divisi By Unit, Region : <?PHP echo "$namaregion,"; ?> Bulan : <?PHP echo "$thnbln, $closing"; ?></title>
