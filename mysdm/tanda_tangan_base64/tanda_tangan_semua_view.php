    ...
    <?PHP
        ...
        echo "<a class='btn' href='$actual_link/media.php?module=$_POST[umodule]&idmenu=$_POST[uidmenu]&act=approve'></a><br />";
    ...
    <div>
        <div id="content"  class="main">
            ...
            <form name="tdata" id="tdata" hidden>
                ...
                <input type="hidden" name="nket" id="nket" value="<?PHP //echo "$_GET[ket]"; ?> " /><br/>
                <input type="hidden" name="ncardid" id="ncardid" value="<?PHP //echo "$_GET[cardid]"; ?> " /><br/>
            </form>
